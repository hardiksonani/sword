...
class Dashboard extends CI_Controller 
{
	...
	public function index()  
	{
			...
			$this->view_data["message"]  = ""; 
			$this->load->view("Distributor/Dashboard_view",$this->view_data);
...
public function getBalance()
	...
	public function AddressFieldcheck()
	{
		...
		*/
		...
		$rsltuserprofile = $this->db->query("select pancardPath,aadharcardPath,PSAStatus,AadhaarStatus,soapselfiePath,gstcertificatePath,service_agreementPath,AddressProofPath from tblusersprofile where user_id = ?",array($this->session->userdata("DistId")));
		...
		// public function getBalance()
		// {
		// 	echo $this->Common_methods->getAgentBalance($this->session->userdata("DistId"))."#".$this->Ew2->getAgentBalance($this->session->userdata("DistId"));
		// }
	}