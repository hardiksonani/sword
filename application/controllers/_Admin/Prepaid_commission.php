		...
		$str_company_id.=$row->company_id.",";
				...
				else
				{
					...
					if($rslt->num_rows() > 0)
					{
							...
							{
								$str.= '<select style="font-size:14px" id="ddlcommission_type'.$row->company_id.'" name="ddlcommission_type'.$row->company_id.'" class="form-control" >
                ...
                <div class="slab-master-block-left">
                    <div id="allshow" class="row">
                        <div class="col-md-12" style="padding-right:20px;">
                            ...
                            <select class="form-control for-select2" style="font-size:14px" id="ddlUserId" name="ddlUserId" onchange="ddlUserIdChange()">
                    ...
                    <div id="retailerdrop" class="row" style="display:none;">
                        ...
                        <div class="col-md-6" style="padding-right:0px;">
                            <div >
                                ...
                                <select class="form-control for-select2" style="font-size:14px" id="ddldealer" name="ddldealer" onchange="ddlretailerid()">
                        ...
                        <div class="col-md-6" style="padding-left:5px;padding-right:20px;">
                            <div >
                                ...
                                <select class="form-control for-select2" style="font-size:14px" id="ddlUserIdrem" name="ddlUserIdrem" onchange="ddlUserIdChangerem()">
