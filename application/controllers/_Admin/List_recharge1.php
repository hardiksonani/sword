...
class List_recharge1 extends CI_Controller {
	...
	public function pageview()
	{
		...
		$config['base_url'] = base_url()."_Admin/list_recharge1/pageview";
		...
		$this->load->view('_Admin/list_recharge1_view',$this->view_data);			
	}
