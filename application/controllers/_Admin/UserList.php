...
class Userlist extends CI_Controller {
	...
	public function pageview()
	{
		...
		$userrows = $this->db->query("select count(user_id) as total from tblusers where usertype_name = 'APIUSER'");
		
		$total_row = $userrows->row(0)->total;
		$this->load->library('pagination');
		$config['base_url'] = base_url()."_Admin/UserList/pageview";
		...
		$this->load->view('_Admin/UserList_view',$this->view_data);		
	}
