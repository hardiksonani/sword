...
class Commonaccount_report extends CI_Controller {
...
$this->output->set_header("Pragma: no-cache"); 
		...
		{ 	
			if($this->input->post('btnSearch') == "Search")
			{
				...
				$this->load->view('_Admin/Commonaccount_report_view',$this->view_data);		
			}					
			else
			{
				...
				if(trim($user) == 'Admin' or trim($user) == 'EMP')
				{
					...
					$this->load->view('_Admin/aCommonaccount_report_view',$this->view_data);	
				}
				else
				{redirect(base_url().'login');}																								
			}
