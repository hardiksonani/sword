				    ...
				    if($amount > 0)
    				{
        				...
        				if($userinfo->num_rows() == 1)
        				{
        					...
        					if($ewrslt == true)
        					{
                    			...
                    			$admin_message = "Payment of RS:".$amount." By Admin to ".$userinfo->row(0)->businessname." Added Successfully and Received Ammount RS : " .$payment_received." Detail : " .$txtRemark."";
                    			$this->common->ExecuteSMSApiWhatsapp("",$admin_message);
								$this->common->ExecuteSMSApiWhatsapp("",$admin_message);
								$this->common->ExecuteSMSApiWhatsapp("9725877297",$admin_message);
                    		 ...
                    		 $MESSAGEBOX_MESSAGETYPE = $this->session->set_flashdata("MESSAGEBOX_MESSAGEBODY","Balance ".$amount." Added Successfully");
