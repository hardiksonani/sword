...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    															...
    															redirect(base_url()."API/dmrmm_finalpage?crypt=".$this->Common_methods->encrypt($unique_id));
    															//redirect(base_url()."API/dmrmm_dashboard?crypt=".$this->Common_methods->encrypt("MyData"));	
    														}
    														else
    														{
    															$this->session->set_flashdata("MESSAGEBOX_MESSAGETYPE","FAILURE");
