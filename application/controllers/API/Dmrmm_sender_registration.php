...
///////////////////////////////////////////////////////
			...
			*/
			...
			if(isset($json_obj->message) and isset($json_obj->status))
			{
					...
					if($status == "0")
					{
						...
						redirect(base_url()."API/dmrmm_validate_sender?crypt=".$this->Common_methods->encrypt("getcustomerinfo"));
					}
		...
		else
		{
			...
			$this->load->view("API/dmrmm_sender_registration_view",$this->view_data);
		}
