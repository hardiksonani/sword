...
class GetDmrList extends CI_Controller {
	...
	public function getDmtDetail()
	{
		error_reporting(-1);
		ini_set('display_errors',1);
		$this->db->db_debug = TRUE;
	     if(isset($_GET["UId"]) and isset($_GET["username"]) and isset($_GET["password"]))
	     {
	         $UId = trim($_GET["UId"]);
...
order by Id desc",array($userinfo->row(0)->user_id,$UId));
                $resparray = array();
	...
	public function index() 
	{
	    ...
	    //http://www.MPAY.IN/appapi1/getDmrList?from=2019-01-01&to=2019-03-31&username=&password=
