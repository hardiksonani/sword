				...
				if($userinfo->num_rows() == 1)
				{
					...
					if($status == '1')
					{
						...
						if(ctype_digit($remittermobile))
						{
							...
							//echo $this->Mastermoney->verify_bene($remitter_id,$benificiary_account_no,$benificiary_ifsc,$bank_id,$userinfo);

							$this->load->model("Instapay");
							echo $this->Instapay->verify_bene($remitter_id,$benificiary_account_no,$benificiary_ifsc,$bank_id,$userinfo);
