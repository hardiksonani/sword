				...
				if($userinfo->num_rows() == 1)
				{
					...
					if($status == '1')
					{
						...
						if(ctype_digit($remitter_id))
						{
								...
								// echo $this->Mastermoney->add_benificiary($remitter_id,$benificiary_name,$benificiary_mobile,$benificiary_account_no,$benificiary_ifsc,$bank_id,$userinfo);


								// $this->load->model("Mastermoney");
								// echo $this->Mastermoney->add_benificiary($remitter_id,$benificiary_name,$benificiary_mobile,$benificiary_account_no,$benificiary_ifsc,$bank_id,$userinfo);

								//$this->Instapay->beneficiary_register($mobile_no,$benificiary_name,$benificiary_mobile,$benificiary_ifsc,$benificiary_account_no,$userinfo);
