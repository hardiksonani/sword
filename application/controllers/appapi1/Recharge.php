			...
			if($user_info->num_rows() == 1)
			{
			    ...
			    if(true)
    			{
    				...
    				if($service_id == 3)
    				{
                        ...
                        $particulars = false;
                        $remark = "";
                        $response = $this->Swift->recharge_transaction2($user_info,$company_info->row(0)->company_id,$Amount,$MobileNo,$MobileNo,$remark,$option1,$ref_id,$particulars);
    				    ...
    				    // $response = $this->Instapay->recharge_transaction2($user_info,$operatorcode,$company_id,$Amount,$MobileNo,$MobileNo,$remark,$option1,$particulars);
    				    // //($user_info,$company_id,$amount,$number,$number,"","","");
    				    // echo $response;exit;
    				}
    				else
    				{
