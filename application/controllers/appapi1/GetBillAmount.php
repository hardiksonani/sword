					...
					if($company_info->num_rows() == 1)
					{
					   ...
					   if($mcode == "UGE" or $mcode == "PGE" or $mcode == "DGE" or $mcode == "MGE")
    					  ...
    					  else
    					  {
							...
							$response = $this->Swift->fetchbill_swift($user_info,$company_info->row(0)->company_id,$serviceno,$customer_mobile,$option1);
    					  }
						...
						//($user_info,$mcode,$company_info->row(0)->company_id,$serviceno,$customer_mobile,$option1);
