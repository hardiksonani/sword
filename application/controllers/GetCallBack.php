...
write_file($filename, $sapretor."\n", 'a+');
	...
	public function test()
	{
	   ...
	   $response = '{"reqid":"2265","status":"REFUND","remark":"RECHARGE REFUND. TRANSACTION ID IS 3673858477359885991, REQUEST ID 2265","balance":"0","mn":"7600537200","amt":"10","field1":"","ec":"1014"}';
	...
	public function index()
	{
	   ...
	   // $response = '{"reqid":"2237","status":"SUCCESS","remark":"SUCCESS","balance":"0","mn":"9586907242","amt":"149","field1":"BH0531155925000076","ec":"1000"}';
	    ...
	    $this->Errorlog->httplog("Callback From ",$response,0);
