...
class TopupReceived extends CI_Controller {
	...
	//	echo $start_row;exit;
		...
		$config['base_url'] = base_url()."Retailer/topupReceived/pageview";
		...
		$this->load->view('MasterDealer/topupReceived_view',$this->view_data);			
	}
