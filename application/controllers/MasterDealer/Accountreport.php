...
class Accountreport extends CI_Controller {
	...
	public function pageview()
	{
	    ...
	    $ddltransaction_type = $this->session->userdata("ddltransaction_type");    
	...
	//	echo $start_row;exit;
		...
		$config['base_url'] = base_url()."MasterDealer/accountreport/pageview";
		...
		$this->view_data['ddltransaction_type'] =$ddltransaction_type;
	
		
		$rows = $this->AccountLedger_getReport($user_id,$fromdate,$todate,$ddldb,$start_row,$per_page,$ddltransaction_type);
	...
	public function index() 
	{
			...
			if(isset($_POST["txt_frm_date"]) and isset($_POST["txt_to_date"]))
			{
				...
				$ddltransaction_type = $this->input->post("ddltransaction_type",TRUE);
			    ...
			    $this->session->set_userdata("ddltransaction_type",$ddltransaction_type);
			    $this->pageview();	
			}					
			...
			else
			{
			    ...
			    $this->session->set_userdata("ddltransaction_type","ALL");
			    $this->pageview();																									
			}
		 
	}	
	private function AccountLedger_getReport($user_id,$from_date,$to_date,$ddldb,$start_row,$per_page,$transaction_type)
	{
