...
class Fos_registration extends CI_Controller {
...
$this->output->set_header("Pragma: no-cache"); 
		...
		if($this->input->post("btnSubmit"))
		{
				...
				{	
						...
						$response = $this->Insert_model->tblusers_registration_Entry($parentid,$distributer_name,$postal_address,$pincode,$state_id,$city_id,$contact_person,$mobile_no,$emailid,$usertype_name,$status,$scheme_id,$username,$password,$aadhar,$pan_no,$gst,$downline_scheme,0);
						...
						{ 
							...
							if($status == "0")
							{
								...
								redirect("Distributor/fos_registration");
							}
							else
							{
				...
				{	
					...
					$this->load->view('MasterDealer/fos_registration_view',$data);
				}
