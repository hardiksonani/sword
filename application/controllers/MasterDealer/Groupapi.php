...
class Groupapi extends CI_Controller {
	...
	{ 
		...
		$this->load->view('MasterDealer/groupapi_view',$this->view_data);		
	}
   ...
   $str.='</table>';
	...
	function ChangeCommission()
	{
		...
		if($groupinfo->num_rows() == 1)
		{
		    ...
		    $md_info = $this->db->query("select scheme_id from tblusers where user_id = ? and usertype_name = 'MasterDealer'",array($user_id));
