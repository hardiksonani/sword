...
<tr><td>Welcome to <b> '.$this->getName().'.!</b> Kindly Find your account information below:</td></tr><br>
<hr><br>
...
<hr>
<tr style="color:#000;"> 
<td style="padding-top:10px;"><p>As a member of <b style="color:#00F;border-bottom:medium;" onClick="'.$this->getWebUrl().'"> '.$this->getName().'.</b> you are entitled to savings and benefits on mobile/ DTH Recharge, Printing work, Ad. booking</p></td>
</tr> 
</table>';
