...
{	
	...
	public function checkChildOf($parent,$child)
	{
		...
		if(($parent_type == "Distributor" and $chile_type == "Agent") or ($parent_type == "Distributor" and $chile_type == "FOS")  or ($parent_type == "MasterDealer" and $chile_type == "Distributor") or ($parent_type == "Distributor" and $chile_type == "Distributor"))
		{
