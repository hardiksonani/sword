...
<html lang="en">
  ...
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>DMT Balance Transfer</title>
...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
   ...
   <?php include("elements/sidebar.php"); ?><!-- br-sideleft -->
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pageheader">
        ...
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Dmt Balance Transfer</span>
	...
	?>    
    <fieldset>
        <input type="hidden" id="hidgetautocompletedata" value="<?php echo base_url()."_Admin/AddDmtBalance/getUserForAutocompleteTextBox"; ?>">
    <form id="frmaddbal" name="frmaddbal" method="post" action="<?php echo base_url()."_Admin/AddDmtBalance?crypt=".$this->Common_methods->encrypt("MyData"); ?>" autocomplete="off" data-parsley-validate>
