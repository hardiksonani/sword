...
<html lang="en">
  ...
  <head>
    ...
    <title>Wallet2 Balance Transfer</title>
...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pageheader">
        ...
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Wallet2 Balance Transfer</span>
      ...
      <div class="br-pagetitle">
        ...
        <div>
          ...
          <h4>Wallet2 Balance Transfer</h4>
    ...
    <form id="frmaddbal" name="frmaddbal" method="post" action="<?php echo base_url()."_Admin/add_balance2?crypt=".$this->Common_methods->encrypt("MyData"); ?>">
