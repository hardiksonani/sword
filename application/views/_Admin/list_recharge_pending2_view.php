...
<html lang="en">
 ...
 <meta charset="utf-8">
    ...
    <title>DILIP PENDING RECHARGE REPORT</title>
  ...
  <?php include("elements/linksheader.php"); ?>
    ...
    {
      $.ajax({
        url:'<?php echo base_url()."_Admin/list_recharge_pending2/checkstatus";?>',
        type:'post',
        ...
        success:function(html)
        {
          ...
          document.getElementById("status_"+value).innerHTML = msg;
        }
        });
...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">DILIP PENDING RECHARGE REPORT</span>
        </nav>
      </div><!-- br-pageheader -->
        ...
        <div class="row row-sm mg-t-20">
          ...
          <div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">DILIP PENDING RECHARGE REPORT</h6>
 ...
 <form id="frmactall" name="frmactall" method="post"> 
  ...
  <th style="font-size:20px;color: white;font-family: times">Op Id</th>
  ...
  ?>
      ...
      if($retry == "yes")
      {?>
              <tr id="tr_<?php echo $result->recharge_id; ?>" class="retry" style="border-top: 1px solid #000;">
      <?php }
      else if($retry == "manual")
      {?>
              <tr  id="tr_<?php echo $result->recharge_id; ?>" class="manual" style="border-top: 1px solid #000;">
      <?php }
      else
      {?>
              <tr  id="tr_<?php echo $result->recharge_id; ?>" class="<?php if($i%2 == 0){echo 'row1';}else{echo 'row2';} ?>" style="border-top: 1px solid #000;">
      <?php }
     ?>
 ...
 <td><a class="copy_text" href="javascript:void(0)"><?php echo $result->mobile_no; ?></a></td>
 <td><?php echo $result->amount; ?></td>

<td>
  <input type="text" id="txtOpId<?php echo $result->recharge_id; ?>" style="width:120px;font-size: 12px;font-weight: bold;" class="text">
</td>
...
<td>
  ...
  <select id="ddlstatus<?php echo $result->recharge_id; ?>">
    <option value="0">Select</option>
    <option value="Success">Success</option>
    <option value="Failure">Failure</option>
    <option value="royal">royal</option>
  </select>
  <img id="imgloading<?php echo $result->recharge_id; ?>" src="<?php echo base_url()."Loading.gif" ?>" style="width:30px;display: none;" >
</td>

<td>
  <input type="button" name="btnSubmitUpdate" value="Submit" class="btn btn-warning btn-sm" onclick="updatestatusbyddl('<?php echo $result->recharge_id; ?>')">
 </td>
 ...
 <?php 
 if($result->recharge_status == 'Pending'){echo "<a  id='status_".$result->recharge_id."' href='javascript:void(0)' onClick='statuschecking(".$result->recharge_id.")' class='label btn-warning'>Pending</a>";}
 if($result->recharge_status == 'Success')
 {
     ...
     $Profit = ($AdminComm + $result->roffer) - ( $commission_amount +  $DComm + $MdComm);
 ...
 <tr id="tr_reqresp<?php echo $result->recharge_id; ?>" style="display:none">
     ...
     <td>Response</td> <td colspan="4" id="tdresp<?php echo $result->recharge_id; ?>" style="word-break:break-all" ></td>
   ...
   <form id="frmexport" name="frmexport" action="<?php echo base_url()."_Admin/list_recharge_pending2/dataexport" ?>" method="get">
  ...
  <div class="modal fade" id="myActionModal" role="dialog">
    <div class="modal-dialog"  >
      <div class="modal-content" style="width:600px;">
        ...
        <input type="hidden" id="hidrefundmethodurl" value="<?php echo base_url()."_Admin/list_recharge_pending2/dorefund"; ?>"> 
        <input type="hidden" id="hidstatusmethodurl" value="<?php echo base_url()."_Admin/list_recharge_pending2/checkstatus"; ?>"> 
        <input type="hidden" id="hidsuccessmethodurl" value="<?php echo base_url()."_Admin/list_recharge_pending2/dosuccess"; ?>"> 
        <input type="hidden" id="hidresendtoothermethodurl" value="<?php echo base_url()."_Admin/list_recharge_pending2/resendtoanotherapi"; ?>"> 
        <input type="hidden" id="hidstatusupdateurl" value="<?php echo base_url()."_Admin/list_recharge_pending2/statusupdatebyddl" ?>">
     ...
     <script>
       ...
       function getreqresplog(recharge_id)
       {
        ...
        function updatestatusbyddl(id)
        {
              ...
              data:{'recharge_id':id,'operator_id':document.getElementById("txtOpId"+id).value,'status':status},
              beforeSend: function() 
              {
...
<div class="modal fade" id="myloader" role="dialog">
    <div class="modal-dialog modal-lg"   >
      <div class="modal-content">
        ...
        <div class="modal-body">
            <span id="resendall_spanloader" style="display:none">
              <img id="resendall_imgloading" src="<?php echo base_url()."Loading.gif"; ?>" style="max-width:80px">
            </span>
           
           
          
          <div id="resendall_reqresp" style="overflow:auto;height:500px;word-break: break-all;">
