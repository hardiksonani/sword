						...
						<div class="row row-sm mg-t-20">
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
                                          ...
                                          <form action="<?php echo base_url()."_Admin/distributor_list?crypt=".$this->Common_methods->encrypt("MyData") ?>" method="post" name="frmCallAction" id="frmCallAction">
                           <input type="hidden" id="hidID" name="hidID">
                                    <table cellspacing="10" cellpadding="3">
                                    <tr>
                                    	<td style="padding-right:30px;">
                                        
										<button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;width:215px;">&nbsp;Distributor Name</button><br><br>
                                        	<input class="autocomplete" type="text" value="<?php echo $txtAGENTName; ?>"  id="txtAGENTName" name="txtAGENTName"  placeholder="Distributor Name" >    
                                    	</div>
                                        	
                                        </td>
                                        <td style="padding-right:30px;">
                                        
										<button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;width:215px;background-color: #4CAF50;">&nbsp;Distributor ID</button><br><br> 
                                            <input class="autocomplete" id="txtAGENTId" value="<?php echo $txtAGENTId; ?>" name="txtAGENTId" type="text"  placeholder="Distributor USER ID">
										...
										<button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;background-color: #824caf;">&nbsp;MOBILE NUMBER</button><br><br>
                                         <input class="autocomplete" id="txtMOBILENo" value="<?php echo $txtMOBILENo; ?>" name="txtMOBILENo" type="text"  placeholder="Distributor MOBILE NO">
                                        ...
                                        <td >
                                        <h5><br></h5>  
                                        <input type="submit" id="btnSubmit" name="btnSubmit" value="Search" class="btn btn-primary btn-sm" style="font-size:24px;border-radius: 10px;background-color:  #AF4C7A;">
                                        </td>
                                    </tr>
                                    </table>
						 ...
						 <div class="row row-sm mg-t-20">
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
										  <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
											<h6 class="card-title tx-uppercase tx-12 mg-b-0">Distributor List</h6>
											<span class="tx-12 tx-uppercase">
												<a href="<?php echo base_url()."_Admin/Admin_d_registration" ?>"  class="blue btn btn-primary btn-sm" > <i class="ace-icon fa fa-plus bigger-120"></i>Add New User </a>
...
<td ><a href="<?php echo base_url()."_Admin/profile?usertype=".$this->Common_methods->encrypt("Distributor")."&user_id=".$this->Common_methods->encrypt($result->user_id);?>" target="_blank"><?php 
...
?></a></td>
<td ><a href="<?php echo base_url()."_Admin/profile/view/".$this->Common_methods->encrypt("Distributor")."/".$this->Common_methods->encrypt($result->parentid);?>" target="_blank"><?php echo $result->parent_name; ?></a></td>
...
<?php if($result->status == 0){echo "<span class='red'><a href='#' onclick='actionDeactivate(".$result->user_id.",1)'>Deactive</a></span>";}else{echo "<span class='green'><a href='#' onclick='actionDeactivate(".$result->user_id.",0)'>Active</a></span>";} ?>
 ...
 <td width="180px">
  <a class="far fa-edit" style="font-size:18px;" href="<?php echo base_url()."_Admin/distributer_edit?id=".$this->Common_methods->encrypt($result->user_id); ?>" title="Edit Franchise"></a> 
   |       
