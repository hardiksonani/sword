						 ...
						 <div class="row row-sm mg-t-20">
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
										  ...
										  <div class="card-body">
                                        <form method="post" action="<?php echo base_url()."_Admin/agent_edit?crypt=".$this->Common_methods->encrypt("MyData");?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
...
<tr>
    ...
    <td>
        ...
        <?php
        	$rlstparent = $this->db->query("select user_id,businessname from tblusers where usertype_name='Distributor' and host_id = 1");
            ...
            <div class="row row-sm mg-t-20">
                <div class="col-sm-12 col-lg-12">
				    <div class="card shadow-base bd-0">
                        ...
                        <div class="card-body">
									  <form method="post" action="<?php echo base_url()."_Admin/agent_edit/commission?crypt=".$this->Common_methods->encrypt("MyData");?>" name="frmdistributer_form2" id="frmdistributer_form2" autocomplete="off">
                                <input type="hidden" name="hiduserid" value="<?php echo $result_user->row(0)->user_id; ?>">
<table class="table table-borderless" style="color:#000000;font-weight:normal;font-family:sans-serif;font-size:14px;overflow:hidden" >
    <tr>
        <th>Sr.</th>
