                    ...
                    <td class="hidden-480"><?php echo $row->add_date; ?></td>
											<td>
												<div class="hidden-sm hidden-sm btn-group">
													...
													<a href="<?php echo base_url()."_Admin/Commission_settings?act=EDIT&id=".$row->Id; ?>" class="btn btn-sm btn-info" >
											...
											<?php echo form_open('Commission_settings',array('id'=>"frmEdit",'method'=>'get'))?>
											<input type="hidden" name="hidEditGroup" id="hidEditGroup">
												<?php echo form_close();?>
										<script language="javascript">
													function editform(id)
													{
														
														document.getElementById("frmEdit").value =  id;
