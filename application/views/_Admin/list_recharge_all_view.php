      ...
      <div class="br-pagetitle">
        ...
        <div class="col-sm-6 col-lg-12">
            ...
            <span class="breadcrumb-item">
          	    <button class="btn btn-info btn-sm" type="button" style="font-size:14px;">RComm : <?php echo $retComm; ?></button>
            </span>
            <span class="breadcrumb-item">
          	    <button class="btn btn-info btn-sm" type="button" style="font-size:14px;">DComm : <?php echo $DComm." + ".$flatcommission; ?></button>
            </span>
             <span class="breadcrumb-item">
          	    <button class="btn btn-info btn-sm" type="button" style="font-size:14px;">MComm : <?php echo $MdComm; ?></button>
            </span>
            
            <span class="breadcrumb-item">
          	    <button class="btn btn-warning btn-sm" type="button" style="font-size:14px;">
          	    <?php 
              	    if($totalRecahrge > 0)
              	    {
            ...
            <span class="breadcrumb-item active">
          	    <button class="btn btn-success btn-sm" type="button" style="font-size:14px;">Admin Commission : <?php echo $AdminComm; ?></button>
            </span>
            <br>
            <br>
            
             <span class="breadcrumb-item active">
          	    <button class="btn btn-success btn-sm" type="button" style="font-size:24px;">OTF : <?php echo $roffer; ?></button>
            </span>
            
            <span class="breadcrumb-item active">
          	    <button class="btn btn-success btn-sm" type="button" style="font-size:24px;">Profit : <?php echo ($AdminComm + $roffer) - ($retComm + $DComm + $MdComm + $flatcommission); ?></button>
            </span>
            
            <span class="breadcrumb-item active">
          	    <button class="btn btn-success btn-sm" type="button" style="font-size:24px;">Success : <?php echo $totalRecahrge; ?></button>
            </span>
           
              <span class="breadcrumb-item active">
              	<button class="btn btn-primary btn-sm" type="button" style="font-size:24px;">Pending : <?php echo $totalpRecahrge; ?></button>
              </span>
              <span class="breadcrumb-item active">
              	<button class="btn btn-danger btn-sm" type="button" style="font-size:24px;">Failure : <?php echo $totalfRecahrge; ?></button>
              </span>
        </div>
      </div><!-- d-flex -->
...
<input type="hidden" id="hidaction" name="hidaction" value="Set" />
 ...
 <input type="hidden" id="hidgetautocompletedata" value="<?php echo base_url()."_Admin/AddMainBalance/getUserForAutocompleteTextBox"; ?>">
    ...
    <th style="font-size:20px;color: white;font-family: times">Total<br>Comm(%)</th>
    <th style="font-size:20px;color: white;font-family: times">AdminComm</th>
