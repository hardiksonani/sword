    ...
    <?php
		...
		$i = 0;foreach($result_complain->result() as $result) 	{  ?>
            ...
            <td >			
                ...
                <?php 
				$recdetail = $this->db->query("select mobile_no,add_date,ExecuteBy,amount,recharge_status,operator_id from tblrecharge where recharge_id = ?",array($result->recharge_id));
              ...
              <br>
                <?php echo "OpId : ".$recdetail->row(0)->operator_id; ?>
                </td>
