...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
   ...
   <?php include("elements/sidebar.php"); ?><!-- br-sideleft -->
          ...
          <div class="col-sm-6 col-lg-12">
            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                ...
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">Balance Transfer</h6>
    ...
    <form id="frmaddbal" name="frmaddbal" method="post" action="<?php echo base_url()."_Admin/AddMainBalance?crypt=".$this->Common_methods->encrypt("MyData"); ?>" autocomplete="off" data-parsley-validate>
                                     ...
                                     <tr>
                                      ...
                                      <tr>
                                       ...
                                       <tr>
                                        ...
                                        <td>
                                            <b><span id="spanCurrentOutstanding"></span></b>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <select id="ddlpaymentType" name="ddlpaymentType" class="form-control text" style="width:400px;">
                                                ...
                                                <option value="Cash">Exchange</option>
