...
<td><?php echo $result->lapubalance;?></td>
 ...
 <td>
     <a style="width:100px;max-width:100px;font-size:20px;font-family:times" href="javascript:void()" onClick="openrecactionmodel('<?php echo $result->recharge_id; ?>')" class="btn btn-primary btn-sm">Action</a>
     <a id="btnResponseLog" style="width:100px;max-width:100px;font-size:20px;font-family:times" href="javascript:void()" onClick="getreqresplog('<?php echo $result->recharge_id; ?>')" class="btn btn-warning btn-sm">Response</a>
