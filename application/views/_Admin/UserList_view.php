...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
                     ...
                     <?php include("elements/messagebox.php"); ?>
						<div class="row row-sm mg-t-20">
                                    ...
                                    <td valign="bottom">                                         
                                    <input type="submit" id="btnSubmit" name="btnSubmit" value="Search" class="btn btn-primary btn-md">       
                                    <input type="button" id="btnExport" name="btnExport" value="Export To Excel" class="btn btn-success btn-md" onClick="startexoprttwo()">
    ...
    <th style="font-size:20px;color: white;font-family: times">API Id</th>
    <th style="font-size:20px;color: white;font-family: times">API Name</th>
