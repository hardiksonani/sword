    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
					  <div class="br-pageheader">
						<nav class="breadcrumb pd-0 mg-0 tx-12">
						  ...
						  <span class="breadcrumb-item active">Distributor Registration Form</span>
						</nav>
					  </div><!-- br-pageheader -->
					  <!-- d-flex -->
      				 ...
      				 <div class="br-pagebody">
						<?php include("elements/messagebox.php"); ?>
						 <div class="row row-sm mg-t-20">
									 ...
									 <form method="post" action="<?php echo base_url()."_Admin/admin_d_registration"?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">  
                                     <table class="table"> 
                                     <tbody> 
                                     ...
                                     <tr> 
                                         <td>
                                            ...
                                            <input type="text" class="form-control-sm" placeholder="Enter Distributor Name." id="txtDistname" name="txtDistname" value="<?php echo $regData['distributer_name']; ?>"  maxlength="100" style="width:300px;"/> 
                                         </td> 
                                         <td>
                                             <h5>Select Parent:</h5> 
                                             ...
                                             <?php 	
                                             $rlstparent = $this->db->query("select * from tblusers where usertype_name='MasterDealer'"); 	
                                     ...
                                     <tr> 
                                         <td>
                                             <h5>State :</h5> 
                                             <input type="hidden" name="hidStateCode" id="hidStateCode" /> <select style="width:300px;" class="form-control-sm" id="ddlState" name="ddlState" onChange="getCityName('<?php echo base_url()."_Admin/city/getCity/"; ?>')" placehoder="Select State.<br />Click on drop down">
                                     ...
                                     <tr> 				
                                         <td> 					
                                             <h5>Scheme :</h5> 					
                                             <select style="width:300px;" class="form-control-sm" id="ddlSchDesc" onChange="ChangeAmount()" placeholder="Select Scheme Name.<br />Click on drop down" name="ddlSchDesc"> 						  <option>Select Scheme</option> 						  <?php 					
                                             $str_query = "select * from tblgroup where groupfor = 'Distributor'"; 							$resultScheme = $this->db->query($str_query);		 							
