...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
   ...
   <script language="javascript">
    ...
    {
        $.ajax({
        url:'<?php echo base_url(); ?>_Admin/groupapi_utility/getresult?groupid='+document.getElementById("ddlgroup").value,
        method:'POST',
        cache:false,
    ...
    function changeapi(i)
    {
      ...
      $.ajax({
          url: '<?php echo base_url(); ?>_Admin/groupapi_utility/changeapi?company_id='+i+'&api_id='+apiid+'&group_id='+groupid,
          type: 'POST',
    ...
    function changecommission(id,ddd)
    {
            //alert(id+"    "+ddd)
    var SdComm = document.getElementById("txtSdComm"+id).value;
    var MdComm = document.getElementById("txtMdComm"+id).value;
    var DComm = document.getElementById("txtDComm"+id).value;
        var RComm = document.getElementById("txtRComm"+id).value;
  ...
  //  document.getElementById("responsespanfailure_BDEL").style.display = "none"; 
    ...
    $.ajax({
  url: '<?php echo base_url(); ?>_Admin/groupapi_utility/changecommission?groupid='+document.getElementById("ddlgroup").value+'&SdComm='+SdComm+'&service_id='+id+'&MdComm='+MdComm+'&DComm='+DComm+'&RComm='+RComm+'&comtype='+comtype,
  type: 'POST',
  success:function(html)
  {
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Utility Commission Settings</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="br-pagetitle">
        <div>
          <h4>Utility Commission Setting</h4>
        </div>
      </div><!-- d-flex -->
...
<?php
  $group_rslt = $this->db->query("select * from utility_group");
