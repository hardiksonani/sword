...
<body class="fix-header card-no-border logo-center">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h4 class="text-themecolor m-b-0 m-t-0">BUSINESS REPORT</h4>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <nav class="breadcrumb">
                                    ...
                                    <a class="breadcrumb-item" href="<?php echo base_url()."_Admin/list_recharge?crypt=".$this->Common_methods->encrypt("MyData"); ?>">Recharge Report</a>
                                    ...
                                    <span class="breadcrumb-item active">BUSINESS REPORT</span>
                                </nav>
                        </div>
    ...
    {
        document.getElementById("hidfrm").value = document.getElementById("txtFrom").value;
        document.getElementById("hidto").value = document.getElementById("txtTo").value;
    	document.getElementById("frmexp").submit();
    	
    }
	</script>
    <form id="frmexp" action="<?php echo base_url()."_Admin/business_report/dataexporttwo" ?>" method="get">
       ...
       <table class="table  table-striped table-bordered mytable-border" style="color:#000000;font-weight:normal;font-family:sans-serif;font-size:14px;overflow:hidden">
        ...
        $tcommission_amount = 0;
             ...
             $i=0; foreach($result_recharge->result() as $rslt) 	
            {
            $commission = 0;
			$totalrec = 0;
