    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagetitle">
        ...
        <span class="breadcrumb-item active">
            <button class="btn btn-danger btn-xs" type="button" style="font-size:14px;">Total Balance : <?php echo $summary["CreditBalance"]; ?></button>
          </span>
          <span class="breadcrumb-item active">
            <button class="btn btn-success btn-xs" type="button" style="font-size:14px;">Total CASH : <?php echo $summary["CashReceived"]; ?></button>
          </span>
                                    ...
                                    <td style="padding-right:10px;">
                                    	...
                                    	<td style="padding-right:10px;">
                                           ...
                                           <select id="ddluser" name="ddluser" class="form-control" style="width: 120px">
											                       ...
											                       <?php
                                             $rsltusers = $this->db->query("select a.chield_id,b.businessname,b.usertype_name from creditmaster a left join tblusers b on a.chield_id = b.user_id  
                                              where a.parent_id = 1
                                              group by a.chield_id order by b.businessname");
