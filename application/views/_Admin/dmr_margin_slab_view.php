...
function SetEdit(value)
	{
		...
		document.getElementById('ddldistChargeType').value=document.getElementById("dist_charge_type_"+value).value;
		document.getElementById('txtDistCharge').value=document.getElementById("dist_charge_value_"+value).value;
         	...
         	<div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                <table class="table table-striped" style="color:#000000;font-weight:normal;font-family:sans-serif;font-size:14px;overflow:hidden">
                                    ...
                                    <th>#</th>                                             
                                    <th>Slab Name</th>     
                                    <th>Distributor Charge</th>
                                    <th>Dist Charge Type</th>                                        
                                    <th>Action</th>                                         
                                    </tr>                                     
                                    </thead>                                     
                                    <tbody>                                    
                                    ...
                                    <?php echo $row->charge_type; ?> 												
                                      ...
                                      <td>
                                            <?php echo $row->dist_charge_value; ?>
                                        <input type="hidden" id="dist_charge_value_<?php echo $row->Id;  ?>" value="<?php echo $row->dist_charge_value; ?>">
                                      </td>
                                      <td>
                                        <?php echo $row->dist_charge_type; ?>
                                        <input type="hidden" id="dist_charge_type_<?php echo $row->Id;  ?>" value="<?php echo $row->dist_charge_type; ?>">
