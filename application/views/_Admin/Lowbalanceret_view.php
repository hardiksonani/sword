...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<title>Low BALANCE Retailer List</title>
						...
						<div class="row row-sm mg-t-20">
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
                                          ...
                                          <form action="<?php echo base_url()."_Admin/Lowbalanceret" ?>" method="post" name="frmCallAction" id="frmCallAction">                            
                                    <input type="hidden" id="hidID" name="hidID">                                     
                                    <table cellspacing="20" cellpadding="3">                                     
                                    <tr>                                     	
                                    <td style="padding-right:30px;">                                         	 
                                    <button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;width:180px;">&nbsp;Agent Name</button><br><br>
                                                          
                                    <input class="autocomplete" id="txtAGENTName" value="<?php echo $txtAGENTName; ?>" name="txtAGENTName" type="text" style="width:180px;" placeholder="AGENT NAME">                                         
                                    </td>                                         
                                    <!--<td style="padding-right:30px;">                                         	 
                                    <button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;width:180px;background-color: #4CAF50;">&nbsp;Agent MOb NO</button><br><br>                                            
                                    <input class="autocomplete" id="txtAGENTId" value="<?php echo $txtAGENTId; ?>" name="txtAGENTId" type="text" style="width:180px;" placeholder="AGENT MOB NO">                                         
                                    </td>  -->                                       
                                    <td style="padding-right:30px;">                                         	 
                                    <button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;background-color: #824caf;">&nbsp;MOBILE NUMBER</button><br><br>                                              
                                    <input class="autocomplete" id="txtMOBILENo" value="<?php echo $txtMOBILENo; ?>" name="txtMOBILENo" type="text" style="width:205px;" placeholder="AGENT MOBILE NO">                                         
                                    </td>                                         
                                    <td style="padding-right:30px;">                                         	 
                                    <button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;background-color: #abaf4c;">&nbsp;PARENT MOBILE</button><br><br>                                              
                                    <input class="autocomplete" id="txtParentMobile" value="<?php echo $txtParentMobile; ?>" name="txtParentMobile" type="text" style="width:200px;" placeholder="PARENT MOBILE NO">                                         
                                    </td>    
                                    <td valign="bottom">                                         
                                    <input type="submit" id="btnSubmit" name="btnSubmit" value="Search" class="btn btn-primary btn-sm" style="font-size:24px;">       
                                    <input type="button" id="btnExport" name="btnExport" value="Export To Excel" class="btn btn-success btn-sm" onClick="startexoprttwo2()">
                                    
                    
                    
                    
                    <form id="frmexport" name="frmexport" action="<?php echo base_url()."_Admin/Lowbalanceret/dataexporttwo"; ?>" method="get">
                        <input type="hidden" id="tempid" name="tempid">
                    </form>
                                    
    <form id="frmexp1123" action="<?php echo base_url()."_Admin/Lowbalanceret/dataexporttwo"; ?>" method="get">
    </form>                                
...
function startexoprttwo2()
{
	document.getElementById("frmexport").submit();
						 ...
						 <div class="row row-sm mg-t-20">
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
										  <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
											<h6 class="card-title tx-uppercase tx-12 mg-b-0">LoW BALANCE LIST</h6>
											<span class="tx-12 tx-uppercase">
												
											</span>
										  </div><!-- card-header -->
										  <div class="card-body">                            
      <table class="table table-bordered tx-uppercase" style="color:#000000;font-weight:normal;font-family:times;font-size:18px;overflow:hidden">
    <tr>
    <tr style="background-color:#f01d75;font-size:16px;text-align=center;font-weight:bold">
    <th style="font-size:20px;color: white;font-family: times">Sr No</th>
    <th style="font-size:20px;color: white;font-family: times">Retailer Id</th>
    <th style="font-size:20px;color: white;font-family: times">Retailer Name</th>
    <th style="font-size:20px;color: white;font-family: times">Parent Name</th>
    <th style="font-size:20px;color: white;font-family: times">Mobile</th>
    <th style="font-size:20px;color: white;font-family: times">BAlance</th>
    <!-- <th style="display: none;">State</th>   
	   <th style="display: none;">City</th> 
	   <th style="display: none;">Group Name</th> 
	   <th style="width: 80px;display: none;">Grouping</th> 
	   <th style="font-size:20px;color: white;font-family: times">DMR.GROUP</th>
       <th style="font-size:20px;color: white;font-family: times">Utility.GROUP</th>
	   <th style="font-size:20px;color: white;font-family: times">Balance</th> 
	   <th style="font-size:20px;color: white;font-family: times">Login</th>
    ...
    <?php
         ...
         $utilitygroup_dropdownitem = '';
        $rsltutilitygroup = $this->db->query("select * from utility_group ");
        foreach($rsltutilitygroup->result() as $utilityrow)
        {
          $utilitygroup_dropdownitem .='<option value="'.$utilityrow->Id.'">'.$utilityrow->Name.'</option>';
        } 
...
<td ><a href="<?php echo base_url()."_Admin/profile?usertype=".$this->Common_methods->encrypt("Distributor")."&user_id=".$this->Common_methods->encrypt($result->parentid);?>" target="_blank"><?php echo $result->parent_name; ?></a></td>
 ...
 <td style="display: none;"><?php echo $result->state_name; ?></td>
 <td  style="display: none;"><?php echo $result->city_name; ?></td>
<td  style="display: none;"><?php echo $result->group_name; ?></td>
...
< 
		...
		$i++;} ?>
                                        ...
                                        <?php  echo $pagination; ?>         
                                      <form id="frmstatuschange" action="<?php echo base_url()."_Admin/Lowbalanceret"; ?>" method="post"> 
                                      ...
                                      {  	
                                          ...
                                          $.ajax({ 	
                                              url:'<?php echo base_url()."_Admin/Lowbalanceret/minRechargeLimit";?>?minrechargelimit='+minrechargelimit+'&id='+user_id, 	
                                          method:'POST', 	
                                          cache:false, 	
                                      ...
                                      { 	
                                          ...
                                          $.ajax({ 	
                                              url:'<?php echo base_url()."_Admin/Lowbalanceret/changedmrgroup?id=";?>'+id+'&field='+myval, 	
                                      ...
                                      <input type="hidden" id="hidurltoggle" value="<?php echo base_url()."_Admin/Lowbalanceret/togglegroup"; ?>">         
                                      <script language="javascript"> 		
                                      ...
                                      { 			
                                          ...
                                          {       				
                                              $.ajax({ 				
                                                  url:'<?php echo base_url()."_Admin/Lowbalanceret/setvalues?"; ?>Id='+id+'&field=MT&val=1', 				
                                                  cache:false, 				
                                                  method:'POST', 				
                                                  success:function(html) 				
                                                  { 					
                                          ...
                                          { 					   				
                                              $.ajax({ 				
                                                  url:'<?php echo base_url()."_Admin/Lowbalanceret/setvalues?"; ?>Id='+id+'&field=MT&val=0', 				
                                                  cache:false, 				
                                                  method:'POST', 				
                                                  success:function(html) 				
                                                  { 					
                                      ...
                                      function stscheck(id)
                                		{
                                			...
                                			{      
                                				$.ajax({
                                				url:'<?php echo base_url()."_Admin/Lowbalanceret/setvalues?"; ?>Id='+id+'&field=ENABLED&val=yes',
                                				cache:false,
                                				method:'POST',
                                				success:function(html)
                                				{
                                			...
                                			else
                                			{
                                				...
                                				$.ajax({
                                				url:'<?php echo base_url()."_Admin/Lowbalanceret/setvalues?"; ?>Id='+id+'&field=ENABLED&val=no',
                                				cache:false,
                                				method:'POST',
                                				success:function(html)
                                				{
                                        ...
                                        function Confirmation(value)
	{
		...
		if(confirm("Are you sure?\nyou want to delete ") == true)
		{
			...
			document.getElementById('frmDelete').submit();
                                      ...
                                      <input type="hidden" id="hidbaseurl" value="<?php echo base_url()."_Admin/Lowbalanceret"; ?>">  
                                      <input type="hidden" id="hidusers" value="<?php echo  $struser; ?>">  
                                      <form action="<?php echo base_url()."_Admin/Lowbalanceret?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" autocomplete="off" name="frmDelete" id="frmDelete">
