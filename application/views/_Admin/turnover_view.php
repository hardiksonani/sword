...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
              ...
              <div class="card-body">
                  <form action="<?php echo base_url()."_Admin/turnover?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">
                           <input type="hidden" id="hidID" name="hidID">
                                    ...
                                    <br>
                                            <input class="autocomplete" id="txtFromDate" name="txtFromDate" type="text"  style="width:150px;height:43px;cursor:pointer" readonly >
                                        </td>
                                    	<td style="padding-right:10px;">
                                      <button class="btn btn-success btn-sm" type="button" style="width:150px;font-size:24px;border-radius: 10px;background-color:#7300e6">TO DATE</button><br>
                                    <br>
                                            <input class="autocomplete" id="txtToDate" name="txtToDate" type="text"  style="width:150px;height:43px;cursor:pointer" readonly >
                                        </td>
    ...
    <th style="font-size:20px;color: white;font-family: times">Success</th>
    <th style="font-size:20px;color: white;font-family: times">Success Count</th>
    <th style="font-size:20px;color: white;font-family: times">Success Per(%)</th>
    <th style="font-size:20px;color: white;font-family: times">Failure</th>  
    <th style="font-size:20px;color: white;font-family: times">Failure Count</th> 
    <th style="font-size:20px;color: white;font-family: times">Failure Per(%)</th>  
     </tr>
    </tr>
