...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title><?php echo $this->white->getName(); ?> RECHARGE</title>
    ...
    <div class="br-mainpanel">
                ...
                <div class="card-body pd-0">
                   <div class="card-body" >
                                ...
                                <div class="table-responsive">
                                     ...
                                     <table class="table  table-bordered bordered" style="color:#000000;border:1px solid #000">
                                            <tr style="border:1px solid #000">
                                                <td  class="btn-default" align="center" style="border:1px solid #000" ></td>
                                                <td class="btn-success" align="center" style="border:1px solid #000">Success</td>
                                                <td class="btn-primary" align="center" style="border:1px solid #000">Pending</td>
                                                <td class="btn-danger" align="center" style="border:1px solid #000">Failure</td>
                                            </tr>
                                            <tr>
                                                <td  class="btn-default" align="center" style="border:1px solid #000">Today Recharge</td>
                                                <td  align="center" class="" style="border:1px solid #000"><a  style="color:#000" href="<?php echo base_url()."_Admin/list_recharge/filter?date=today&status=Success"; ?>"><b><span id="valsuccess"></span></b></a></td>
                                                <td class="" align="center" style="border:1px solid #000"><a style="color:#000"  href="<?php echo base_url()."_Admin/list_recharge/filter?date=today&status=Pending"; ?>"><b><span id="valpending"></span></b></a></td>
                                                <td class="" align="center" style="border:1px solid #000"><a style="color:#000"  href="<?php echo base_url()."_Admin/list_recharge/filter?date=today&status=Failure"; ?>"><b><span id="valfailure"></span></b></a></td>
                                            </tr>
                                            
                                            <tr>
                                                <td class="btn-default"  align="center" style="border:1px solid #000">Today DMT</td>
                                                <td class="" align="center" style="border:1px solid #000"><b><span id="valdmrsuccess"></span></b></td>
                                                <td class="" align="center" style="border:1px solid #000"><b><span id="valdmrpending"></span></b></td>
                                                <td class="" align="center" style="border:1px solid #000"><b><span id="valdmrfailure"></span></b></td>
                                            </tr>
                                    </table>
                                    
                                    <table class="table color-table success-table" style="border:1px solid #000">
                                      
                                        <tbody>
                                            
                                            <tr>
                                                <td style="border:1px solid #000"><b>Yesterday Success Recharge</b></td><td style="border:1px solid #000"><b><span id="valyesterdaysuccess"></span></b> | <b><span id="valyesterdaysuccess_count"></b></td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="border:1px solid #000"><b>Average Daily Recharge</b></td><td style="border:1px solid #000"><b><span id="avg_daily_recharge"></span></b> | <b><span id="avg_daily_recharge_count"></b></td>
                                            </tr>
                                            <tr>
                                                <td style="border:1px solid #000"><b>Last Month Success Recharge</b></td><td style="border:1px solid #000"><b><span id="last_month_success_recharge"></span></b> </td>
                                            </tr>
                                            
                                           
                                            <tr>
                                                <td style="border:1px solid #000"><b>Payment Request Pending</b></td><td style="border:1px solid #000"><b><span id="pending_payment_request"></span></b>   </td>
                                            </tr>
                                            <tr>
                                                <td style="border:1px solid #000"><b>Complain Pending</b></td><td style="border:1px solid #000"><b><span id="pending_complains"></span></b>   </td>
                                            </tr>
                   ...
                   <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <td class="dilip" align="center">API Name</td>
                                                <td class="dilip" align="center">Balance</td>
                                                <td class="dilip" align="center">Pending</td>
                                                <td class="dilip" align="center"">Amount</td>
      ...
      <footer class="br-footer">
        <div class="footer-left">
          <div class="mg-b-2">Copyright &copy; 2020-21. <?php echo $this->white->getName(); ?>. All Rights Reserved.</div>
          <div>Attentively and carefully made by <?php echo $this->white->getName(); ?>.</div>
        </div>
