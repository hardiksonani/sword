          ...
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">Custom Api Setting</h6>
         	...
         	<div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                 <form id="frmAmountApi" role="form" method="post" action="<?php echo base_url()."_Admin/randomapirouting/amountwiseapi?crypt=".$this->Common_methods->encrypt("MyData"); ?>">
                  ...
                  var ddlamountcode = document.getElementById("amtcode"+id).value;

                  var chkcheckoffer = document.getElementById("chkcheckoffer"+id);
                  var checkoffer = "no";
                  if (chkcheckoffer.checked == true)
                  {
                        var checkoffer = "yes";
                  }
                 // alert(ddlamountcode);
                					...
                					data:{'Id':id,"amounts":amounts,'amounts_api':ddlamountapi,'amounts_circle':ddlamountcircle,'code':ddlamountcode,'checkoffer':checkoffer},
                					beforeSend: function() 
                					{
