    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagetitle">
        ...
        <div class="col-sm-6 col-lg-12">
          	    ...
          	    <button class="btn btn-success btn-sm" type="button" style="font-size:24px;border-radius: 10px;background-color:#ff0066">OTF : <?php echo $roffer; ?></button>
            </span>
            
            <span class="breadcrumb-item active">
          	    <button class="btn btn-success btn-sm" type="button" style="font-size:24px;border-radius: 10px;background-color:#7300e6">Profit : <?php echo ($AdminComm + $roffer) - ($retComm + $DComm + $MdComm + $flatcommission); ?></button>
            </span>
            
            <span class="breadcrumb-item active">
          	    <button class="btn btn-success btn-sm" type="button" style="font-size:24px;border-radius: 10px;">Success : <?php echo $totalRecahrge; ?></button>
            </span>
           
              <span class="breadcrumb-item active">
              	<button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;">Pending : <?php echo $totalpRecahrge; ?></button>
              </span>
              <span class="breadcrumb-item active">
              	<button class="btn btn-danger btn-sm" type="button" style="font-size:24px;border-radius: 10px;">Failure : <?php echo $totalfRecahrge; ?></button>
              </span>
              <span class="breadcrumb-item">
          	    <button class="btn btn-info btn-sm" type="button" style="font-size:18px;border-radius: 10px;">R Comm : <br><?php echo $retComm; ?></button>
            </span>
            <span class="breadcrumb-item">
          	    <button class="btn btn-info btn-sm" type="button" style="font-size:18px;border-radius: 10px;">D Comm : <br><?php echo $DComm; ?></button>
            </span>
             <span class="breadcrumb-item">
          	    <button class="btn btn-info btn-sm" type="button" style="font-size:18px;border-radius: 10px;">M Comm : <br><?php echo $MdComm; ?></button>
            </span>
            
            <span class="breadcrumb-item">
          	    <button class="btn btn-warning btn-sm" type="button" style="font-size:18px;border-radius: 10px;"> Average Comm :<br>
          	    <?php 
              	    if($totalRecahrge > 0)
              	    {
              	    ...
              	    $totalcomper =  ((($MdComm + $DComm + $retComm + $flatcommission ) * 100)/$totalRecahrge);
              	    echo round($totalcomper,2)."  %"; 
              	    }else echo 0;
          	    ?>
          	    </button>
            </span>
            ...
            <span class="breadcrumb-item active">
          	    <button class="btn btn-success btn-sm" type="button" style="font-size:18px;border-radius: 10px;">Admin Commission : <br><?php echo $AdminComm; ?></button>
            </span>
        </div>
      </div><!-- d-flex -->
      ...
      <<div class="br-pagebody">
          ...
          <div class="col-sm-14 col-lg-14">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form action="<?php echo base_url()."_Admin/list_recharge?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmsubmit" id="frmsubmit">
                           <input type="hidden" id="hidID" name="hidID">
                                    <table cellspacing="10" cellpadding="3">
                                    <tr>
                                    <td style="padding-right:10px;text-align: center;color: black">
                                        	 <h5>From Date</h5>
                                           <input class="autocomplete" value="<?php echo $from; ?>" id="txtFrom" name="txtFrom" type="text" style="width:150px;cursor:pointer" readonly >
                                        </td>
                                    	<td style="padding-right:10px;text-align: center;color: black">
                                        	 <h5>To Date</h5>
                                            <input class="autocomplete" value="<?php echo $to; ?>" id="txtTo" name="txtTo" type="text" style="width:150px;cursor:pointer" readonly >
                                        </td>
                                        <td style="padding-right:10px;text-align: center;color: black;">
                                           <h5>User</h5>
                                          <div class="autocomplete" style="width:200px;">
                                                <input id="myInput" type="text" name="ddluser"  value="<?php echo $ddluser; ?>">
                                            </div>
                                            <script language="javascript">
                                        ...
                                        <td style="padding-right:10px;text-align: center;color: black">
                                        	 <h5>Status</h5>
                                           <select id="ddlstatus" name="ddlstatus" class="autocomplete" style="width:200px;height:43px;border: 2px solid black">
                                        ...
                                        <td style="padding-right:10px;text-align: center;color: black">
                                        	 <h5>Operator</h5>
                                           <select id="ddloperator" name="ddloperator" class="autocomplete" style="width:200px;height:43px;border: 2px solid black">
                                           	<option value="ALL">ALL</option>
                                        ...
                                        <td style="padding-right:10px;text-align: center;color: black">
                                        	 <h5>Re-root</h5>
                                           <select id="ddlreroot" name="ddlreroot" class="autocomplete" style="width:200px;height:43px;border: 2px solid black">
                                           	<option value="ALL">ALL</option>
										...
										<td style="padding-right:10px;text-align: center;color: black">
                                        	 <h5>Data</h5>
                                           <select id="ddldb" name="ddldb" class="autocomplete" style="width:100px;height:43px;border: 2px solid black">
                                        ...
                                        <td valign="bottom">
                                        <input type="submit" id="btnSubmit" name="btnSubmit" value="Submit" class="btn btn-primary btn-sm" style="font-size:22px;">
                                        </td>
                                        <td valign="bottom">
                                       
                                        <input type="button" id="btnExport" name="btnExport" value="Export" class="btn btn-success btn-sm" onClick="startexoprt()" style="font-size:22px;">
                                        </td>
                                    ...
                                    <form action="<?php echo base_url()."_Admin/list_recharge?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">
...
<input type="hidden" id="hidaction" name="hidaction" value="Set" />
 ...
 <input type="hidden" id="hidgetautocompletedata" value="<?php echo base_url()."_Admin/AddMainBalance/getUserForAutocompleteTextBox"; ?>">
              </div><!-- card-body -->
            </div><!-- card -->
          </div><!-- col-4 -->
        </div>
    ...
    <table class="table table-bordered is-fullwidth" style="color:#000000;font-weight:normal;font-size:14px;overflow:hidden;border:2px solid;">
    
    <tr>  
    <tr style="background-color:#f01d75;font-size:16px;text-align=center;font-weight:bold;border:8px solid;"> 
    <th style="font-size:20px;color: white;font-family: times">Rec.Id</th>
  
    <th style="font-size:20px;color: white;font-family: times">Transaction Id</th>  
    <th style="font-size:20px;color: white;font-family: times">Rec. Date</th>
    <th style="font-size:20px;color: white;font-family: times">Time</th>
    <th style="font-size:20px;color: white;font-family: times">Agent Name</th>
    <th style="font-size:20px;color: white;font-family: times">opcode</th>
    <th style="font-size:20px;color: white;font-family: times">Mobile No</th>    
    <th style="font-size:20px;color: white;font-family: times">Amt</th>  
    <th style="font-size:20px;color: white;font-family: times">otf</th>
    ...
    <th style="font-size:18px;color: white;font-family: times">API Last<br>Balance</th>
    <th style="font-size:20px;color: white;font-family: times"></th>
	 
	 
    
    <th style="font-size:20px;color: white;font-family: times">Ret<br>Comm.</th>
    <th style="font-size:20px;color: white;font-family: times">Dist<br>Comm.</th>
    <th style="font-size:20px;color: white;font-family: times">Md<br>Comm.</th>
    <th style="font-size:20px;color: white;font-family: times">Total<br>Comm.</th>
    <th style="font-size:20px;color: white;font-family: times">Total<br>Comm(%)</th>
    <th style="font-size:20px;color: white;font-family: times">Admin<br>Comm</th>
    <th style="font-size:20px;color: white;font-family: times">Profit</th>
    </tr>
    ...
    $DComm = 0;
    $MdComm = 0;
    $strrecid = "";$totalRecharge = 0;	$i = count($result_recharge->result());
 ...
 <td style="font-size:10px;"><?php echo $this->common->change_date_format($result->add_date); ?></td>
 <td>
     <?php 
 ...
 <td><?php echo $result->roffer; ?></td>
 <td style="width:100px;font-weight:bold;color:#3366cc;font-size:20px;font-family:times" id="tdstatus<?php echo $result->recharge_id; ?>">
 <?php 
...
<td><?php echo $result->lapubalance;?></td>
 ...
 <td>
     <a style="width:100px;max-width:100px;font-size:20px;font-family:times" href="javascript:void()" onClick="openrecactionmodel('<?php echo $result->recharge_id; ?>')" class="btn btn-oblong btn-primary btn-sm">Action</a>
     <a id="btnResponseLog" style="width:100px;max-width:100px;font-size:20px;font-family:times" href="javascript:void()" onClick="getreqresplog('<?php echo $result->recharge_id; ?>')" class="btn btn-oblong btn-warning btn-sm">Response</a>
     
 </td>
 
 
  
  <td><?php echo $commission_amount; ?></td>
 <td><?php echo $DComm; ?><br><?php echo $result->flat_commission; ?></td>
 <td><?php echo $MdComm; ?></td>
 <?php 

//echo $commission_amount."   ".$DComm."    ".$MdComm;exit;

 $totalCommGiven = (floatval($commission_amount) + floatval($DComm) + floatval($MdComm));
 $totalCommGiven = round($totalCommGiven,2);
 ?>
 <td><?php echo $totalCommGiven; ?></td>
 <td><?php echo round((($totalCommGiven * 100)/$result->amount),2); ?></td>
 <td><?php echo round($AdminComm,2); ?></td>
 <td><?php echo round($Profit,2); ?></td>
      ...
      for (i = 0; i < arr.length; i++) {
        ...
        if(arr[i].toUpperCase().includes(val.toUpperCase()))
        {
          ...
          b.addEventListener("click", function(e) {
              ...
              document.getElementById("spanCurrentOutstanding").innerHTML  = this.getElementsByTagName("input")[0].value.split(" ^-^ ")[4];
