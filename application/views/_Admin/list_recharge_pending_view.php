...
<html lang="en">
 ...
 <meta charset="utf-8">
    ...
    <title>SUDHIR PENDING RECHARGE REPORT</title>
  ...
  <?php include("elements/linksheader.php"); ?>
    ...
    {
      $.ajax({
        url:'<?php echo base_url()."_Admin/list_recharge_pending/checkstatus";?>',
        type:'post',
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">SUDHIR PENDING RECHARGE REPORT</span>
        </nav>
      </div><!-- br-pageheader -->
        ...
        <div class="row row-sm mg-t-20">
          ...
          <div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">SUDHIR PENDING RECHARGE REPORT</h6>
...
<td>
 ...
 <tr id="tr_reqresp<?php echo $result->recharge_id; ?>" style="display:none">
   ...
   <form id="frmexport" name="frmexport" action="<?php echo base_url()."_Admin/list_recharge_pending/dataexport" ?>" method="get">
  ...
  <div class="modal fade" id="myActionModal" role="dialog">
    <div class="modal-dialog"  >
      <div class="modal-content" style="width:600px;">
        ...
        <input type="hidden" id="hidrefundmethodurl" value="<?php echo base_url()."_Admin/list_recharge_pending/dorefund"; ?>"> 
        <input type="hidden" id="hidstatusmethodurl" value="<?php echo base_url()."_Admin/list_recharge_pending/checkstatus"; ?>"> 
        <input type="hidden" id="hidsuccessmethodurl" value="<?php echo base_url()."_Admin/list_recharge_pending/dosuccess"; ?>"> 
        <input type="hidden" id="hidresendtoothermethodurl" value="<?php echo base_url()."_Admin/list_recharge_pending/resendtoanotherapi"; ?>"> 
        <input type="hidden" id="hidstatusupdateurl" value="<?php echo base_url()."_Admin/list_recharge_pending/statusupdatebyddl" ?>">
