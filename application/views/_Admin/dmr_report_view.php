...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>DMR TRANSACTION LIST</title>
...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
       ...
       <div class="col-sm-6 col-lg-3">
        ...
        <div class="col-sm-6 col-lg-9">
            ...
            <span class="breadcrumb-item">
          	<button class="btn btn-outline btn-sm" type="button" style="font-size:14px;">CCF : <?php echo $summary_array["total_ccf"]; ?></button>
            </span>
            
            <span class="breadcrumb-item">
          	<button class="btn btn-outline btn-sm" type="button" style="font-size:14px;">CASHBACK : <?php echo $summary_array["total_cashback"]; ?></button>
            </span>
            
            <span class="breadcrumb-item">
          	<button class="btn btn-outline btn-sm" type="button" style="font-size:14px;">TDS : <?php echo $summary_array["total_tds"]; ?></button>
            </span>
      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                 <form action="<?php echo base_url()."_Admin/dmr_report?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmReport" id="frmReport">
            <table class="table">
            <tr>
            	<td>
                	<label>From Date :</label>
                    <input type="text" readonly name="txtFrom" id="txtFrom" value="<?php echo $from; ?>" class="autocomplete" title="Select From Date." maxlength="10"  style="cursor: pointer;width:180px;height:45px;border: 2px solid black"/>
                </td>
                <td>
                	<label>To Date :</label>
                    <input type="text" readonly name="txtTo" id="txtTo" class="autocomplete" value="<?php echo $to; ?>" title="Select From To." maxlength="10" style="cursor: pointer;width:180px;height:45px;border: 2px solid black"/>
                </td>
				<td>
                	<label>Status :</label>
                    <select id="ddlstatus" name="ddlstatus" class="autocomplete"style="width:180px;height:45px;border: 2px solid black" >
                ...
                <td>
                	<label>API :</label>
                    <select id="ddlapi" name="ddlapi" class="autocomplete"style="width:180px;height:45px;border: 2px solid black" >
						<option value="ALL">ALL</option>
				...
				<td>
                    ...
                    <input type="text" name="txtRemitter" id="txtRemitter" class="autocomplete" value="<?php echo $txtRemitter; ?>"  maxlength="10"style="width:180px;height:45px;border: 2px solid black"  />
                </td>
                <td>
                	<label>Account No :</label>
                    <input type="text" name="txtAccNo" id="txtAccNo" class="autocomplete" value="<?php echo $txtAccNo; ?>"  maxlength="30"style="width:180px;height:45px;border: 2px solid black" />
                </td>
				 <td>
                	<label>UserId :</label>
                    <input type="text" name="txtUserId" id="txtUserId" class="autocomplete" value="<?php echo $txtUserId; ?>"  maxlength="10"style="width:180px;height:45px;border: 2px solid black"  />
                </td>
				
				<td>
                	<label>Data :</label>
                    <select id="ddldb" name="ddldb" class="autocomplete"style="width:180px;height:45px;border: 2px solid black" >
                ...
                <td colspan="4">
                	<label></label>
                  <input type="submit" name="btnSearch" id="btnSearch" value="Search" class="btn btn-success btn-md" title="Click to search." />
    ...
    <th style="font-size:16px;color: white;font-family: times">API</th>
    <th style="font-size:16px;color: white;font-family: times">ID</th>
                    
    <th style="font-size:16px;color: white;font-family: times">DateTime</th>
    <th style="font-size:16px;color: white;font-family: times">Time</th>
    <th style="font-size:16px;color: white;font-family: times">AgentName</th>
    <th style="font-size:16px;color: white;font-family: times">Remitter</th> 
                 
    <th style="font-size:16px;color: white;font-family: times">AccountNo</th>
                         
    <th style="font-size:16px;color: white;font-family: times">Amount</th>
    <th style="font-size:16px;color: white;font-family: times">Bank Ref No</th>        
    <th style="font-size:16px;color: white;font-family: times">Status</th> 
    <th style="font-size:16px;color: white;font-family: times"></th>
    <th style="font-size:16px;color: white;font-family: times"></th> 
                </tr>
                </tr>
              </thead>
 ...
 <td style="display:none"><input class="form-control" style="width: 15px;" type="checkbox" id="chkdmr<?php echo $result->Id;  ?>" name="chkdmr[]" value="<?php echo $result->Id; ?>"> </td>
 <td><?php echo $result->API; ?>
 <br>
