    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Reconciliation Report</span>
        </nav>
      </div><!-- br-pageheader -->
      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form action="<?php echo base_url()."_Admin/rcno?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">
                                        <input type="hidden" id="hidID" name="hidID">
                                    <table cellspacing="10" cellpadding="3">
                                        <tr>
                                        <td style="padding-right:10px;">
                                        <h5> Date</h5>
                                    <input class="form-control-sm datepicker" value="<?php echo $date; ?>" id="txtDate" name="txtDate" type="text" style="width:120px;cursor:pointer;" readonly placeholder="Select Date">
                                    </td>
                                    <td valign="bottom">
                                        <input type="submit" id="btnSubmit" name="btnSubmit" value="Search" class="btn btn-primary">
                                    </td>
                                    </tr>
                                    </table>
                                    </form>
