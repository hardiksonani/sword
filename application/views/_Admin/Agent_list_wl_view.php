...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
						...
						<div class="row row-sm mg-t-20">
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
                                          ...
                                          <form action="<?php echo base_url()."_Admin/agent_list_wl" ?>" method="post" name="frmCallAction" id="frmCallAction">                            
                                    ...
                                    <tr>                                     	
                                       <td>
                                        <h5>HostName</h5>
                                        <input class="form-control-sm" id="txtHostName" value="<?php echo $txtHostName; ?>" name="txtHostName" type="text" style="width:180px;" placeholder="HOST NAME">              
                                      </td>
                                    <td style="padding-right:30px;">                                         	 
                                    <h5>&nbsp;Agent Name</h5>
                                                          
                                    <input class="form-control-sm" id="txtAGENTName" value="<?php echo $txtAGENTName; ?>" name="txtAGENTName" type="text" style="width:180px;" placeholder="AGENT NAME">                                         
                                    </td>                                         
                                    <td style="padding-right:30px;">                                         	 
                                    <h5>&nbsp;Agent ID</h5>
                                    <input class="form-control-sm" id="txtAGENTId" value="<?php echo $txtAGENTId; ?>" name="txtAGENTId" type="text" style="width:180px;" placeholder="AGENT USER ID">                                         
                                    </td>                                         
                                    <td style="padding-right:30px;">                                         	 
                                    <h5>&nbsp;MOBILE NUMBER</h5>
                                          
                                    <input class="form-control-sm" id="txtMOBILENo" value="<?php echo $txtMOBILENo; ?>" name="txtMOBILENo" type="text" style="width:205px;" placeholder="AGENT MOBILE NO">                                         
                                    </td>                                         
                                    <td style="padding-right:30px;">                                         	 
                                    <h5>&nbsp;PARENT MOBILE</h5>                                              
                                    <input class="form-control-sm" id="txtParentMobile" value="<?php echo $txtParentMobile; ?>" name="txtParentMobile" type="text" style="width:200px;" placeholder="PARENT MOBILE NO">                                         
                                    </td>    
                                    <td valign="bottom">                                         
                    ...
                    <form id="frmexport" name="frmexport" action="<?php echo base_url()."_Admin/agent_list_wl/dataexporttwo"; ?>" method="get">
                        <input type="hidden" id="tempid" name="tempid">
                    </form>
                                    
    <form id="frmexp1123" action="<?php echo base_url()."_Admin/agent_list_wl/dataexporttwo"; ?>" method="get">
    </form>                                
...
<table class="table " style="color:#000000;overflow:hidden">
    <tr>
...
<?php if($result->status == 0){echo "<span class='red'><a href='#' onclick='actionDeactivate(".$result->user_id.",1)'>Deactive</a></span>";}else{echo "<span class='green'><a href='#' onclick='actionDeactivate(".$result->user_id.",0)'>Active</a></span>";} ?>
 ...
 <a style="cursor:pointer" class="fas fa-trash-alt" onClick="Confirmation('<?php echo $result->user_id; ?>')"></a> 
		...
		$i++;} ?>
                                        ...
                                        <?php  echo $pagination; ?>         
                                      <form id="frmstatuschange" action="<?php echo base_url()."_Admin/agent_list_wl"; ?>" method="post"> 
                                      ...
                                      {  	
                                          ...
                                          $.ajax({ 	
                                              url:'<?php echo base_url()."_Admin/agent_list_wl/minRechargeLimit";?>?minrechargelimit='+minrechargelimit+'&id='+user_id, 	
                                          method:'POST', 	
                                          cache:false, 	
                                      ...
                                      { 	
                                          ...
                                          $.ajax({ 	
                                              url:'<?php echo base_url()."_Admin/agent_list_wl/changedmrgroup?id=";?>'+id+'&field='+myval, 	
                                      ...
                                      <input type="hidden" id="hidurltoggle" value="<?php echo base_url()."_Admin/agent_list_wl/togglegroup"; ?>">         
                                      <script language="javascript"> 		
                                      ...
                                      { 			
                                          ...
                                          {       				
                                              $.ajax({ 				
                                                  url:'<?php echo base_url()."_Admin/agent_list_wl/setvalues?"; ?>Id='+id+'&field=MT&val=1', 				
                                                  cache:false, 				
                                                  method:'POST', 				
                                                  success:function(html) 				
                                                  { 					
                                          ...
                                          { 					   				
                                              $.ajax({ 				
                                                  url:'<?php echo base_url()."_Admin/agent_list_wl/setvalues?"; ?>Id='+id+'&field=MT&val=0', 				
                                                  cache:false, 				
                                                  method:'POST', 				
                                                  success:function(html) 				
                                                  { 					
                                      ...
                                      function stscheck(id)
                                		{
                                			...
                                			{      
                                				$.ajax({
                                				url:'<?php echo base_url()."_Admin/agent_list_wl/setvalues?"; ?>Id='+id+'&field=ENABLED&val=yes',
                                				cache:false,
                                				method:'POST',
                                				success:function(html)
                                				{
                                			...
                                			else
                                			{
                                				...
                                				$.ajax({
                                				url:'<?php echo base_url()."_Admin/agent_list_wl/setvalues?"; ?>Id='+id+'&field=ENABLED&val=no',
                                				cache:false,
                                				method:'POST',
                                				success:function(html)
                                				{
                                        ...
                                        function Confirmation(value)
	{
		...
		if(confirm("Are you sure?\nyou want to delete ") == true)
		{
			...
			document.getElementById('frmDelete').submit();
                                      ...
                                      <input type="hidden" id="hidbaseurl" value="<?php echo base_url()."_Admin/agent_list_wl"; ?>">  
                                      <input type="hidden" id="hidusers" value="<?php echo  $struser; ?>">  
                                      <form action="<?php echo base_url()."_Admin/agent_list_wl?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" autocomplete="off" name="frmDelete" id="frmDelete">
