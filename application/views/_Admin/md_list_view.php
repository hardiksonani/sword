    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
					  <div class="br-pageheader">
						<nav class="breadcrumb pd-0 mg-0 tx-12">
						  ...
						  <a class="breadcrumb-item" href="#">MasterDealer</a>
						  <span class="breadcrumb-item active">MasterDealer List</span>
						</nav>
					  </div><!-- br-pageheader -->
					  <!-- d-flex -->
                     ...
                     <?php include("elements/messagebox.php"); ?>
						<div class="row row-sm mg-t-20">
                          ...
                          <form action="<?php echo base_url()."_Admin/md_list?crypt=".$this->Common_methods->encrypt("MyData") ?>" method="post" name="frmCallAction" id="frmCallAction">
                           <input type="hidden" id="hidID" name="hidID">
                                    <table cellspacing="10" cellpadding="3">
                                    <tr>
                                    	<td style="padding-right:10px;">
                                        <button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;width:210px;">&nbsp;Master Dist Name</button><br><br>
                                        ...
                                        <td style="padding-right:10px;">
                                        <button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;width:180px;background-color: #4CAF50;">&nbsp;MAster Dist ID</button><br><br>
                                            <input class="autocomplete" id="txtAGENTId" value="<?php echo $txtAGENTId; ?>" name="txtAGENTId" type="text"  placeholder="MasterDealer USER ID">
                         
                                    	</div>
                                        </td>
                                         <td style="padding-right:10px;">
										 <button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;background-color: #824caf;">&nbsp;MAster Dist MO.NO</button><br><br>
										...
										<div class="card shadow-base bd-0">
										  <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
											...
											<span class="tx-12 tx-uppercase">
												<a href="<?php echo base_url()."_Admin/Admin_md_registration" ?>"  class="blue btn btn-primary btn-sm" > <i class="ace-icon fa fa-plus bigger-120"></i>Add New User </a>
                                          ...
                                          <table class="table table-striped" style="color:#000000;font-weight:normal;font-family:times;font-size:14px;overflow:hidden">
    <tr>
...
<?php
 ...
 <td width="180px">
  <a class="far fa-edit" style="font-size:18px;" href="<?php echo base_url()."_Admin/md_edit?id=".$this->Common_methods->encrypt($result->user_id); ?>" title="Edit Franchise"></a> 
   |       
