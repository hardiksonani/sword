    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
                     ...
                     <?php include("elements/messagebox.php"); ?>
						<div class="row row-sm mg-t-20">
                                    ...
                                    <td style="padding-right:30px;">                                         	 
                                    <button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;width:180px;background-color: #4CAF50;">&nbsp;Agent ID</button><br><br>                                            
                                    <input class="autocomplete" id="txtAGENTId" value="<?php echo $txtAGENTId; ?>" name="txtAGENTId" type="text" style="width:180px;" placeholder="AGENT USER ID">                                         
                                    </td>                                         
                                    <td style="padding-right:30px;">                                         	 
                    ...
                    <form id="frmexport" name="frmexport" action="<?php echo base_url()."_Admin/agent_list/dataexporttwo"; ?>" method="get">
                        <input type="hidden" id="tempid" name="tempid">
                    </form>
                                    
    <form id="frmexp1123" action="<?php echo base_url()."_Admin/agent_list/dataexporttwo"; ?>" method="get">
    </form>                                
...
function startexoprttwo2()
{
						 ...
						 <div class="row row-sm mg-t-20">
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
                                          ...
                                          <table class="table table-striped tx-uppercase" style="color:#000000;font-weight:normal;font-family:times;font-size:18px;overflow:hidden">
    <tr>
    ...
    <th style="font-size:20px;color: white;font-family: times">BirthDate</th>
...
<td class="padding_left_10px box_border_bottom box_border_right" align="left" height="34" >
  ...
  <select id="ddlutilitygroup_<?php echo $result->user_id; ?>" onChange="changeutilitygroup('<?php echo $result->user_id; ?>')" style="width:100px;">
    <option value="0">Select</option>
    <option value="0">Default</option>
    <?php echo $utilitygroup_dropdownitem;?>
  </select>
  <script language="javascript">
    document.getElementById("ddlutilitygroup_"+<?php echo $result->user_id; ?>).value = '<?php echo $result->utility_group; ?>';
  </script>
 </td>      
      
<!-- end utility group td -->
...
<?php if($result->status == 0){echo "<span class='red'><a href='#' onclick='actionDeactivate(".$result->user_id.",1)'>Deactive</a></span>";}else{echo "<span class='green'><a href='#' onclick='actionDeactivate(".$result->user_id.",0)'>Active</a></span>";} ?>
 ...
 <td width="180px">
  <a class="far fa-edit" style="font-size:18px;" href="<?php echo base_url()."_Admin/agent_edit?id=".$this->Common_methods->encrypt($result->user_id); ?>" title="Edit Franchise"></a> 
   |       
 ...
 echo '<a class="fas rupee" style="font-size:16px;" title="Transfer Money" href="'.base_url().'_Admin/add_balance2?encrid='.$this->Common_methods->encrypt($result->user_id).'" class="paging"><img style="width:30px;" src="'.base_url().'files/rupee.png"></a> | ';
 ...
 <a style="cursor:pointer" class="fas fa-trash-alt" onClick="Confirmation('<?php echo $result->user_id; ?>')"></a> 
		...
		$i++;} ?>
                                        ...
                                        <?php  echo $pagination; ?>         
                                      <form id="frmstatuschange" action="<?php echo base_url()."_Admin/agent_list"; ?>" method="post"> 
                                      ...
                                      function changeutilitygroup(id) 
                                      {   
                                          var myval = document.getElementById("ddlutilitygroup_"+id).value;   
                                          document.getElementById("ddlutilitygroup_"+id).style.display="none";  
                                          $.ajax({  
                                              url:'<?php echo base_url()."_Admin/UserList/changeutilitygroup?id=";?>'+id+'&field='+myval,   
                                              cache:false,  method:'POST',  
                                              success:function(html)  
                                              {       
                                                  document.getElementById("ddlutilitygroup_"+id).style.display="block";     
                                                  document.getElementById("ddlutilitygroup_"+id).value = html;  
