...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
                      <div class="br-pageheader">
                        <nav class="breadcrumb pd-0 mg-0 tx-12">
                          ...
                          <span class="breadcrumb-item active">SuperDealer List</span>
                        </nav>
                      </div><!-- br-pageheader -->
                      <!-- d-flex -->
                        ...
                        <div class="row row-sm mg-t-20">
                                      <div class="col-sm-12 col-lg-12">
                                        <div class="card shadow-base bd-0">
                                          ...
                                          <form action="<?php echo base_url()."_Admin/sd_list?crypt=".$this->Common_methods->encrypt("MyData") ?>" method="post" name="frmCallAction" id="frmCallAction">
                           <input type="hidden" id="hidID" name="hidID">
                                    <table cellspacing="10" cellpadding="3">
                                    <tr>
                                        <td style="padding-right:30px;">
                                        <button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;width:210px;">&nbsp;Whitelabel Name</button><br><br>
                                            <input class="autocomplete" type="text" value="<?php echo $txtAGENTName; ?>"  id="txtAGENTName" name="txtAGENTName"  placeholder="MasterDealer Name" >    
                                        </div>
                                            
                                        </td>
                                        <td style="padding-right:10px;">
                                        <button class="btn btn-primary btn-sm" type="button" style="font-size:24px;border-radius: 10px;width:180px;background-color: #4CAF50;">&nbsp;Whitelabel ID</button><br><br>
                                            <input class="fautocomplete" id="txtAGENTId" value="<?php echo $txtAGENTId; ?>" name="txtAGENTId" type="text"  placeholder="MasterDealer USER ID">
                                         ...
                                         <input class="autocomplete" id="txtMOBILENo" value="<?php echo $txtMOBILENo; ?>" name="txtMOBILENo" type="text"  placeholder="MasterDealer MOBILE NO">
                                        ...
                                        <div class="card shadow-base bd-0">
                                          <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="tx-12 tx-uppercase">
                                                <a href="<?php echo base_url()."_Admin/Admin_sd_registration" ?>"  class="blue btn btn-primary btn-sm" > <i class="ace-icon fa fa-plus bigger-120"></i>Add New User </a>
    ...
    <th style="font-size:20px;color: white;font-family: times">Agent Id</th>
    ...
    <th style="font-size:20px;color: white;font-family: times">State</th>   
    <th style="font-size:20px;color: white;font-family: times">City</th> 
    <th style="font-size:20px;color: white;font-family: times">Group Name</th> 
    <th style="font-size:20px;color: white;font-family: times">Grouping</th> 
    ...
    <th style="font-size:20px;color: white;font-family: times">DMR</th>
...
<td ><a href="<?php echo base_url()."_Admin/profile?usertype=".$this->Common_methods->encrypt("MasterDealer")."&user_id=".$this->Common_methods->encrypt($result->user_id);?>" target="_blank"><?php 
...
?></a></td>
<td ><a href="<?php echo base_url()."_Admin/profile/view/".$this->Common_methods->encrypt("MasterDealer")."/".$this->Common_methods->encrypt($result->parentid);?>" target="_blank"><?php echo $result->parent_name; ?></a></td>
...
<?php
 ...
 <td width="180px">
  <a class="far fa-edit" style="font-size:18px;" href="<?php echo base_url()."_Admin/sd_edit?id=".$this->Common_methods->encrypt($result->user_id); ?>" title="Edit Franchise"></a> 
   |       
    ...
    function Confirmation(value)
    {
        ...
        if(confirm("Are you sure?\nyou want to delete ") == true)
        {
            ...
            document.getElementById('frmDelete').submit();
                                      ...
                                      <input type="hidden" id="hidbaseurl" value="<?php echo base_url()."_Admin/Md_list"; ?>">  
                                      <input type="hidden" id="hidusers" value="<?php echo  $struser; ?>">  
                                       <form action="<?php echo base_url()."_Admin/md_list?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" autocomplete="off" name="frmDelete" id="frmDelete">
