    ...
    function senderdetails(change) {
      ...
      //
        ...
        if (len == 10) {
            ...
            $.ajax({
                url: '/Retailer/dmrmm_home/Senderdetails',
    ...
    function Registerben() {
        ...
        var benname = $('#benname').val();
           if (senderno != "" && account != "" && ifsccode != "" && originalifsccode != "" && benname!="") {
               $.ajax({
                   url: '/Retailer/dmrmm_home/Register_ben',
...
<script>
    function newsendernumber() {
        ...
        $('#otpsendername').text("");
        $.ajax({
            url: '/Retailer/dmrmm_home/Register_sender',
...
<script>
    function verifyotp() {
        ...
        $.ajax({
            url: '/Retailer/dmrmm_home/Otp_verify_sender',
...
<script>  
    function DMT() {      
       // $('#banknm').val(null).trigger("change");       
        ...
        $('#benadd').hide();
         $.ajax({
            url: '/Retailer/dmrmm_home/DMTreportnew',
            cache: false,
                 type: "GET",
                 cache: false,
               dataType:"html",
...
<script type="text/javascript">
    ...
    function bindDropdownbanklist() {
        ...
        $.ajax({
            type: "POST",
            url: "/Retailer/Dmrmm_home/BindBankDdllist",
            data: '{}',
...
<script>
    function deleteben (idno)
    {
        var senderno = $('#changesender').val();
        $.ajax({
            url: '/Retailer/dmrmm_home/Delete_ben',
...
<script>
    function Accountverify() {
        ...
        if (senderno != "" && account != "" && benIFSC != "" && banknm != "") {
            $.ajax({
                url: '/Retailer/dmrmm_home/Verify_account',
...
<script>
    function Accountverifyagain() {
        ...
        if (senderno != "" && account != "" && benIFSC != "" && banknm != "") {
            $.ajax({
                url: '/Retailer/dmrmm_home/Verify_account_again',
                data: { NUMBER: senderno, account: account, benIFSC: benIFSC, bankname: banknm },
                cache: false,
                type: "POST",
                    beforeSend: function() {
...
<script>
    function TransferDMT() {
        ...
        if (amount != "" && markup != "" && Dmtpin != "" && idproff != undefined) {
            ...
            if (resp == "OK") {
                $.ajax({
                    url: '/Retailer/dmrmm_home/Imps_check_transfer',
...
<script>
    ...
    function finalpay() {
        ...
        if (amount != "" && Dmtpin != "") {
            $.ajax({
                url: '/Retailer/dmrmm_home/imps_transfer',
...
<script>
    function printmoney() {
        ...
        var url = "/Retailer/dmrmm_home/Print_Imps_Pdf?orderid=" + orderid;
...
<script>
    function email() {
        var orderid = $('#responseorderid').text();
        $.ajax({
            url: '/Retailer/dmrmm_home/imps_email',
...
<script>
    function PurchaseAEPS(e) {
        $.ajax({
            url: '/RETAILER/Home/ServiceCharge',
            data: { Service: e },
            cache: false,
            type: "POST",
            dataType: 'json',
    ...
    function FinalPurchaseAEPS(e) {
         $.ajax({
            url: '/RETAILER/Home/ServicePurchase',
            data: { Service: e },
            cache: false,
            type: "POST",
             dataType: 'json',
        ...
        $.ajax({
            ...
            error: function () {
               ...
               $("#loadaeps").hide();
                 ...
                 $.ajax({
            url: '/RETAILER/Home/AEPSreportnew',
            cache: false,
                 type: "GET",
                 cache: false,
               dataType:"html",
...
<script>
    function print(e) {
        if (e == "balance") {
            ...
            var url = "/RETAILER/Home/Print_aeps_balance_Pdf?rrnno=" + rrnno + "&firmname=" + firmname + "&aadhar=" + aadhar + "&mobile=" + mobile + "&remain=" + remain;
            window.open(url, "_blank")
        }
        else if (e == "statement")
        {
            ...
            var url = "/RETAILER/Home/Print_aeps_ministatement_Pdf?txtbankstate=" + txtbankstate + "&txtfrmstate=" + txtfrmstate + "&txtbankaadhar=" + txtbankaadhar + "&txtfrmdate=" + txtfrmdate + "&txtfeeservice=" + txtfeeservice+"&statementtbody="+sttt;
            window.open(url, "_blank")
        }
        else if (e=="transfer") {
...
<script>
    function SendOTP() {
        $('.loader').show();
        var url = '/RETAILER/Home/RetailerOutletRegister'
        $.ajax({
            url: url,
            cache: false,
            type: "POST",
...
<script>
    function otpverify() {
        $('.loader').show();
        var otp = $('#otpShow').val();
        var url = '/RETAILER/Home/EnterOtp'
        $.ajax({
            url: url,
            data: { otp:otp },
            cache: false,
    ...
    $("#txtphone").keyup(function () {
        if (this.value.length == 10) {
            var mobile = $('#txtphone').val();
              var url = '/RETAILER/Home/AEPSNAMEFIND'
            $.ajax({
                url: url,
                data: { mobile: mobile },
                cache: false,
...
<div id="secpur1" class="col-md-12 remitter_button remitter_buttonewq" style="display:none;text-align: center;">
    ...
    function PANCARD() {
            ...
            success: function (data) {
             ...
             $.ajax({
            url: '/RETAILER/Home/PANCARDreportnew',
            cache: false,
                 type: "GET",
                 cache: false,
               dataType:"html",
    ...
    function Register() {
       ...
       var panpancard = $("#panpancard").val();
        ...
        $.ajax({
            url: '/RETAILER/PANCARD/RegisterPSA',
            cache: false,
    ...
    function checkstatus() {
     $.ajax({
            url: '/RETAILER/PANCARD/CheckStatus',
            cache: false,
         type: "POST",
              beforeSend: function() {
                  $('.loader').show();
            ...
            if (validaadhar == true) {
                ...
                if (regex.test(panpancard.toUpperCase())) {
                    ...
                    if (CheckZipCode.test(pinpan)) {
                       $.ajax({
                               url: '/RETAILER/PANCARD/UpdatePSA',
                               cache: false,
    ...
    function purchase() {
        ...
        if (dig > 0 || phy > 0) {
            $.ajax({
                url: '/RETAILER/PANCARD/buyUTIToken',
                cache: false,
...
<div id="secpur2" class="col-md-12 remitter_button remitter_buttonewq" style="display:none;text-align: center;">
    ...
    function MPOS() {
        ...
        $.ajax({
            ...
            $.ajax({
            url: '/RETAILER/Home/MPOSreportnew',
            cache: false,
                 type: "GET",
                 cache: false,
               dataType:"html",
