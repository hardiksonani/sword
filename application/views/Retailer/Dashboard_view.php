<!DOCTYPE html>
<!-- saved from url=(0040)<?php echo base_url(); ?>/Retailer/Home -->
        ...
        <div class="top-navmenup finaciall" style="display: none; ">
            <ul id="leftulbar" class="nav nav-tabs tab-nav-left nav1-tabs1" role="tablist" style="padding-top:5px;border-bottom:none;">
                <li id="dashboard" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/Retailer/Home" aria-expanded="false" style="background:transparent; cursor:pointer;"><i class="fa fa-home" style="color:white;top:-3px;"></i></a>
                </li>
                <li id="recharge" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/Retailer/Home/Index" id="recharge" aria-expanded="false" style="background:transparent;">RECHARGE &amp; BILL</a>
                </li>
                <li id="finanical" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/Retailer/Home/Money_transfer1" aria-expanded="true" style="background:transparent;">FINANCIAL</a>
                </li>
                <li id="Gift" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/Retailer/Home/Gift_Card" aria-expanded="true" style="background:transparent;">GIFT&nbsp;CARDS</a>
                </li>

                <li id="Dth" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/Retailer/DthConnection/Index" aria-expanded="true" style="background:transparent;">NEW-DTH</a>
                </li>
                <li id="travel" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/Retailer/Home/Travel" aria-expanded="true" style="background:transparent;">TRAVEL</a>
                </li>
                <li id="ecommerce" class="listtryp" role="presentation" style="padding:0px; margin-bottom:-27px;">
                    <a href="<?php echo base_url(); ?>/Retailer/ECommerce/Index" aria-expanded="true" style="background:transparent;">E-COMMERCE</a>
                </li>
        ...
        <div class="col-xs-12 col-md-4 cart-p dasborddetail">
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="adminprofile">
                            <div class="body" style="height:294px;margin-top:38px;">
                                <center>
                                    ...
                                    <div class="msg" style="padding-top:16px;">DILIP PATEL</div>
                                </center>
                                ...
                                <center>
                                    <div class="row" style="margin-top:8%;">
                                        ...
                                        <div class="col-xs-6" style="margin-bottom:0px;">
                                            <a href="<?php echo base_url(); ?>/Retailer/Home/Profile" class="btn btn-default waves-effect" type="button" style="text-decoration:none;box-shadow:none; border:1px solid #dddddd;width:100%;margin-left:-10px;"><i class="fa fa-user-circle-o" style="top:1px;font-size:14px;"></i>&nbsp;My&nbsp;Profile</a>
                                        </div>
            ...
            <div class="row">
                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/Retailer/Accountreport">
                    ...
                    <p><a href="<?php echo base_url(); ?>/Retailer/Home/RetailerLedger" style="margin-left:0px;cursor:pointer;font-size:11px;font-weight:700;">Ledger</a></p>
                </div>
                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/Retailer/Daybook">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/123.svg" style="height: 24px; margin-bottom: 8px; width: 23px;">
                        </button>
                    </a><br>
                    <a href="<?php echo base_url(); ?>/Retailer/Daybook" style="margin-left:3px;cursor:pointer;font-size:11px;font-weight:700;">Day&nbsp;Book</a>
                </div>
                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/Retailer/Operatorwisereport">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/money-bag.svg" style="height:24px;margin-bottom:8px;width:23px;">
                        </button>
                    </a><br>
                    <a href="<?php echo base_url(); ?>/Retailer/Operatorwisereport" style="margin-left:4px;cursor:pointer;font-size:11px;font-weight:700;">My&nbsp;Earn</a>
                </div>

                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/Retailer/Home/Set_Referral">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/refer.svg" style="height:24px;margin-bottom:8px;width:23px;">
                        </button>
                    </a><br>
                    <a href="<?php echo base_url(); ?>/Retailer/Home#" style="margin-left:-2px;cursor:pointer;font-size:11px;font-weight:700;">Referral</a>
                </div>
                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/Retailer/Home/Service_Fee">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/support.svg" style="height:24px;margin-bottom:8px;width:23px;">
                        </button>
                    </a><br>
                    <a href="<?php echo base_url(); ?>/Retailer/Home#" style="margin-left:-2px;cursor:pointer;font-size:11px;font-weight:700;">Service&nbsp;Fee</a>
                </div>

                <div class="col-md-3 pay-o repoat-pp">

                    <a href="<?php echo base_url(); ?>/Retailer/Home/WebLogin">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <center>
                    ...
                    <a href="<?php echo base_url(); ?>/Retailer/Home/WebLogin" style="margin-left:2px;cursor:pointer;font-size:11px;font-weight:700;">Login&nbsp;Info</a>

                </div>

                <div class="col-md-3 pay-o repoat-pp">

                    <a href="<?php echo base_url(); ?>/Retailer/Home/Bank_info">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <center>
                    ...
                    <a href="<?php echo base_url(); ?>/Retailer/Home#" style="margin-left:2px;cursor:pointer;font-size:11px;font-weight:700;">Bank&nbsp;&amp;&nbsp;Cash</a>

                </div>

                
                <div class="col-md-3 full-icon marketing-op">
                    <a href="<?php echo base_url(); ?>/Retailer/Home/WalletUnloadReport">
                        ...
                        <a href="<?php echo base_url(); ?>/Retailer/Home/WalletUnloadReport" style="margin-left:-3px;cursor:pointer;font-size:11px;font-weight:700;">Wallet&nbsp;Unload</a>
                </div>
                ...
                <div class="col-md-3 pay-o">
                    ...
                    <a href="<?php echo base_url(); ?>/Retailer/mycommission">
                    ...
                    <a href="<?php echo base_url(); ?>/Retailer/mycommission" style="margin-left:3px;cursor:pointer;font-size:11px;font-weight:700;">Operator&nbsp;Comm</a>

                </div>

                <div class="col-md-3 pay-o markup-po">

                    <a href="<?php echo base_url(); ?>/Retailer/Home/MarkupSetting">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/Markup.svg" style="height:23px;width:23px;">
                        </button>
                    </a>
                    <a href="<?php echo base_url(); ?>/Retailer/Home/MarkupSetting" style="display:block;width:100%;margin-left:-3px;cursor:pointer;font-size:11px;font-weight:700;">Markup&nbsp;Setting</a>

                </div>

                <div class="col-md-3 pay-o dispu">

                    <a href="<?php echo base_url(); ?>/Retailer/Home/DisputeReport">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <center>
                    ...
                    <a href="<?php echo base_url(); ?>/Retailer/Home/DisputeReport" style="margin-left:-8px;cursor:pointer;font-size:11px;font-weight:700;">Dispute&nbsp;List</a>
                ...
                <div class="col-md-3 full-icon">
                    ...
                    <div class="bubblep bubblepss" style="text-align:center;margin:0px auto;display:block;float:none;height:auto !important;">
                        <a href="<?php echo base_url(); ?>/Retailer/Home/Show_Credit_report_by_admin" class="btn btn-default btn-circle waves-effect waves-circle waves-float pull-right dropdown-toggle" role="button" aria-expanded="true" title="My Credit Balance " onclick="showoutstandingbal()">
                            <i class="material-icons" style="color:#000;font-size:35px;margin-top:1px;">bubble_chart</i>
                        </a>
                    </div><br>
                    <div class="my-cre"> <a href="<?php echo base_url(); ?>/Retailer/Home/Show_Credit_report_by_admin" style="font-size:11px;">My Credit</a></div>
                ...
                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/Retailer/Home/Gst_Invocing_Retailer_report">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/tax.svg" style="height:24px;margin-bottom:8px;width:23px;margin-left:2px;">
                        </button>
                    </a><br>
                    <a href="<?php echo base_url(); ?>/Retailer/Home/Gst_Invocing_Retailer_report" style="margin-left:-2px;cursor:pointer;font-size:11px;font-weight:700;">GST&nbsp;&amp;&nbsp;TDS</a>
                </div>
                ...
                <div class="nav-tab" style="padding-top:1px;">
                    ...
                    <ul class="nav nav-tabs token-cpp li-responsivestart" role="tablist" style="padding-bottom:0px;">
                        <li role="presentation" class="active" style=" margin-left:0px;">
                            <a href="<?php echo base_url(); ?>/Retailer/Home#History" data-toggle="tab" aria-expanded="false" class="btn bg-grey waves-effect" onclick="Alltab()">
                        ...
                        <li role="presentation" style="">
                            <a href="<?php echo base_url(); ?>/Retailer/Home#Todaybusiness" id="Today" data-toggle="tab" aria-expanded="false" class="btn bg-grey waves-effect" onclick="today(this)">
                        ...
                        <li role="presentation" style="">
                            <a href="<?php echo base_url(); ?>/Retailer/Home#Todaybusiness" data-toggle="tab" id="Yesterday" aria-expanded="false" class="btn bg-grey waves-effect" onclick="today(this)" style="margin-right: 0px;">
                                            ...
                                            <div class="table-responsive" style="margin-top:-14px;">
                                                <table class="table" style="margin-left:1%;width:98%;">
                                                    <tbody><tr style="border-bottom:1px solid #eeeeee;">
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/Retailer/Home/RechargeReport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/Retailer/Home/Money_Transfer_Report" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/Retailer/Air/TicketReport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/Retailer/Bus/BusBookingReport" style="text-decoration:none;">
                                                                <center>
                                                ...
                                                <table class="table" style="margin-top:-21px;margin-left:1%;width:98%;">
                                                    <tbody><tr style="border-bottom:1px solid #eeeeee;">
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/Retailer/Home/AepsReport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/Retailer/Home/Ecommerce_Report" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/Retailer/Home/m_Possreport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/Retailer/PANCARD/TokenPurchaseReport" style="text-decoration:none;">
                                                                <center>
                                                ...
                                                <table class="table" style="margin-top:-21px;margin-left:1%;width:98%;">
                                                    <tbody><tr style="border-bottom:1px solid #eeeeee;">
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url(); ?>/Retailer/Home#" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/Retailer/Hotel/HotelReport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/Retailer/DthConnection/DthBookingReport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/Retailer/Home/Giftcard_Report" style="text-decoration:none;">
                                                                <center>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active pay-now" id="basicsetting">
                            <div class="body" style="height:332px;">
                                <div class="icon-button-demo">
                                    ...
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/WalletToBankAmountTransfer">
                                            <button type="button" class="btn bg-grey btn-circle-lg waves-effect waves-circle waves-float" style="margin-left:2px;">
                                           <img src="<?php echo base_url();?>vfiles/affiliate-marketing.svg" style="height:26px;">
                                            </button>
                                        </a>
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/WalletToBankAmountTransfer" style="margin-left:-14px;cursor:pointer;font-size:11px;font-weight:700;">Unload&nbsp;Charge's</a>
                                    </div>
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/Bank_info" style="margin-left:0px;cursor:pointer;font-size:11px;font-weight:700;">Bank&nbsp;Info</a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/Operator_info">
                                            <button type="button" class="btn bg-grey btn-circle-lg waves-effect waves-circle waves-float" style="margin-left:8px;">
                                                <img src="<?php echo base_url();?>vfiles/monitoring.svg" style="height:27px;">
                                            </button>
                                        </a>
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/Operator_info" style="margin-left:3px;cursor:pointer;font-size:11px;font-weight:700;">Operator&nbsp;Comm</a>
                                    </div>
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/MarkupSetting" style="margin-left:-9px;cursor:pointer;font-size:11px;font-weight:700;">Markup&nbsp;Setting</a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/WebLogin">
                                            <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                                    ...
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/GST_Report">
                                        ...
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/GST_Report" style="margin-left:-2px;cursor:pointer;font-size:11px;font-weight:700;">Declaration&nbsp;Form</a>
                                    </div>
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/Gst_Invocing_Retailer_report" style="margin-left:-6px;cursor:pointer;font-size:11px;font-weight:700;">GST&nbsp;&amp;&nbsp;TDS</a>
                                    </div>

                                    

                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/Help">
                                        ...
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/Help" style="margin-left:25px;cursor:pointer;font-size:11px;font-weight:700;">Help</a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="body" style="margin-top:-31px;">
                                <div class="icon-button-demo">
                              <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/Purchase_ORDER">
                                            <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                                       <img src="<?php echo base_url();?>vfiles/purchase.svg" style="height:24px;margin-bottom:10px;width:23px;margin-left:4px;">
                                            </button>
                                        </a>
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/Purchase_ORDER" style="margin-left:-14px;cursor:pointer;font-size:11px;font-weight:700;">Purchase&nbsp;Req</a>
                                    </div>
                                
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/Retailer_to_retailer">
                                            <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                                                <center>
                                        ...
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/Retailer_to_retailer" style="margin-left:-9px;cursor:pointer;font-size:11px;font-weight:700;">R&nbsp;to&nbsp;R&nbsp;Transfer</a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/WalletUnloadReport">
                                        ...
                                        <a href="<?php echo base_url(); ?>/Retailer/Home/WalletUnloadReport" style="margin-left:-2px;cursor:pointer;font-size:11px;font-weight:700;">Unload&nbsp;Wallet</a>
                                    </div>
...
<script>
    function today(a)
    {
        ...
        //call ajax
        $.ajax({
            url: '/Retailer/Home/Show_Today_All_Recharge',
            type: 'POST',
            dataType: "html",
            data: { yesterday: x },
