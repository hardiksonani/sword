      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                 <form action="<?php echo base_url()."Retailer/bill_report?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmReport" id="frmReport">
            ...
            <tr>
                ...
                <td style="padding-top:30px;">
                  ...
                  <input type="submit" name="btnSearch" id="btnSearch" value="Search" class="btn btn-success" title="Click to search." />
							...
							<form id="frmexport" name="frmexport" action="<?php echo base_url()."Retailer/bill_report/dataexport" ?>" method="get">
...
<td>
    ...
    <a href="<?php echo base_url()."Retailer/print_bill_online_copy?idstr=".$this->Common_methods->encrypt($result->Id)."&idstr2=".$this->Common_methods->encrypt($result->user_id); ?>" target="_blank">Print</a>
    <?php } ?>
</td>	
