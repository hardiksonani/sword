    ...
    <div class="loginPage">
      ...
      <div class="login-wrapper">
        <div class="LogoBox">
              ...
              <table>
                  <tr>
                      <td align="center"> <img src="<?php echo base_url(); ?>maharshi_logo.png" style="width:280px;"></td>
        ...
        <div class="loginBox" style="background-color:#f502c0">
          <div class="heading">
            <h3 style="color:#FFFFFF">Enter Passcode To Login</h3>
            <p style="color:#FFFFFF">Enter Passcode From Authenticator App</p>
          </div>
          <?php echo form_open('',array('id'=>"frmLogin",'method'=>'post'))?>
          <div class="form-group">
            <input type="text" class="form-control" placeholder="Passcode" id="txtPasscode" name="txtPasscode">
              <input type="hidden" id="txtKey" name="txtKey" value="<?php echo $key; ?>">
          </div><!-- form-group -->
          
          <div class="actionRow">
            <button type="submit" class="btn-info buttonSignIn">Submit</button>
            <a href="<?php base_url()."login"; ?>" class="forgotLink">Back To Login</a>
          </div>
          <?php echo form_close();?>
          <?php
