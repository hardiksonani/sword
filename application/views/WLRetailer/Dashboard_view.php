...
<html lang="en">
  ...
  <body>
   ...
   <!-- ########## START: LEFT PANEL ########## -->
    ...
    <?php include("elements/wlagentsidebar.php"); ?><!-- br-sideleft -->
    <!-- ########## END: LEFT PANEL ########## -->

    <!-- ########## START: HEAD PANEL ########## -->
    <?php include("elements/wlagentheader.php"); ?><!-- br-header -->
    <!-- ########## END: HEAD PANEL ########## -->
      ...
      <div class="col-sm-6 col-lg-6">
                  <div class="bg-primary rounded overflow-hidden">
                    <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                      ...
                      <div class="mg-l-20">
                        <p class="tx-20 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">For Auto Balance Topup </p>
                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Account Number : PDRS91SWORLD<?php echo $this->session->userdata("WLAgentId"); ?> </p>
                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">IFSC Code : ICIC0000106</p>
          ...
          <div class="col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-footer tx-12 pd-y-15 bg-transparent">
                <a href="<?php echo base_url()."WLRetailer/Dmr_report?crypt=".$this->Common_methods->getAgentBalance($this->session->userdata("ApiId")); ?>"><i class="fa fa-angle-down mg-r-5"></i>View All Transaction History</a>
              </div><!-- card-footer -->
            </div><!-- card -->
          </div><!-- col-6 -->
          <!-- col-6 -->
    ...
    <script src="<?php echo base_url(); ?>js/widgets.js"></script>
		...
		function getrechargesummary()
		{
			$.ajax({
					type: "GET",
					url: '<?php echo base_url(); ?>WLRetailer/Dashboard/getSummary',
					cache: false,
		...
		function getlasttransactions()
		{
			$.ajax({
					type: "GET",
					url: '<?php echo base_url(); ?>WLRetailer/Dashboard/getLastTransactions',
					cache: false,
					success: function(html)
					{
		...
		$.ajax({
					type: "GET",
					url: '<?php echo base_url(); ?>WLRetailer/dashboard/getTodaysHourSale',
					cache: false,
					success: function(html)
					{
						var jsonobj = JSON.parse(html);
