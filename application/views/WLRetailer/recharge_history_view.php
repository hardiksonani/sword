...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          <a class="breadcrumb-item" href="<?php echo base_url()."WLRetailer/dashboard"; ?>">Dashboard</a>
    ...
    <input type="hidden" id="hidmsg" name="hidmsg">
                           ...
                           <form action="<?php echo base_url()."WLRetailer/recharge_history?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">
                           <input type="hidden" id="hidID" name="hidID">
                                    ...
                                    <form id="frmexport" name="frmexport" action="<?php echo base_url()."WLRetailer/recharge_history/dataexport" ?>" method="get">
...
<td>
 ...
 <td>
  <?php echo "<span id='db_mobile".$i."'>".$result->mobile_no."</span>"; ?><br>
