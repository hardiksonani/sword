...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
    ...
    <div class="br-mainpanel">
         	...
         	<div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                ...
                <div class="divsmcontainer" style="text-align:center">
                    	<a href="<?php echo base_url()."API/dmrmm_bene_registration?crypt=".$this->Common_methods->encrypt("MyData"); ?>" class="btn btn-success">Add New Receiver</a>
                    </div>
              </div><!-- card-body -->
            </div>
      ...
      <input type="hidden" id="hidurllivedata" value="<?php echo base_url()."API/recharge_home/getLiveTransactions"; ?>">
		<input type="hidden" id="hidurlcheckotp" value="<?php echo base_url()."API/dmrmm_dashboard/checksender_mastermoney"; ?>">
		<input type="hidden" id="hidurlregsendermm" value="<?php echo base_url()."API/dmrmm_dashboard/sendererg_mastermoney"; ?>">
      
     
      <input type="hidden" id="hidacvalurl" value="<?php echo base_url()."API/dmrmm_dashboard/getAccountvalidate"; ?>">
	...
	<form action="<?php echo base_url()."API/dmr2_home?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmdmr" id="frmdmr">
    ...
    <form id="frmtxn" method="post" action="<?php echo base_url()."API/dmrmm_transaction?cr=".$this->Common_methods->encrypt("MyData"); ?>">
     ...
     <input type="hidden" id="hidbregvalurl" value="<?php echo base_url()."API/dmrmm_bene_registration"; ?>">
      <input type="hidden" id="hiddashboardurl" value="<?php echo base_url()."API/dmrmm_dashboard"; ?>">
