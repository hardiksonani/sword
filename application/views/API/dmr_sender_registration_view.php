...
<head>
    ...
    <title>RETAILER::DMR Sender Registration</title>
...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
          ...
          <div id="page-wrapper">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <i class="fa fa-fw"></i>Sender Registration
                            
                        </div>
                        <div class="panel-body">
                            <form action="<?php echo base_url()."API/dmr_sender_registration?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmdmr" id="frmdmr">
            <input type="hidden" id="hidformaction" name="hidformaction">
                ...
                <tr>
                    ...
                    <td>
                        <input type="hidden" id="hidencrdata" name="hidencrdata" value="<?php echo $this->Common_methods->encrypt($this->session->userdata("session_id")); ?>">
                         <input type="text" name="txtName" id="txtName"  class="form-control"  maxlength="20"  style="width:300px;" >
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                         ...
                         <input type="text" name="txtSName" id="txtSName"  class="form-control"  maxlength="20"  style="width:300px;" >
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                       <input type="text" name="txtMobile" id="txtMobile"  class="form-control"  maxlength="10"  style="width:300px;" >
                    </td>
                </tr>
                <tr>
                	<td><label>Pincode:</label></td>
                    <td>
                       <input type="text" name="txtPincode" id="txtPincode"  class="form-control"  maxlength="6"  style="width:300px;" >
                    </td>
                </tr>
                <tr>
                    <td></td>
	...
	{
		if(validatamobile() & validatename() & validatepin())
		{
			$('#myOverlay').show();
    		$('#loadingGIF').show();
