<!DOCTYPE html>
<!-- saved from url=(0055)http://maharshimulti.co.in/API/Recharge_home/ChangePassword -->
...
<form action="<?php echo base_url()."API/change_txnpassword"; ?>" id="resttarnspass" method="post">                                        <div class="body" style="margin-top:20px;">
                                            <div class="row clearfix">
...
<form action="<?php echo base_url()."API/change_password"; ?>" method="post" novalidate="novalidate">                                        
