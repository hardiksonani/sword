...
<body>
    ...
    <div id="wrapper">
          ...
          <div id="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12">
					<br><br>
					<h3>DMR DASHBOARD</h3>
                    <a href="<?php echo base_url()."API/dmr_report" ?>" class="btn btn-outline btn-primary">DMR REPORT</a>
				  <a href="<?php echo base_url()."API/accountreport2" ?>" class="btn btn-outline btn-primary">LEDGER REPORT</a>
				  <a href="<?php echo base_url()."API/dmr_logout" ?>" class="btn btn-outline btn-primary">LOGOUT</a>
                </div>
                <!--end page header -->
            </div>
			  <div class="row">
              ...
              <?php 
			  		...
			  		foreach($beneficiary_info as $bnfr)
					{
                     ...
                     <div class="divsmcontainer" style="text-align:center">
                    	<a href="<?php echo base_url()."API/dmr_bene_registration?crypt=".$this->Common_methods->encrypt("MyData"); ?>" class="btn btn-default">Add New Receiver</a>
                    </div>	
                <?php }
				else
				{?>
      ...
      <input type="hidden" id="hidacvalurl" value="<?php echo base_url()."API/dmr_dashboard/getAccountvalidate"; ?>">
   ...
   <div class="modal fade" id="myMPModal" role="dialog">
	...
	<form action="<?php echo base_url()."API/dmr_home?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmdmr" id="frmdmr">
    ...
    <form id="frmtxn" method="post" action="<?php echo base_url()."API/dmr_transaction?cr=".$this->Common_methods->encrypt("MyData"); ?>">
