            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                   <?php include_once("elements/messagebox.php"); ?>
                                <form id="frmsendervalidate" name="frmsendervalidate" method="post" action="<?php echo base_url()."API/dmrmm_validate_sender?idgs=".$this->Common_methods->encrypt("ravikant"); ?>">
                                <input type="hidden" id="hidsession_id" name="hidsession_id" value="<?php echo session_id(); ?>">
                                 ...
                                 <form id="frmresendotp" name="frmresendotp" action="<?php echo base_url()."API/dmrmm_validate_sender/resendotp"; ?>" method="post">
                               <input type="hidden" id="hidsessionid" name="hidsessionid" value="<?php echo base64_encode(trim($this->session->userdata("session_id"))); ?>"> 
                                ...
                                <script language="javascript">
                                  ...
                                  <input type="hidden" id="hidredurl" value="<?php echo base_url()."API/dmrmm_home?idstr=".$this->Common_methods->encrypt("Ravikant") ?>">  
                                  <input type="hidden" id="hidhomeurl" value="<?php echo base_url()."API/dmrmm_dashboard?idstr=".$this->Common_methods->encrypt("Ravikant") ?>">  
              </div><!-- card-body -->
            </div><!-- card -->
          </div><!-- col-4 -->
        </div>
