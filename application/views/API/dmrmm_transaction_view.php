...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>RETAILER::DMR2 Transaction</title>
...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
          ...
          <?php include("elements/messagebox.php"); ?>
            <div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">Do <?php echo $this->Common_methods->decrypt($transtype); ?> Transaction</h6>
                <span class="tx-12 tx-uppercase"></span>
              </div><!-- card-header -->
              <div class="card-body">
                  <form action="<?php echo base_url()."API/dmrmm_transaction?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmdmr" id="frmdmr">
            ...
            <input type="hidden" id="crypt_d6" name="crypt_d6" value="<?php echo $this->Common_methods->encrypt($transtype); ?>">
                ...
                <tr>
                	<td><label>Tpin:</label></td>
                    <td>
                      <input  type="password" name="txtTpin" id="txtTpin"  class="form-control"  maxlength="20"  style="width:300px;cursor:text !important;background-color: white;" maxlength="8" >
                    </td>
                </tr>
	...
	{
		if(validataamount() & validatetpin() )
		{
			 $('#myOverlay').show();
    		$('#loadingGIF').show();
	...
	{
	    var tpin = document.getElementById("txtTpin").value;
		if(tpin.length < 4)
		{
			$("#txtTpin").addClass("error");
			return false;
		}
		else
		{
			$("#txtTpin").removeClass("error");
			return true;
		}
	}
...
<input type="hidden" id="hidurllivedata" value="<?php echo base_url()."API/recharge_home/getLiveTransactions"; ?>">
      ...
      <input type="hidden" id="hiddashboardurl" value="<?php echo base_url()."API/dmrmm_dashboard"; ?>">
