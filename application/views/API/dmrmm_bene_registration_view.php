            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <?php include_once("elements/messagebox.php"); ?>
                                <form id="frmregister" name="frmregister" method="post" action="<?php echo base_url()."API/dmrmm_bene_registration?idgs=".$this->Common_methods->encrypt("ravikant"); ?>" autocomplete="off">
                                ...
                                <input type="hidden" id="hidsession_id" name="hidsession_id" value="<?php echo session_id(); ?>">
                                 <input type="hidden" id="hidaction" name="hidformaction">
                                   <table border="0" class="table">
                                    ...
                                    <input type="hidden" id="hiddashboardurl" value="<?php echo base_url()."API/dmrmm_dashboard?crypt=".$this->Common_methods->encrypt("MyData"); ?>">
                                    <script language="javascript">
									function cancel()
									{
...
<input type="hidden" id="hidredurl" value="<?php echo base_url()."API/dmr2_home?idstr=".$this->Common_methods->encrypt("Ravikant") ?>">   
<input type="hidden" id="hidbfurl" value="<?php echo base_url()."API/dmrmm_bene_registration/getbeneinfo"?>">
