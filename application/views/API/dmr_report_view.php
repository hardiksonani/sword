...
<form action="<?php echo base_url()."API/dmr_report"; ?>" method="post">                        <div class="">
                            <div class="col-md-2 rechargefirst">
                                <div class="form-group">
                                    <div class="" style="">
                                        <select class="form-control select2-hidden-accessible" id="ddl_status" name="ddl_status" style="margin-top:0px; padding-left:0px; padding-right:0px;text-align:center;" tabindex="-1" aria-hidden="true"><option value="" selected="selected">ALL Status</option>
...
">
                                        <input class="form-control" id="txtRemitter" name="txtRemitter" placeholder="Sender Number" style="height:30px;" type="text" value="<?php echo $txtRemitter; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 rechargefiveclass">
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc;
">
                                        <input class="form-control" id="txtAccNo" name="txtAccNo" placeholder="Account Number" style="height:30px;" type="text" value="<?php echo $txtAccNo; ?>">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    <span  class="btn btn-success btn-sm">Success : <?php echo $summary_array["Success"]; ?></span>
                    <span  class="btn btn-primary btn-sm">Pending : <?php echo $summary_array["Pending"]; ?></span>
                    <span  class="btn btn-warning btn-sm">Failure : <?php echo $summary_array["Failure"]; ?></span>
                            ...
                            <table id="tbldata" class="table table-bordered table-striped table-hover dataTable" style="width:100%;" cellspacing="0">
                                <thead style="background-color:whitesmoke;">
                                    <tr>
                                        ...
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">UId</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">DateTime</th>


                                        

                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Time</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">RetailerName</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Sender</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">AccountNo</th>
                                        

                                        
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Amount</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Bank Ref No</th>

                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Status</th>
                                        <th class="noExl" style="padding-left:2px; padding-right:2px;text-align:center;width:76px;"></th>
...
<?php echo $result->unique_id;?>
 ...
 <td style="min-width:200px">
     <?php echo "<span id='db_company".$i."'>".$result->AccountNumber."<br>IFSC : ".$result->IFSC."<br>".$result->RESP_name."<br>Mode: ".$result->mode."<br>".$result->bank_name."</span>"; ?>
</td> 
 ...
 <?php if($result->Status == "PENDING" or $result->Status == "HOLD"){echo "<span  style='word-break: break-all;' id='db_status".$result->Id."' class='btn btn-primary btn-sm' onclick='checkpending(\"".$result->Id."\")'>".$result->Status."</span>";} ?>
  ...
  <td>
      <a class="btn btn-outline-primary" href="<?php echo base_url()."API/print_dmr_online_copy?idstr=".$this->Common_methods->encrypt($result->Id)."&idstr2=".$this->Common_methods->encrypt($result->user_id); ?>" target="_blank">Print</a>
  </td>
  </tr>
        <?php
...
<script>
    ...
    function disputedata(e) {
        ...
        var txtmob = $('#txtmob').val();
             ...
             $.post("/API/Recharge_home/dispute",
             {"id": e, "txtregion": ""},
                 function (data) {
                     $.post("/API/Recharge_home/InfiniteScroll",
...
<script type="text/javascript">
    function GotoPDFRecharge(e) {
                       // alert(e)
                       var idno = e.toString();
                       var url = '/API/Recharge_home/RechargePDF?Idno=' + idno + '';
...
<script>
    function findtotal() {
         ...
         var Operator = $('#Operator').val();
         var txtmob = $('#txtmob').val();
             $.post("/API/Recharge_home/FindTotal",
...
<script type="text/javascript">
    function GenrateInvoice(ultra_request_id, RechargeTo, OptName, amt, OptID, Date) {
       var url = '/API/Recharge_home/GotoInvoicePDF1?Id=' + ultra_request_id + '&RechargeTo=' + RechargeTo + '&OptName=' + OptName + '&amt=' + amt + '&OptID=' + OptID + '&Date=' + Date + '';
            window.open(url, '_blank');
     }
</script>
<script>
   ...
   var txt_frm_date = $('#txt_frm_date').val();
         ...
         var Operator = $('#Operator').val();
        var txtmob = $('#txtmob').val();
        var url = '/API/Recharge_home/ExcelRechargereport?txt_frm_date=' + txt_frm_date + '&txt_to_date=' + txt_to_date + '&ddl_status=' + ddl_status + '&Operator=' + Operator + '&txtmob=' + txtmob;
        location.href = url;
});
</script>
<script>
    $("#btnPDF").click(function () {
     var txt_frm_date = $('#txt_frm_date').val();
         ...
         var Operator = $('#Operator').val();
        var txtmob = $('#txtmob').val();
        var url = '/API/Recharge_home/PDFRechargereport?txt_frm_date=' + txt_frm_date + '&txt_to_date=' + txt_to_date + '&ddl_status=' + ddl_status + '&Operator=' + Operator + '&txtmob=' + txtmob;
        window.open(
url,
