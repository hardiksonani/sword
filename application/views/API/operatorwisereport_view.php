...
<form action="<?php echo base_url()."API/operatorwisereport"; ?>" method="post">                        <div class="">
                        ...
                        <div class="table-responsive recharge-responsive" style="position:inherit;margin-top:-10px;">
                            ...
                            <table id="tbldata" class="table table-bordered table-striped table-hover dataTable" style="width:100%;" cellspacing="0">
                                <thead style="background-color:whitesmoke;">
                                    <tr>
                                        <th align="center" style="padding-left:2px; padding-right:2px;text-align:center;"  >#&nbsp;Sr</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Product</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Total Count</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Total Success</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Earning</th>
