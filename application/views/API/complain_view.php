...
<section class="content" style="margin:90px 0px 0px 0px;">
    <div class="container-fluid retailer-page fundtranfer rechargefirstclass fundtranfer-responshive">
        <div class="row clearfix">
            ...
            <form action="<?php echo base_url()."API/complain"; ?>" method="post">                
                            ...
                            <table id="tbldata" class="table table-bordered table-striped table-hover dataTable" style="width:100%;" cellspacing="0">
                                <thead style="background-color:whitesmoke;">
                                    <tr>
                                        ...
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Complain&nbsp;Date</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Complain&nbsp;message</th>
                                       
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Admin&nbsp;Remark</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Complain&nbsp;Status</th>
...
<tr style="background-color:">
        ...
        <td><?php echo $result->complain_status; ?></td>
