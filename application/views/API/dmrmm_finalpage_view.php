          ...
          <div class="col-sm-6 col-lg-12">
            ...
            <div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                ...
                <a class="btn btn-outline-primary" href="<?php echo base_url()."API/print_dmr_online_copy?idstr=".$this->Common_methods->encrypt($data->row(0)->Id)."&idstr2=".$this->Common_methods->encrypt($data->row(0)->user_id); ?>" target="_blank">Print</a>
                &nbsp;&nbsp;
                <a href="<?php echo base_url()."API/dmrmm_dashboard"; ?>" class="btn btn-outline-success">Go To DMT Dashboard</a>
                </span>
              </div><!-- card-header -->
              <div class="card-body">
