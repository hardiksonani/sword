...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../ncss/bootstrap.min.css"> 
    <link type="text/css" rel="stylesheet" href="../ncss/dezire-font.css"> 
    <link type="text/css" rel="stylesheet" href="../ncss/swiper.min.css"> 
    <link type="text/css" rel="stylesheet" href="../ncss/dist.css"> 
    <link type="text/css" rel="stylesheet" href="../ncss/font-awesome.min.css"> 
    
    <title>DezireMoney | Retailer | DMR Transaction</title>
...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
    <div id="wrapper"> 
        <div class="page home-page">
          <header>
            <?php include("files/agent_header.php"); ?>
          </header> 
        </div>
      ...
      <section> 
        <div >
         ...
         <br><br>
          <div class="container">
            <div class="inner_content_section" id="transactions">
            <h3>Do <?php echo $this->Common_methods->decrypt($transtype); ?> Transaction</h3>
            <form action="<?php echo base_url()."API/dmr_transaction?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmdmr" id="frmdmr">
            <input type="hidden" id="hidformaction" name="formaction">
          	<input type="hidden" id="crypt_d4" name="crypt_d4" value="<?php echo $this->Common_methods->encrypt($bene_id); ?>">
            <input type="hidden" id="crypt_d5" name="crypt_d5" value="<?php echo $this->Common_methods->encrypt($remitter_id); ?>"> 
            <input type="hidden" id="crypt_d6" name="crypt_d6" value="<?php echo $this->Common_methods->encrypt($transtype); ?>">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                       <input type="text" name="txtAmount" id="txtAmount"  class="form-control"  maxlength="5"  style="width:300px;" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
                    </td>
                </tr>
                <tr>
                	<td><label>Remark:</label></td>
                    <td>
                       <input type="text" name="txtRemark" id="txtRemark"  class="form-control"  maxlength="20"  style="width:300px;">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="padding-top:30px;">
                      <input type="button" name="btnSubmit" id="btnSubmit" value="Submit" class="btn btn-success" onClick="validataandsubmit()" />
                    </td>
                </tr>
                </table>
			</form>
	...
	{
		if(validataamount() & validateremark())
		{
			 $('#myOverlay').show();
    		$('#loadingGIF').show();
	...
	function validateremark()
	{
      ...
      <input type="hidden" id="hidurllivedata" value="<?php echo base_url()."API/recharge_home/getLiveTransactions"; ?>">
      ...
      <input type="hidden" id="hidbregvalurl" value="<?php echo base_url()."API/dmr_bene_registration"; ?>">
      <input type="hidden" id="hiddashboardurl" value="<?php echo base_url()."API/dmr_dashboard"; ?>">
      
      <footer> 
        
        <?php include("files/agent_footer.php"); ?>
      </footer> 
     
      <script type="text/javascript" src="../njs/jquery.min.js"></script>
      <script type="text/javascript" src="../njs/bootstrap.min.js"></script>
      <script type="text/javascript" src="../njs/swiper.min.js"></script>
   
      <script type="text/javascript" src="../njs/custom.js"></script>
