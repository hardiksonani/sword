<!DOCTYPE html>
<!-- saved from url=(0048)<?php echo base_url();?>API/Recharge_home/Profile -->
...
<style>
 ...
 <?php
                $profile_userinfo = $this->db->query("SELECT a.user_id,a.businessname,a.mobile_no,a.usertype_name,a.add_date,a.status,a.password,a.txn_password,b.postal_address,b.pincode,b.aadhar_number,b.pan_no,b.gst_no,b.call_back_url,b.contact_person,b.emailid,b.client_ip,b.client_ip2,b.client_ip3,b.client_ip4
FROM `tblusers` a
left join  `tblusers_info` b on a.user_id = b.user_id where a.user_id = ?",array($this->session->userdata("ApiId")));
             ?>
                    ...
                    <div class="card " style="height:318px;">
                        ...
                        <div class="body">
                            <center>
                                ...
                                <div class="msg" style="padding-top:12px; font-size:19px; font-weight:600; color:#7a7676;"><?php echo $profile_userinfo->row(0)->businessname; ?></div>
...
<form action="<?php echo base_url();?>API/Recharge_home/UploadProfileimage" enctype="multipart/form-data" method="post">                                                    <div class="modal-body" style="margin-top:0px;">
                                                        <div class="body">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 registered-profile">
                <div class="card profilecard">
                    <div class="body profilebodyback profilelastdetail" style="margin-bottom:11px;background-color:whitesmoke;height:3px;">
                            <h1 style="color:#49586e;font-size:20px;font-weight:bold;margin-top:-13px;">
                                <img src="<?php echo base_url(); ?>vfiles/store.svg">
                                Callback Setting
                                <a style="float:right;cursor:pointer;" id="Editaddresshide"><i class="fa fa-pencil-square-o" id="EditaddressModalssee" style="font-size:22px;margin-top:0px;" onclick="editeaddress('<?php echo $this->Common_methods->encrypt($this->session->userdata("ApiId")); ?>')">Edit</i></a>
                            </h1>
                    ...
                    <div class="body bodyprofileshow" style="margin-top:-19px;">
                        <ul class="list-group" id="list-groupwert" style="margin-bottom:;">
							...
							<li class="list-group-item" style="margin-top:-19px;">
                                <span style="color:#7a7676;font-family:&#39;Open Sans&#39;,sans-serif;font-weight:600;">Callback Url</span>
                                    <p style="margin-top:4px;float:right;"><?php echo $profile_userinfo->row(0)->call_back_url; ?></p>
                            </li>
                           
                            <li class="list-group-item">
                                <span style="color:#7a7676;font-family:&#39;Open Sans&#39;,sans-serif;font-weight:600;">IpAddress</span>
                                    <p style="float:right;margin-top:0px;"><?php echo $profile_userinfo->row(0)->client_ip; ?></p>
                            </li>
                            <li class="list-group-item">
                                <span style="color:#7a7676;font-family:&#39;Open Sans&#39;,sans-serif;font-weight:600;">IpAddress 2</span>
                                    <p style="float:right;margin-top:0px;"><?php echo $profile_userinfo->row(0)->client_ip2; ?></p>
                            </li>
                        </ul>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color:whitesmoke;">
                                        <h4 class="modal-title" id="defaultModalLabel" style="color:black;">Update Callback</h4>
                                    </div>
<form action="<?php echo base_url();?>API/Dashboard/UpdateRetailerProfile" method="post">                                        <div class="modal-body" style="margin-top:0px;">
                                            <div class="body">
                                                    ...
                                                    <div class="row clearfix">
                                                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 form-control-label">
                                                            <label for="email_address_2" class="required">Ip Address</label>
                                                        </div>
                                                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
                                                            <div class="form-group">
                                                                <div class="" style="border:1px solid #ddd;">
                                                                    <input class="form-control" id="txtIpAddress" name="txtIpAddress" onkeypress="return isNumber(event)" placeholder="Enter Ip Address" type="text" value="<?php echo $profile_userinfo->row(0)->client_ip; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row clearfix">
                                                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 form-control-label">
                                                            <label for="email_address_2" class="required">Ip Address 2</label>
                                                        </div>
                                                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
                                                            <div class="form-group">
                                                                <div class="" style="border:1px solid #ddd;">
                                                                    <input class="form-control" id="txtIpAddress2" name="txtIpAddress2" onkeypress="return isNumber(event)" placeholder="Enter Ip Address 2" type="text" value="<?php echo $profile_userinfo->row(0)->client_ip2; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                     ...
                                                     <div class="row clearfix">
                                                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 form-control-label">
                                                            <label for="email_address_2" class="required">Callback Url</label>
                                                        </div>

                                                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
                                                            <div class="form-group">
                                                                <div class="" style="border:1px solid #ddd;">
                                                                    <input class="form-control" id="txtCallbackUrl" name="txtCallbackUrl" placeholder="Enter Callback Url"  type="text" value="<?php echo $profile_userinfo->row(0)->call_back_url; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="profilebackground fullbodydycolorbg">
                    <div class="card " style="height:533px;margin-top:-5px;">
                        <div class="body" style="margin-bottom:11px;background-color:#ddd;height:42px;margin-top:5px;">
                            ...
                            <p style="text-transform:uppercase;margin-top:-9px;color:#555;"><?php echo $profile_userinfo->row(0)->add_date; ?></p>
                            ...
                            <div class="profile-borders" id="profileshowtable">
                                <table border="1">
                                    <tbody><tr>
                                        ...
                                        <td><p style="text-transform:uppercase;margin-top:-7px;"><?php echo $profile_userinfo->row(0)->businessname; ?></p></td>
                                    </tr>
                                    <tr>
                                        <th>
                                            <p style="color:#7a7676;font-family:&#39;Open Sans&#39;,sans-serif;font-weight:600;">Email-ID</p>
                                        </th>
                                        <td><p style="text-transform:uppercase;margin-top:-7px;"><?php echo $profile_userinfo->row(0)->emailid; ?></p></td>
                                    </tr>
                                    <tr>
                                        <th>
                                            <p style="color:#7a7676;font-family:&#39;Open Sans&#39;,sans-serif;font-weight:600;">Mobile</p>
                                        </th>
                                        <td><p style="text-transform:uppercase;margin-top:-7px;"><?php echo $profile_userinfo->row(0)->mobile_no; ?></p></td>
                                    </tr>
                                    <tr>
                                        <th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                <p style="text-transform:uppercase;margin-top:-7px;"><?php echo $profile_userinfo->row(0)->aadhar_number; ?></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th><p style="color:#7a7676;font-family:&#39;Open Sans&#39;,sans-serif;font-weight:600;">Pancard&nbsp;No</p></th>
                                        <td>
                                                <p style="text-transform:uppercase;margin-top:-7px;"><?php echo $profile_userinfo->row(0)->pan_no; ?></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th><p style="color:#7a7676;font-family:&#39;Open Sans&#39;,sans-serif;font-weight:600;">GST No</p></th>
                                        <td>
                                                <p style="text-transform:uppercase;margin-top:-7px;"><?php echo $profile_userinfo->row(0)->gst_no; ?></p>
                                        </td>
                                    </tr>
                                    <tr>
...
<form action="<?php echo base_url();?>API/Recharge_home/UpdatePanccardandmobile" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>API/Recharge_home/UpdateBankinfromation" method="post">                                        <div class="modal-body" style="margin-top:0px;">
                                            <div class="body">
...
<form action="<?php echo base_url();?>API/Recharge_home/UploadAadharcarddoc" enctype="multipart/form-data" method="post" novalidate="novalidate">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>API/Recharge_home/UploadPancardcarddoc" enctype="multipart/form-data" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>API/Recharge_home/UploadShopwithSalfieddoc" enctype="multipart/form-data" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>API/Recharge_home/UploadRegistractionCertificatedoc" enctype="multipart/form-data" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>API/Recharge_home/UploadServiceAggrementdoc" enctype="multipart/form-data" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>API/Recharge_home/UploadAddressProofdoc" enctype="multipart/form-data" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
                    ...
                    <div class="body bodyprofileshow" style="margin-top:-25px;">
                        <ul class="list-group" style="">
                            <li class="list-group-item" style="margin-top:0px;">
                                ...
                                <p class="badge" style="margin-top:-38px;margin-right:0px;background-color:white;color:black;border:1px solid #dddddd;font-weight:400;"><a href="<?php echo base_url();?>Retailer_image/72fdb1c0-04f8-4094-8700-a92ef7fae928_download.jpg" style="cursor:pointer;text-decoration:none;color:#4a2400;" target="_blank">View</a></p>
                            ...
                            <li class="list-group-item" style="margin-top:-15px;">
                                ...
                                <p style="color:brown;opacity:0.5;margin-top:-10px;border-bottom:1px dashed #999;">MANDATORY</p>
                                <p class="badge" style="margin-top:-38px;margin-right:0px;background-color:white;color:black;border:1px solid #dddddd;font-weight:400;"><a href="<?php echo base_url();?>Retailer_image/d2caa6e7-4c14-43b3-a94e-89f5f261c8e2_download.jpg" style="cursor:pointer;text-decoration:none;color:#4a2400;" target="_blank">View</a></p>
                                        <p class="badge" style="margin-top:-38px;margin-right:48px;background-color:white;color:green;border:1px solid #dddddd;font-weight:400;cursor:pointer; width: 72px;">Approved</p>
                            ...
                            <li class="list-group-item" style="margin-top:-15px;">
                                ...
                                <p style="color:brown;opacity:0.5;margin-top:-10px;border-bottom:1px dashed #999;">MANDATORY</p>
                                <p class="badge" style="margin-top:-38px;margin-right:0px;background-color:white;color:black;border:1px solid #dddddd;font-weight:400;"><a href="<?php echo base_url();?>Retailer_image/200fbeb6-4599-4e48-80e7-9d6f1d05f9fd_download.jpg" style="cursor:pointer;text-decoration:none;color:#4a2400;" target="_blank">View</a></p>
                                        <p class="badge" style="margin-top:-38px;margin-right:48px;background-color:white;color:green;border:1px solid #dddddd;font-weight:400;cursor:pointer; width: 72px;">Approved</p>
...
<script>
    ...
    $.ajax({
        url: '/API/Recharge_home/FillDistict',
        type: "GET",
        dataType: "JSON",
...
<script>
    function editeaddress(retailerid) {
        var url = '/API/Dashboard/ShowRetailerprofile1'
        $.ajax({
            url: url,
...
<script>
    ...
    var url = '/API/Dashboard/AddressFieldcheck'
        $.ajax({
            url: url,
          success: function (data) {
    ...
    function editemobileandpancard(retailerid) {
        ...
        var url = '/API/Recharge_home/Showmobileandpancardprofile'
        $.ajax({
            url: url,
            data: { retailerid: retailerid },
            cache: false,
...
<script>
    function editebankinformation(retailerid) {
        var url = '/API/Recharge_home/ShowBankinfo'
        $.ajax({
            url: url,
            data: { retailerid: retailerid },
            cache: false,
...
<script type="text/javascript">
    ...
    $.ajax({
        type: "POST", url: '/API/Recharge_home/DelereprofileDoc', data: { 'SSID': retailerid, 'Docname': docname }, dataType: 'json', cache: false, success: function (result) {
            if (result == "Success") {

                var url = '/API/Recharge_home/Profile';
...
<script> 
    function SetAsReaded(idn,url)
    {
       ...
       // alert('<?php echo base_url(); ?>');
        var urlSiteName = '<?php echo base_url(); ?>';
        var setObj = { Id : idn};
