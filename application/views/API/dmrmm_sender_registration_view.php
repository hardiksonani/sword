            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <?php include_once("elements/messagebox.php"); ?>
                                <form id="frmregister" name="frmregister" method="post" action="<?php echo base_url()."API/dmrmm_sender_registration?idgs=".$this->Common_methods->encrypt("ravikant"); ?>">
                                ...
                                <form id="frmresendotp" name="frmresendotp" action="<?php echo base_url()."API/dmrmm_sender_registration/resendotp"; ?>" method="post">
