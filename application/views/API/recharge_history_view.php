...
<div id="pagealert" class="alert alert-success" role="alert" style="display: none;">
  
</div>
                <div class="card" style="margin-top:2px;float: left;width: 100%;">
<form action="<?php echo base_url()."API/recharge_history"; ?>" method="post">                        <div class="">
                            <div class="col-md-2 rechargefirst">
                                <div class="form-group">
                                    <div class="" style="">
                                        <select class="form-control select2-hidden-accessible" id="ddl_status" name="ddl_status" style="margin-top:0px; padding-left:0px; padding-right:0px;text-align:center;" tabindex="-1" aria-hidden="true"><option value="ALL" selected="selected">ALL Status</option>
<option value="Success">SUCCESS</option>
<option value="Pending">Pending</option>
<option value="Failure">FAILED</option>
</select>
<script language="javascript">
    document.getElementById("ddl_status").value = '<?php echo $ddlstatus; ?>';
</script>
<span class="select2 select2-container select2-container--default" dir="ltr" style="width: 207px;">
...
<span class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <div class="col-md-3 rechargesecond">
                                <div class="form-group">
                                    <div class="" style="">
                                        <select class="form-control select2-hidden-accessible" id="Operator" name="Operator" tabindex="-1" aria-hidden="true"><option value="ALL" selected="selected">ALL OPERATORS </option>
<?php
$optr_rslt = $this->db->query("select company_id,company_name from tblcompany order by service_id,company_name");
foreach($optr_rslt->result() as $comp)
{?>
...
<script language="javascript">
    document.getElementById("Operator").value = '<?php echo $ddloperator; ?>';
</script>


<span class="select2 select2-container select2-container--default" dir="ltr" style="width: 289px;">
...
<span class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <div class="col-md-2 rechargefiveclass">
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc;
">
                                        <input class="form-control" id="txtmob" name="txtmob" placeholder="Consumer Number" style="height:30px;" type="text" value="<?php echo $word; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 rechargethrees">
                                <div class="form-group" style="margin-bottom:0px;margin-top:1px;">
                                    <div class="input-daterange input-group">
                                        <div class="datesate datesates focused">
                                            <div class="form-iconmy" style="top: 0px;left: 1px;padding: 6px 5px;"><i class="fa fa-calendar tmw-total-color-one fullbodydycolorbg"></i></div>
                                            <input autocomplete="off" class="form-control" id="txt_frm_date" name="txt_frm_date" required="required" style="border:1px solid #dddddd; margin-top:4px;height:32px;" type="text" value="<?php echo $from; ?>">
                                        </div>
                                        <span class="input-group-addon" style="display:none;">
                                            <i class="fa fa-exchange" style="padding-top:8px;"></i>
                                        </span>
                                        <div class="datesate datesatese">
                                            <div class="form-iconmy form-iconmyss" id="iconmyssee" style="top: 0px;left: 1px;padding: 6px 5px;"><i class="fa fa-calendar tmw-total-color-one fullbodydycolorbg"></i></div>
                                            <input autocomplete="off" class="form-control" id="txt_to_date" name="txt_to_date" required="required" style="border:1px solid #dddddd; margin-top:4px;height:32px;" type="text" value="<?php echo $to; ?>">
                                        </div>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                            <div class="col-md-2 rechargefive">
                                <div class="form-group">
                                    <div class="form-line" style="border-bottom:none;margin-top:0px;">
                                        <center>
                                            <button value="LIVE" type="submit" class="btn" id="btntype" name="btntype" style="margin-top:5px; margin-left:2px; height:32px;border:1px solid #c7c2c2;background:#dedddd;">
                                                <i class="fa fa-search" style="top:-1px;font-size:13px;color:black;"></i>
                                                <span style="top:-1px;color:black;">Search</span>
                                            </button>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 rechargepdfexal">
                        <div style="float:right;">
                            <span><img src="<?php echo base_url(); ?>vfiles/pdf.png"><input type="button" id="btnPDF" value="PDF" style="margin-left:2px; height:32px;border:1px solid #c7c2c2;background:#dedddd;"></span>
                            <span>
                                <img src="<?php echo base_url(); ?>vfiles/xls.png"><input type="button" id="btnExport" value="Export" style="margin-left:2px; height:32px;border:1px solid #c7c2c2;background:#dedddd;">
                            </span>

                            <button onclick="findtotal()" class="btn" id="pdfblock" style=" margin-left:2px; height:32px;border:1px solid #c7c2c2;background:#dedddd;">
                                <span class="displaypdf" style="top:-1px;color:black;">TOTAL</span>
                                <strong class="pdfblocks" style="display:none;float:right;"><span id="successtotal"></span><span id="Failedtotal"></span><span id="Pendingtotal"></span></strong>
                            </button>
                        </div>
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    <span  class="btn btn-success btn-sm">Success : <?php echo $totalRecahrge; ?></span>
                    <span  class="btn btn-primary btn-sm">Pending : <?php echo $totalpRecahrge; ?></span>
                    <span  class="btn btn-warning btn-sm">Failure : <?php echo $totalfRecahrge; ?></span>
                ...
                <div class="card">
                    <div class="body change-iconrech-report change-iconrech-responshive" style="padding:12px;padding-left: 0;padding-right: 0;padding-top: 15px;">
                        <div class="table-responsive recharge-responsive" style="position:inherit;margin-top:-10px;">
                            <table id="tbldata" class="table table-bordered table-striped table-hover dataTable" style="width:100%;" cellspacing="0">
                                <thead style="background-color:whitesmoke;">
                                    <tr>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">#&nbsp;Category</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Consumer&nbsp;No</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Operator&nbsp;Name</th>


                                        

                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Net&nbsp;Amt</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Debit</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Earn</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Remain</th>
                                        

                                        
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Request&nbsp;Date</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Resp&nbsp;Date</th>

                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Transition</th>
                                        <th class="noExl" style="padding-left:2px; padding-right:2px;text-align:center;width:76px;">Action</th>
...
<tr style="background-color:">
        <td>
        	...
        	{?>
        		<img style="height: 20px;width: 18px;margin-right:5px;max-width: 100%;padding: 0; border-radius:50%; background-color:green" src="<?php echo base_url(); ?>/ashok-images/correct.svg">
                <span style="font-size:0px;">SUCCESS</span>PrePaid

        	<?php }
        	else if($result->recharge_status == 'Failure' and $result->transaction_type == 'Recharge_Refund')
        	{?>
        		
                    <p>
                    <img style="height: 20px;width: 18px;margin-right:5px;max-width: 100%;padding: 0; border-radius:50%; background-color:brown" src="<?php echo base_url(); ?>/ashok-images/backresnd.svg">

                <span style="font-size:0px;">Credit</span>Refund
            </p>
        	<?php }
        	else if($result->recharge_status == 'Failure' )
        		{?>
                ...
                <span style="font-size:0px;">Failure</span>Prepaid
            </p>
        	<?php 
        }
        else
        {?>
            ...
            <img style="height: 20px;width: 18px;margin-right:5px;max-width: 100%;padding: 0; border-radius:50%; background-color:blue" src="<?php echo base_url(); ?>/ashok-images/correct.svg">
                <span style="font-size:0px;">SUCCESS</span>Pending
<?php } ?>
        ...
        <td><span class="app-web"><img src="<?php echo base_url(); ?>/ashok-images/seo-and-web.svg"></span> <?php echo $result->company_name; ?></td>
        ...
        <td> <?php echo str_replace(","," ",$result->balance); ?></td>
        ...
        <td class="noExl noExlss">
            
                <button id="disp-<?php echo $result->recharge_id; ?>" type="button" style="background-color:transparent; border:none;" title="dispute" onclick="confirm('<?php echo $result->recharge_id; ?>')">
                    <i class="material-icons">gavel</i>
                </button>
                <button id="confirm-<?php echo $result->recharge_id; ?>" class="sure-newadd" type="button" style="background-color:transparent; border:none;display:none" title="ARE YOU SURE" onclick="disputedata('<?php echo $result->recharge_id; ?>')">
                    <i class="material-icons" style="display:none;">check</i>Sure&nbsp;?
                </button>
                <button class="displaynoneadd" id="close-<?php echo $result->recharge_id; ?>" type="button" style="background-color:transparent;border:none;display:none" title="CANCEL" onclick="cancel('<?php echo $result->recharge_id; ?>')">
                    <i class="material-icons">close</i>
                </button>
                            <center>
                    <a target="_blank" id="but"  href="<?php echo base_url()."API/print_receipt?cruptid=".$this->Common_methods->encrypt($result->recharge_id) ?>" style="border:none;background:none;" data-toggle="tooltip" data-placement="bottom" title="Click To Print Generate Invoice"><i class="material-icons">print</i></a>
                </center>
        </td>
...
?>
                            ...
                            <!--<div id="loadingdiv" style="text-align:center;display:none;margin-bottom:20px;">
                                <div class="loadertablecssnew">Loading...</div>
                            </div>-->
                        </div>
...
<script>
    function today(a)
    {
        ...
        //call ajax
        $.ajax({
            url: '<?php echo base_url(); ?>API/Recharge_home/Show_Today_All_Recharge',
            type: 'POST',
            dataType: "html",
            data: { yesterday: x },
...
<script>
    $(document).ready(function () {
        ...
        $("#remainretailer").load("<?php echo base_url() ?>API/recharge_home/getBalance");
    ...
    function disputedata(e) {
        ...
        var txtmob = $('#txtmob').val();
             ...
             $.post("<?php echo base_url(); ?>API/Recharge_home/dispute",
             {"id": e, "txtregion": ""},
                 function (data) 
                 {
                    ...
                    $('#close-'+e).hide();
                        ...
                        document.getElementById("pagealert").innerHTML = data;
                        $( "#pagealert" ).fadeOut( 10000, function() {
                            // Animation complete.
                          });
...
<script>
    ...
    $(window).scroll(function () {
            if ($(window).scrollTop() > Number($("#tbldata").height()) / 4 && !NoMoredata && !inProgress) {
                inProgress = true;
                $("#loadingdiv").show();
                $.post("<?php echo base_url(); ?>API/Recharge_home/InfiniteScroll",
...
<script type="text/javascript">
    function GotoPDFRecharge(e) {
                       // alert(e)
                       var idno = e.toString();
                       var url = '<?php echo base_url(); ?>API/Recharge_home/RechargePDF?Idno=' + idno + '';
...
<script>
    function findtotal() {
         ...
         var Operator = $('#Operator').val();
         var txtmob = $('#txtmob').val();
             $.post("<?php echo base_url(); ?>API/Recharge_home/FindTotal",
...
<script type="text/javascript">
    function GenrateInvoice(ultra_request_id, RechargeTo, OptName, amt, OptID, Date) {
       var url = '<?php echo base_url(); ?>API/Recharge_home/GotoInvoicePDF1?Id=' + ultra_request_id + '&RechargeTo=' + RechargeTo + '&OptName=' + OptName + '&amt=' + amt + '&OptID=' + OptID + '&Date=' + Date + '';
            window.open(url, '_blank');
     }
</script>
<script>
   ...
   var txt_frm_date = $('#txt_frm_date').val();
         ...
         var Operator = $('#Operator').val();
        var txtmob = $('#txtmob').val();
        var url = '<?php echo base_url(); ?>API/Recharge_home/ExcelRechargereport?txt_frm_date=' + txt_frm_date + '&txt_to_date=' + txt_to_date + '&ddl_status=' + ddl_status + '&Operator=' + Operator + '&txtmob=' + txtmob;
        location.href = url;
});
</script>
<script>
    $("#btnPDF").click(function () {
     var txt_frm_date = $('#txt_frm_date').val();
         ...
         var Operator = $('#Operator').val();
        var txtmob = $('#txtmob').val();
        var url = '<?php echo base_url(); ?>API/Recharge_home/PDFRechargereport?txt_frm_date=' + txt_frm_date + '&txt_to_date=' + txt_to_date + '&ddl_status=' + ddl_status + '&Operator=' + Operator + '&txtmob=' + txtmob;
        window.open(
url,
