    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
					  <div class="br-pageheader">
						<nav class="breadcrumb pd-0 mg-0 tx-12">
						  ...
						  <span class="breadcrumb-item active">CHANGE TRANSACTION PIN</span>
						</nav>
					  </div><!-- br-pageheader -->
					  <!-- d-flex -->
      				 ...
      				 <div class="br-pagebody">
						<?php include("elements/messagebox.php"); ?>
						 <div class="row row-sm mg-t-20">
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
										  <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
											<h6 class="card-title tx-uppercase tx-12 mg-b-0">CHANGE TRANSACTION PIN FORM</h6>
									 ...
									 <form role="form" method="post" action="<?php echo base_url()."Retailer/change_txnpassword"; ?>">
                           <input type="hidden" id="hidID" name="hidID">
                                    <table cellspacing="10" cellpadding="3">
                                    <tr>
                                    	<td style="padding-right:10px;">
                                        	 <label>OLD PIN</label>
                                            <input class="form-control" id="txtOldPassword" name="txtOldPassword" type="password" style="width:120px;" placeholder="Old PIN">
                                        </td>
                                        <td style="padding-right:10px;">
                                        	 <label>NEW PIN</label>
                                            <input class="form-control" id="txtNewPassword" name="txtNewPassword" type="password" style="width:120px;" placeholder="NEW PIN" maxlength="4">
                                        </td>
                                        <td style="padding-right:10px;">
                                        	 <label>CONFIRM PIN</label>
                                             <input class="form-control" id="txtCNewPassword" name="txtCNewPassword" type="password" style="width:120px;" placeholder="CONFIRM PIN" maxlength="4">
                                        </td>
                                        <td valign="bottom">
