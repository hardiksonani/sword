...
<form action="<?php echo base_url()."Distributor/operatorwisereport"; ?>" method="post">                        <div class="">
                            ...
                            <table id="tbldata" class="table table-bordered table-striped table-hover dataTable" style="width:100%;" cellspacing="0">
                                <thead style="background-color:whitesmoke;">
                                    <tr>
                                        ...
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Distributor Profit</th>
