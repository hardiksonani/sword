...
<form action="<?php echo base_url()."Distributor/recharge_history"; ?>" method="post">                        <div class="">
                                        ...
                                        <center>
                                            <select id="ddluser" name="ddluser">
                                                ...
                                                <?php
                                                        ...
                                                        $rsltuse = $this->db->query("select user_id,businessname from tblusers where parentid = ? order by businessname",array($this->session->userdata("DistId"))); 
