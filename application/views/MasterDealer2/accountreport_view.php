          ...
          <div class="col-sm-6 col-lg-12">
            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  ...
                  <form action="<?php echo base_url()."MasterDealer/accountreport?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">                            
...
<form id="frmexport" name="frmexport" action="<?php echo base_url()."MasterDealer/accountreport/dataexport" ?>" method="get">
