<!DOCTYPE html>
<!-- saved from url=(0040)<?php echo base_url(); ?>/MasterDealer/Home -->
        ...
        <div class="top-navmenup finaciall" style="display: none; ">
            <ul id="leftulbar" class="nav nav-tabs tab-nav-left nav1-tabs1" role="tablist" style="padding-top:5px;border-bottom:none;">
                <li id="dashboard" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home" aria-expanded="false" style="background:transparent; cursor:pointer;"><i class="fa fa-home" style="color:white;top:-3px;"></i></a>
                </li>
                <li id="recharge" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/Index" id="recharge" aria-expanded="false" style="background:transparent;">RECHARGE &amp; BILL</a>
                </li>
                <li id="finanical" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/Money_transfer1" aria-expanded="true" style="background:transparent;">FINANCIAL</a>
                </li>
                <li id="Gift" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/Gift_Card" aria-expanded="true" style="background:transparent;">GIFT&nbsp;CARDS</a>
                </li>

                <li id="Dth" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/MasterDealer/DthConnection/Index" aria-expanded="true" style="background:transparent;">NEW-DTH</a>
                </li>
                <li id="travel" class="listtryp" role="presentation" style="padding:0px;">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/Travel" aria-expanded="true" style="background:transparent;">TRAVEL</a>
                </li>
                <li id="ecommerce" class="listtryp" role="presentation" style="padding:0px; margin-bottom:-27px;">
                    <a href="<?php echo base_url(); ?>/MasterDealer/ECommerce/Index" aria-expanded="true" style="background:transparent;">E-COMMERCE</a>
                </li>
        ...
        <div class="col-xs-12 col-md-4 cart-p dasborddetail">
                                ...
                                <center>
                                    <div class="row" style="margin-top:8%;">
                                        ...
                                        <div class="col-xs-6" style="margin-bottom:0px;">
                                            <a href="<?php echo base_url(); ?>/MasterDealer/Home/Profile" class="btn btn-default waves-effect" type="button" style="text-decoration:none;box-shadow:none; border:1px solid #dddddd;width:100%;margin-left:-10px;"><i class="fa fa-user-circle-o" style="top:1px;font-size:14px;"></i>&nbsp;My&nbsp;Profile</a>
                                        </div>

                                        <div class="col-xs-6" style="margin-bottom:0px;">
                                            <a href="<?php echo base_url(); ?>/MasterDealer/Home/ChangePassword" style="text-decoration:none;box-shadow:none; border:1px solid #dddddd;width:127%;margin-left:-27px;" class="btn btn-default waves-effect"><span style="font-size: 13px; top: -2px;"><i class="material-icons" style="font-size: 14px; top: 2px; left: -6px;">lock_outline</i>&nbsp;Manage Password</span></a>
                                        </div>
            ...
            <div class="row">
                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Accountreport">
                    ...
                    <p><a href="<?php echo base_url(); ?>/MasterDealer/Home/RetailerLedger" style="margin-left:0px;cursor:pointer;font-size:11px;font-weight:700;">Ledger</a></p>
                </div>
                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Daybook">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/123.svg" style="height: 24px; margin-bottom: 8px; width: 23px;">
                        </button>
                    </a><br>
                    <a href="<?php echo base_url(); ?>/MasterDealer/Daybook" style="margin-left:3px;cursor:pointer;font-size:11px;font-weight:700;">Day&nbsp;Book</a>
                </div>
                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Operatorwisereport">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/money-bag.svg" style="height:24px;margin-bottom:8px;width:23px;">
                        </button>
                    </a><br>
                    <a href="<?php echo base_url(); ?>/MasterDealer/Operatorwisereport" style="margin-left:4px;cursor:pointer;font-size:11px;font-weight:700;">My&nbsp;Earn</a>
                </div>

                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/Set_Referral">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/refer.svg" style="height:24px;margin-bottom:8px;width:23px;">
                        </button>
                    </a><br>
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home#" style="margin-left:-2px;cursor:pointer;font-size:11px;font-weight:700;">Referral</a>
                </div>
                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/Service_Fee">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/support.svg" style="height:24px;margin-bottom:8px;width:23px;">
                        </button>
                    </a><br>
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home#" style="margin-left:-2px;cursor:pointer;font-size:11px;font-weight:700;">Service&nbsp;Fee</a>
                </div>

                <div class="col-md-3 pay-o repoat-pp">

                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/WebLogin">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <center>
                    ...
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/WebLogin" style="margin-left:2px;cursor:pointer;font-size:11px;font-weight:700;">Login&nbsp;Info</a>

                </div>

                <div class="col-md-3 pay-o repoat-pp">

                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/Bank_info">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <center>
                    ...
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home#" style="margin-left:2px;cursor:pointer;font-size:11px;font-weight:700;">Bank&nbsp;&amp;&nbsp;Cash</a>

                </div>

                
                <div class="col-md-3 full-icon marketing-op">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/WalletUnloadReport">
                        ...
                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/WalletUnloadReport" style="margin-left:-3px;cursor:pointer;font-size:11px;font-weight:700;">Wallet&nbsp;Unload</a>
                </div>
                ...
                <div class="col-md-3 pay-o">
                    ...
                    <a href="<?php echo base_url(); ?>/MasterDealer/mycommission">
                    ...
                    <a href="<?php echo base_url(); ?>/MasterDealer/mycommission" style="margin-left:3px;cursor:pointer;font-size:11px;font-weight:700;">Operator&nbsp;Comm</a>

                </div>

                <div class="col-md-3 pay-o markup-po">

                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/MarkupSetting">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/Markup.svg" style="height:23px;width:23px;">
                        </button>
                    </a>
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/MarkupSetting" style="display:block;width:100%;margin-left:-3px;cursor:pointer;font-size:11px;font-weight:700;">Markup&nbsp;Setting</a>

                </div>

                <div class="col-md-3 pay-o dispu">

                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/DisputeReport">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <center>
                    ...
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/DisputeReport" style="margin-left:-8px;cursor:pointer;font-size:11px;font-weight:700;">Dispute&nbsp;List</a>
                ...
                <div class="col-md-3 full-icon">
                    ...
                    <div class="bubblep bubblepss" style="text-align:center;margin:0px auto;display:block;float:none;height:auto !important;">
                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/Show_Credit_report_by_admin" class="btn btn-default btn-circle waves-effect waves-circle waves-float pull-right dropdown-toggle" role="button" aria-expanded="true" title="My Credit Balance " onclick="showoutstandingbal()">
                            <i class="material-icons" style="color:#000;font-size:35px;margin-top:1px;">bubble_chart</i>
                        </a>
                    </div><br>
                    <div class="my-cre"> <a href="<?php echo base_url(); ?>/MasterDealer/Home/Show_Credit_report_by_admin" style="font-size:11px;">My Credit</a></div>
                ...
                <div class="col-md-3 full-icon">
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/Gst_Invocing_Retailer_report">
                        <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                            <img src="<?php echo base_url();?>vfiles/tax.svg" style="height:24px;margin-bottom:8px;width:23px;margin-left:2px;">
                        </button>
                    </a><br>
                    <a href="<?php echo base_url(); ?>/MasterDealer/Home/Gst_Invocing_Retailer_report" style="margin-left:-2px;cursor:pointer;font-size:11px;font-weight:700;">GST&nbsp;&amp;&nbsp;TDS</a>
                </div>
                ...
                <div class="nav-tab" style="padding-top:1px;">
                    ...
                    <ul class="nav nav-tabs token-cpp li-responsivestart" role="tablist" style="padding-bottom:0px;">
                        <li role="presentation" class="active" style=" margin-left:0px;">
                            <a href="<?php echo base_url(); ?>/MasterDealer/Home#History" data-toggle="tab" aria-expanded="false" class="btn bg-grey waves-effect" onclick="Alltab()">
                        ...
                        <li role="presentation" style="">
                            <a href="<?php echo base_url(); ?>/MasterDealer/Home#Todaybusiness" id="Today" data-toggle="tab" aria-expanded="false" class="btn bg-grey waves-effect" onclick="today(this)">
                        ...
                        <li role="presentation" style="">
                            <a href="<?php echo base_url(); ?>/MasterDealer/Home#Todaybusiness" data-toggle="tab" id="Yesterday" aria-expanded="false" class="btn bg-grey waves-effect" onclick="today(this)" style="margin-right: 0px;">
                                            ...
                                            <div class="table-responsive" style="margin-top:-14px;">
                                                <table class="table" style="margin-left:1%;width:98%;">
                                                    <tbody><tr style="border-bottom:1px solid #eeeeee;">
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/Home/RechargeReport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/Home/Money_Transfer_Report" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/Air/TicketReport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/Bus/BusBookingReport" style="text-decoration:none;">
                                                                <center>
                                                ...
                                                <table class="table" style="margin-top:-21px;margin-left:1%;width:98%;">
                                                    <tbody><tr style="border-bottom:1px solid #eeeeee;">
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/Home/AepsReport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/Home/Ecommerce_Report" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/Home/m_Possreport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/PANCARD/TokenPurchaseReport" style="text-decoration:none;">
                                                                <center>
                                                ...
                                                <table class="table" style="margin-top:-21px;margin-left:1%;width:98%;">
                                                    <tbody><tr style="border-bottom:1px solid #eeeeee;">
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/Home#" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/Hotel/HotelReport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/DthConnection/DthBookingReport" style="text-decoration:none;">
                                                                <center>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>/MasterDealer/Home/Giftcard_Report" style="text-decoration:none;">
                                                                <center>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active pay-now" id="basicsetting">
                            <div class="body" style="height:332px;">
                                <div class="icon-button-demo">
                                    ...
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/WalletToBankAmountTransfer">
                                            <button type="button" class="btn bg-grey btn-circle-lg waves-effect waves-circle waves-float" style="margin-left:2px;">
                                           <img src="<?php echo base_url();?>vfiles/affiliate-marketing.svg" style="height:26px;">
                                            </button>
                                        </a>
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/WalletToBankAmountTransfer" style="margin-left:-14px;cursor:pointer;font-size:11px;font-weight:700;">Unload&nbsp;Charge's</a>
                                    </div>
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/Bank_info" style="margin-left:0px;cursor:pointer;font-size:11px;font-weight:700;">Bank&nbsp;Info</a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/Operator_info">
                                            <button type="button" class="btn bg-grey btn-circle-lg waves-effect waves-circle waves-float" style="margin-left:8px;">
                                                <img src="<?php echo base_url();?>vfiles/monitoring.svg" style="height:27px;">
                                            </button>
                                        </a>
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/Operator_info" style="margin-left:3px;cursor:pointer;font-size:11px;font-weight:700;">Operator&nbsp;Comm</a>
                                    </div>
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/MarkupSetting" style="margin-left:-9px;cursor:pointer;font-size:11px;font-weight:700;">Markup&nbsp;Setting</a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/WebLogin">
                                            <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                                    ...
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/GST_Report">
                                        ...
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/GST_Report" style="margin-left:-2px;cursor:pointer;font-size:11px;font-weight:700;">Declaration&nbsp;Form</a>
                                    </div>
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/Gst_Invocing_Retailer_report" style="margin-left:-6px;cursor:pointer;font-size:11px;font-weight:700;">GST&nbsp;&amp;&nbsp;TDS</a>
                                    </div>

                                    

                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/Help">
                                        ...
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/Help" style="margin-left:25px;cursor:pointer;font-size:11px;font-weight:700;">Help</a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="body" style="margin-top:-31px;">
                                <div class="icon-button-demo">
                              <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/Purchase_ORDER">
                                            <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                                       <img src="<?php echo base_url();?>vfiles/purchase.svg" style="height:24px;margin-bottom:10px;width:23px;margin-left:4px;">
                                            </button>
                                        </a>
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/Purchase_ORDER" style="margin-left:-14px;cursor:pointer;font-size:11px;font-weight:700;">Purchase&nbsp;Req</a>
                                    </div>
                                
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/Retailer_to_retailer">
                                            <button type="button" class="btn btn-grey btn-circle-lg waves-effect waves-circle waves-float">
                                                <center>
                                        ...
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/Retailer_to_retailer" style="margin-left:-9px;cursor:pointer;font-size:11px;font-weight:700;">R&nbsp;to&nbsp;R&nbsp;Transfer</a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/WalletUnloadReport">
                                        ...
                                        <a href="<?php echo base_url(); ?>/MasterDealer/Home/WalletUnloadReport" style="margin-left:-2px;cursor:pointer;font-size:11px;font-weight:700;">Unload&nbsp;Wallet</a>
                                    </div>
...
<script>
    function today(a)
    {
        ...
        //call ajax
        $.ajax({
            url: '/MasterDealer/Home/Show_Today_All_Recharge',
            type: 'POST',
            dataType: "html",
            data: { yesterday: x },
