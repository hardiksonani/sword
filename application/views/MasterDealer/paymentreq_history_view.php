...
<head>
   ...
   <!-- Favicon icon -->
    ...
    <title>Distributor::Payment Request History</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h4 class="text-themecolor m-b-0 m-t-0">PAYMENT REQUEST HISTORY</h4>
                    </div>
                </div>
                <!-- ============================================================== -->
        	...
        	<span id="mobmsg" class="mobmsg"></span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                     <form action="<?php echo base_url()."MasterDealer/paymentreq_history" ?>" method="post" name="frmCallAction" id="frmCallAction">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">PAYMENT REQUEST HISTORY</h4>
                                <div class="table-responsive">
