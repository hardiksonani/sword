...
<head>
    ...
    <title>Distributor::RETAILER ACCOUNT REPORT</title>
...
<div class="DialogMask" style="display:none"></div>
 ...
 <td style="padding-right:10px;">
     ...
     <?php
	 	$rsl = $this->db->query("select user_id,username,businessname from tblusers where usertype_name = 'Agent' and parentid =? order by businessname",array($this->session->userdata("MdId")));
