...
<?php
	...
	$result_user = $this->db->query("
		select 
			...
			where a.user_id=? and parentid = ?",array($user_id,$this->session->userdata("MdId")));	
 ?>
          ...
          <div class="col-sm-6 col-lg-12">
            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  ...
                  <form method="post" action="<?php echo base_url()."MasterDealer/fos_edit?crypt=".$this->Common_methods->encrypt("MyData");?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
