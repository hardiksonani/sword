...
<form action="<?php echo base_url()."MasterDealer/recharge_history"; ?>" method="post">                        <div class="">
                            <div class="col-md-2 rechargefirst">
                                <div class="form-group">
                                    <div class="" style="">
                                        <select class="form-control select2-hidden-accessible" id="ddl_status" name="ddl_status" style="margin-top:0px; padding-left:0px; padding-right:0px;text-align:center;" tabindex="-1" aria-hidden="true">
                                        ...
                                        <center>
                                            <select id="ddluser" name="ddluser">
                                                ...
                                                <?php
                                                        ...
                                                        $rsltuse = $this->db->query("select user_id,businessname from tblusers where parentid = ? order by businessname",array($this->session->userdata("MdId"))); 
                                                        foreach($rsltuse->result() as $rwchiluser)
                                                        {?>
                                                                <option value="<?php echo $rwchiluser->user_id; ?>"><?php echo $rwchiluser->businessname; ?></option>
                                                        <?php }
                                                 ?>
                                            </select>
                                        </center>
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div  class="body change-iconrech-report change-iconrech-responshive" style="display:none;padding:12px;padding-left: 0;padding-right: 0;padding-top: 15px;">
                        <?php echo $summary; ?>
                    </div>
                </div>
            </div>
                            ...
                            <table id="tbldata" class="table table-bordered table-striped table-hover dataTable" style="width:100%;" cellspacing="0">
                                <thead style="background-color:whitesmoke;">
                                    <tr>
                                        ...
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Agent</th>
...
<tr style="background-color:">
        ...
        <td><?php echo $result->rec_agentname; ?></td>
        ...
        <td class="noExl noExlss">
                ...
                <button id="disp-1215" type="button" style="background-color:transparent; border:none;" title="dispute" onclick="confirm('1215')">
                    <i class="material-icons">gavel</i>
                </button>
                <button id="confirm-1215" class="sure-newadd" type="button" style="background-color:transparent; border:none;display:none" title="ARE YOU SURE" onclick="disputedata('1215')">
                    <i class="material-icons" style="display:none;">check</i>Sure&nbsp;?
                </button>
                <button class="displaynoneadd" id="close-1215" type="button" style="background-color:transparent;border:none;display:none" title="CANCEL" onclick="cancel('1215')">
                    <i class="material-icons">close</i>
                </button>
                            <center>
