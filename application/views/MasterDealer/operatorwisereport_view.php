...
<form action="<?php echo base_url()."MasterDealer/operatorwisereport"; ?>" method="post">                        <div class="">
                            ...
                            <table id="tbldata" class="table table-bordered table-striped table-hover dataTable" style="width:100%;" cellspacing="0">
                                <thead style="background-color:whitesmoke;">
                                    <tr>
                                        ...
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Retailer Commission</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">MDistributor Profit</th>
...
<tr style="background-color:">
        ...
        <td> <?php echo $result->total_txn; ?></td>
...
<?php 
$gross_recharge += $result->amount;
$gross_count += $result->total_txn;
$gross_commission += $result->commission_amount;
$gross_profit += $result->DComm;
...
<tr style="font-weight: bold;">
    ...
    <td><?php echo $gross_recharge;  ?></td>
    <td><?php echo $gross_count;  ?></td>
    <td><?php echo $gross_commission;  ?></td>
