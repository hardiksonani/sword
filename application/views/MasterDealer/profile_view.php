<!DOCTYPE html>
<!-- saved from url=(0048)<?php echo base_url();?>RETAILER/Home/Profile -->
...
<form action="<?php echo base_url();?>RETAILER/Home/UploadProfileimage" enctype="multipart/form-data" method="post">                                                    <div class="modal-body" style="margin-top:0px;">
                                                        <div class="body">
                ...
                <div class="card profilecard">
                    <div class="body profilebodyback profilelastdetail" style="margin-bottom:11px;background-color:whitesmoke;height:3px;">
                            <h1 style="color:#49586e;font-size:20px;font-weight:bold;margin-top:-13px;text-transform:uppercase;">
                                ...
                                RAVIKANT
                                <a style="float:right;cursor:pointer;" id="Editaddresshide"><i class="fa fa-pencil-square-o" id="EditaddressModalssee" style="font-size:22px;margin-top:0px;" onclick="editeaddress('<?php echo $this->Common_methods->encrypt($this->session->userdata("AgentId")); ?>')">Edit</i></a>
                            </h1>
...
<form action="<?php echo base_url();?>RETAILER/Home/UpdateRetailerProfile" method="post">                                        <div class="modal-body" style="margin-top:0px;">
                                            <div class="body">
...
<form action="<?php echo base_url();?>RETAILER/Home/UpdatePanccardandmobile" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>RETAILER/Home/UpdateBankinfromation" method="post">                                        <div class="modal-body" style="margin-top:0px;">
                                            <div class="body">
...
<form action="<?php echo base_url();?>RETAILER/Home/UploadAadharcarddoc" enctype="multipart/form-data" method="post" novalidate="novalidate">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>RETAILER/Home/UploadPancardcarddoc" enctype="multipart/form-data" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>RETAILER/Home/UploadShopwithSalfieddoc" enctype="multipart/form-data" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>RETAILER/Home/UploadRegistractionCertificatedoc" enctype="multipart/form-data" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>RETAILER/Home/UploadServiceAggrementdoc" enctype="multipart/form-data" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<form action="<?php echo base_url();?>RETAILER/Home/UploadAddressProofdoc" enctype="multipart/form-data" method="post">                                            <div class="modal-body" style="margin-top:0px;">
                                                <div class="body">
...
<script>
    ...
    $.ajax({
        url: '/Distributor/Home/FillDistict',
        type: "GET",
        dataType: "JSON",
...
<script>
    function editeaddress(retailerid) {
        var url = '/Distributor/Dashboard/ShowRetailerprofile1'
        $.ajax({
            url: url,
...
<script>
    ...
    var url = '/Distributor/Dashboard/AddressFieldcheck'
        $.ajax({
            url: url,
          success: function (data) {
    ...
    function editemobileandpancard(retailerid) {
        ...
        var url = '/Distributor/Home/Showmobileandpancardprofile'
        $.ajax({
            url: url,
            data: { retailerid: retailerid },
            cache: false,
...
<script>
    function editebankinformation(retailerid) {
        var url = '/Distributor/Home/ShowBankinfo'
        $.ajax({
            url: url,
            data: { retailerid: retailerid },
            cache: false,
...
<script type="text/javascript">
    ...
    $.ajax({
        type: "POST", url: '/Distributor/Home/DelereprofileDoc', data: { 'SSID': retailerid, 'Docname': docname }, dataType: 'json', cache: false, success: function (result) {
            if (result == "Success") {

                var url = '/Distributor/Home/Profile';
