<!DOCTYPE html>
<!-- saved from url=(0056)<?php echo base_url();?>Retailer/dmrmm_home -->
    ...
    <div class="col-md-12 accountholderde">
        ...
        <div class="col-md-12 cancelbutton">
            <div class="cancelbuttonright">
                <a href="<?php echo base_url();?>Retailer/dmrmm_home#" class="cancel" onclick="back()">BACK</a>
...
<div id="dmtconfirm" style="display:none;" class="col-md-12 accountholderde accountholderde-responshive">
    <div class="col-md-12 next-page">
        ...
        <div class="col-md-12 cancelbutton">
            <div class="cancelbuttonright">
                <a href="<?php echo base_url();?>Retailer/dmrmm_home#" class="cancel" onclick="confirmback()">BACK</a>
    ...
    <div class="col-md-12 Confirm-Payment">
        <div class="container-fluid">
            ...
            <div class="col-md-6 successful-logo">
                <img id="logo" src="<?php echo base_url();?>Retailer/dmrmm_home">
            </div>
        </div>
    ...
    function senderdetails(change) {
      ...
      //
        ...
        if (len == 10) {
            ...
            $.ajax({
                url: '/Distributor/dmrmm_home/Senderdetails',
    ...
    function Registerben() {
        ...
        var benname = $('#benname').val();
           if (senderno != "" && account != "" && ifsccode != "" && originalifsccode != "" && benname!="") {
               $.ajax({
                   url: '/Distributor/dmrmm_home/Register_ben',
...
<script>
    function newsendernumber() {
        ...
        $('#otpsendername').text("");
        $.ajax({
            url: '/Distributor/dmrmm_home/Register_sender',
...
<script>
    function verifyotp() {
        ...
        $.ajax({
            url: '/Distributor/dmrmm_home/Otp_verify_sender',
...
<script>  
    function DMT() {      
       // $('#banknm').val(null).trigger("change");       
        ...
        $('#benadd').hide();
         $.ajax({
            url: '/Distributor/dmrmm_home/DMTreportnew',
            cache: false,
                 type: "GET",
                 cache: false,
               dataType:"html",
...
<script type="text/javascript">
    ...
    function bindDropdownbanklist() {
        ...
        $.ajax({
            type: "POST",
            url: "/Distributor/Dmrmm_home/BindBankDdllist",
            data: '{}',
...
<script>
    function deleteben (idno)
    {
        var senderno = $('#changesender').val();
        $.ajax({
            url: '/Distributor/dmrmm_home/Delete_ben',
...
<script>
    function Accountverify() {
        ...
        if (senderno != "" && account != "" && benIFSC != "" && banknm != "") {
            $.ajax({
                url: '/Distributor/dmrmm_home/Verify_account',
...
<script>
    function Accountverifyagain() {
        ...
        if (senderno != "" && account != "" && benIFSC != "" && banknm != "") {
            $.ajax({
                url: '/Distributor/dmrmm_home/Verify_account_again',
                data: { NUMBER: senderno, account: account, benIFSC: benIFSC, bankname: banknm },
                cache: false,
                type: "POST",
                    beforeSend: function() {
...
<script>
    function TransferDMT() {
        ...
        if (amount != "" && markup != "" && Dmtpin != "" && idproff != undefined) {
            ...
            if (resp == "OK") {
                $.ajax({
                    url: '/Distributor/dmrmm_home/Imps_check_transfer',
...
<script>
    ...
    function finalpay() {
        ...
        if (amount != "" && Dmtpin != "") {
            $.ajax({
                url: '/Distributor/dmrmm_home/imps_transfer',
...
<script>
    function printmoney() {
        ...
        var url = "/Distributor/dmrmm_home/Print_Imps_Pdf?orderid=" + orderid;
...
<script>
    function email() {
        var orderid = $('#responseorderid').text();
        $.ajax({
            url: '/Distributor/dmrmm_home/imps_email',
...
<div class="container-fluid aeps">
    ...
    <div id="driverdetails" class="container-fluid driver-page driverdetails-responshiveclass">
        <div class="col-md-12 driver-logo aeps-responsive">
            <ul>
                <li>
                    <div class="mantra-width"><a href="<?php echo base_url();?>Retailer/dmrmm_home#"><img src="<?php echo base_url();?>vfiles/logosite.png"></a></div>
                ...
                <li>
                    <div class="mantra-width mantra-width-img"><a href="<?php echo base_url();?>Retailer/dmrmm_home#"><img src="<?php echo base_url();?>vfiles/startek-logo.png"></a></div>
                    <div class="mantra-width mantra-width-img-one">
                ...
                <li>
                    <div class="mantra-width mantra-width-img"><a href="<?php echo base_url();?>Retailer/dmrmm_home#" style="font-size: 24px;
line-height: 19px;
...
" class="body-border-bottom"></span>
                    ...
                    <a href="<?php echo base_url();?>Retailer/dmrmm_home#scanrecoveer" id="againscanclick" onclick="gotoscan()">Scan&nbsp;Again</a>
                </div>
...
<div class="col-md-12 Confirm-Payment" id="getbalanceview" style="display:none;">
    <div class="container-fluid">
        ...
        <div class="col-md-6 successful-logo">
            <img id="logochkaeps" src="<?php echo base_url();?>Retailer/dmrmm_home">
        </div>
    </div>
    <div class="container-fluid transaction">
...
<div class="col-md-12 Confirm-Payment" id="aeps-Confirm-Payment" style="display:none;">
    <div class="container-fluid">
        ...
        <div class="col-md-6 successful-logo">
            ...
            <img id="logochkaepssuccess" src="<?php echo base_url();?>Retailer/dmrmm_home">
...
<script>
    function PurchaseAEPS(e) {
        $.ajax({
            url: '/Distributor/Home/ServiceCharge',
            data: { Service: e },
            cache: false,
            type: "POST",
            dataType: 'json',
    ...
    function FinalPurchaseAEPS(e) {
         $.ajax({
            url: '/Distributor/Home/ServicePurchase',
            data: { Service: e },
            cache: false,
            type: "POST",
             dataType: 'json',
        ...
        $.ajax({
            ...
            error: function () {
               ...
               $("#loadaeps").hide();
                 ...
                 $.ajax({
            url: '/Distributor/Home/AEPSreportnew',
            cache: false,
                 type: "GET",
                 cache: false,
               dataType:"html",
...
<script>
    function print(e) {
        if (e == "balance") {
            ...
            var url = "/Distributor/Home/Print_aeps_balance_Pdf?rrnno=" + rrnno + "&firmname=" + firmname + "&aadhar=" + aadhar + "&mobile=" + mobile + "&remain=" + remain;
            window.open(url, "_blank")
        }
        else if (e == "statement")
        {
            ...
            var url = "/Distributor/Home/Print_aeps_ministatement_Pdf?txtbankstate=" + txtbankstate + "&txtfrmstate=" + txtfrmstate + "&txtbankaadhar=" + txtbankaadhar + "&txtfrmdate=" + txtfrmdate + "&txtfeeservice=" + txtfeeservice+"&statementtbody="+sttt;
            window.open(url, "_blank")
        }
        else if (e=="transfer") {
            ...
            var url = "/Distributor/Home/Print_aeps_transfer_Pdf?rrnno=" + rrnno + "&firmname=" + firmname + "&aadhar=" + aadhar + "&mobile=" + mobile + "&remain=" + remain+"&amount="+aepssuccessamt+"&servicefee="+aepssuccessfee+"&tax="+aepssuccesstax+"&paidamount="+paidamt;
            window.open(url, "_blank")
        }
        else if (e=="aadharpay") {
            var rrnno = $('#rrnaepssuccess').text();
            ...
            var aepssuccesstax = $('#aepssuccesstax').text();
            var paidamt = $('#paidamt').text();
            var url = "/RETAILER/Home/Print_aeps_transfer_Pdf?rrnno=" + rrnno + "&firmname=" + firmname + "&aadhar=" + aadhar + "&mobile=" + mobile + "&remain=" + remain+"&amount="+aepssuccessamt+"&servicefee="+aepssuccessfee+"&tax="+aepssuccesstax+"&paidamount="+paidamt;
            window.open(url, "_blank")
        }
    }
</script>
...
<script>
    function SendOTP() {
        $('.loader').show();
        var url = '/Distributor/Home/RetailerOutletRegister'
        $.ajax({
            url: url,
            cache: false,
            type: "POST",
...
<script>
    function otpverify() {
        $('.loader').show();
        var otp = $('#otpShow').val();
        var url = '/Distributor/Home/EnterOtp'
        $.ajax({
            url: url,
            data: { otp:otp },
            cache: false,
    ...
    $("#txtphone").keyup(function () {
        if (this.value.length == 10) {
            var mobile = $('#txtphone').val();
              var url = '/Distributor/Home/AEPSNAMEFIND'
            $.ajax({
                url: url,
                data: { mobile: mobile },
                cache: false,
...
<div id="secpur1" class="col-md-12 remitter_button remitter_buttonewq" style="display:none;text-align: center;">
    ...
    <div class="col-md-12 Confirm-Payment" id="pan-Confirm-Payment" style="display:none;">
        <div class="container-fluid">
            ...
            <div class="col-md-6 successful-logo"><a href="<?php echo base_url();?>Retailer/dmrmm_home#">logo</a></div>
        </div>
        <div class="container-fluid transaction">
            <p>AEPS transaction details</p>
            <ul class="transaction-detail">
    ...
    function PANCARD() {
            ...
            success: function (data) {
             ...
             $.ajax({
            url: '/Distributor/Home/PANCARDreportnew',
            cache: false,
                 type: "GET",
                 cache: false,
               dataType:"html",
    ...
    function registeruti() {
          $.ajax({
            url: '/Distributor/PANCARD/Userinfo',
            cache: false,
              type: "GET",
                beforeSend: function() {
                  $('.loader').show();
    ...
    function Register() {
       ...
       var panpancard = $("#panpancard").val();
        ...
        $.ajax({
            url: '/Distributor/PANCARD/RegisterPSA',
            cache: false,
    ...
    function checkstatus() {
     $.ajax({
            url: '/Distributor/PANCARD/CheckStatus',
            cache: false,
         type: "POST",
              beforeSend: function() {
                  $('.loader').show();
            ...
            if (validaadhar == true) {
                ...
                if (regex.test(panpancard.toUpperCase())) {
                    ...
                    if (CheckZipCode.test(pinpan)) {
                       $.ajax({
                               url: '/Distributor/PANCARD/UpdatePSA',
                               cache: false,
    ...
    function purchase() {
        ...
        if (dig > 0 || phy > 0) {
            $.ajax({
                url: '/Distributor/PANCARD/buyUTIToken',
                cache: false,
...
<div id="secpur2" class="col-md-12 remitter_button remitter_buttonewq" style="display:none;text-align: center;">
    ...
    function MPOS() {
        ...
        $('#purchasempos').hide();
           ...
           $('#errormposid').text("");
        $.ajax({
            url: '/Distributor/Home/MPOSservice',
            cache: false,
            type: "GET",
             beforeSend: function() {
                  $('.loader').show();
            ...
            $.ajax({
            url: '/Distributor/Home/MPOSreportnew',
            cache: false,
                 type: "GET",
                 cache: false,
               dataType:"html",
