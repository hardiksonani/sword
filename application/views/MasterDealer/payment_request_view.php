    ...
    <div class="container-fluid">
        <div class="bread-same-all-page allpage-responshivenew">
            <div class="col-md-6">
                <ul>
                    <li class="smli">
                        <a href="<?php echo base_url(); ?>Distributor/Dashboard" class="fullbodydycolorbg tmw-total-color-one">
            ...
            <div class="col-md-4">
                <div class="fund-trasfer-left fund-user-left">
                    <ul class="nav nav-tabs tabtypeschages tabtypeschages-fullpage" id="tabs">
                        ...
                        <li id="firstontyimetabe" class="tab-link tabChangeType current active" data-tabname="Purchase_ORDER" data-href="/Distributor/payment_request/MDTODealer?tabtype=Purchase_ORDER" data-tab="tab-1" style="width:100% !important;"><a data-toggle="tab" href="<?php echo base_url(); ?>Distributor/payment_request#menu1" aria-expanded="false">Purchase Rerquest &nbsp;&nbsp; &nbsp;</a></li>
                            ...
                            <div class="fund-transfer-form textarea-classadd" id="frmdata1">
                                ...
                                <div class="w-100 float-left tab-menur tab-menubaar-responsive">
                                    <ul class="w-100 float-left">
                                        <li><a href="<?php echo base_url(); ?>Distributor/payment_request#" data-oldcr="/Distributor/payment_request/R_Creditchk?MID=Distributor" data-usertype="Distributor" class="chkoldcredit tab-ar  active-ar" data-id="tab1">Request&nbsp;To&nbsp;Distributor</a></li>
                                        <li><a href="<?php echo base_url(); ?>Distributor/payment_request#" data-oldcr="/Distributor/payment_request/R_Creditchk?MID=Admin" class="chkoldcredit tab-ar" data-usertype="Admin" data-id="tab2">Request&nbsp;To&nbsp;Admin</a></li>
...
<form action="<?php echo base_url(); ?>Distributor/payment_request" data-ajax="true" data-ajax-failure="OnFailure" data-ajax-mode="replace" data-ajax-success="OnSuccess11" data-ajax-update="#tblshowMasterD" id="form0" method="post">                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div>
...
<script>
    ...
    $('#btnchangetabbutton').click(function (e) {
      ...
      $.ajax({
          url: "/Distributor/payment_request",
     ...
     $("#RetailerId").blur(function (event) {
        ...
        var mobemail = $("#RetailerId").val()
         ...
         debugger
            ...
            //   alert(mobemail.val())
            $.ajax({
                url: "/Distributor/payment_request/CheckRetailerEmailMobile",
...
<script>
     ...
     function OnSuccess(result) {
       ...
       // cahangeTab('menu1');
        ...
        $.ajax({
            url: "/Distributor/payment_request/MDTODealer?tabtype=ReatilertoRetailer",
            success: function (data) {
                $('#tblshowMasterD').html(data)
...
<script>
     ...
     function OnSuccess11(result) {
       ...
       // cahangeTab('menu1');
        ...
        $.ajax({
            url: "/Distributor/payment_request/MDTODealer?tabtype=Purchase_ORDER",
            success: function (data) {
                $('#tblshowMasterD').html(data)
...
<script>
    ...
    {
        var url = '/Distributor/payment_request/Complaint';
...
<script>
        function showoutstandingbal()
        {
            ...
            $.ajax({
                type: 'Post',
                url: "/Distributor/payment_request/Chkbalance",
                dataType: 'html',
            cache: false,
            async: false,
            success: function (data) {
 ...
 "<tr>" +
"<td><a href='/Distributor/payment_request/Show_Credit_report_by_admin',style='text-decoration:none;cursor:pointer;'><p>My Credit From Admin</p></a></td>" +
"<td><p style='text-align:center;'>" + x.admincreditbal + "</p></td>" + "</tr>" +
"<tr>"+
 "<tr>" +
"<td><a href='/Distributor/payment_request/Show_Credit_report_by_dealer',style='text-decoration:none;cursor:pointer;'><p>My Credit From Distributor</p></a></td>" +
...
<script>
        function showtransferbal()
        {
            ...
            $.ajax({
                type: 'POST',
                url:'/Distributor/payment_request/Totalbaltransfer',
                dataType:'html',
                cache:false,
                async:false,
                success: function(data)
    ...
    "<tr>" +
   "<td><a href='/Distributor/payment_request/Retailer_to_retailer',style='text-decoration:none;cursor:pointer;'><p>Total&nbsp;Transfer&nbsp;Retailer&nbsp;to&nbsp;Retailer</p></a></td>" +
   "<td><p style='text-align:center;'>" + x.retailertoretailer + "</p></td>" + "</tr>" +
    "<tr>" +
    "<tr>" +
   "<td><a href='/Distributor/payment_request/ReceiveFund_by_admin',style='text-decoration:none;cursor:pointer;'><p>Received&nbsp;From&nbsp;Admin</p></a></td>" +
   "<td><p style='text-align:center;'>" + x.admintoretailer + "</p></td>" + "</tr>" +
    "<tr>" +
    "<tr>" +
   "<td><a href='/Distributor/payment_request/ReceiveFund_by_dealer',style='text-decoration:none;cursor:pointer;'><p>Received&nbsp;From&nbsp;Distributor</p></a></td>" +
