...
<?php
    ...
    $result_user = $this->db->query("
        select 
            ...
            where a.user_id=? and a.parentid  = ?",array($user_id,$this->session->userdata("MdId")));    
...
$(document).ready(function(){
    ...
    function setLoadValues()
    {
        ...
        getCityNameOnLoad('<?php echo base_url()."MasterDealer/city/getCity/"; ?>');
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card" style="margin-top:2px;float: left;width: 100%;">
                  ...
                  <form method="post" action="<?php echo base_url()."MasterDealer/agent_edit?crypt=".$this->Common_methods->encrypt("MyData");?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
                ...
                <div class="card">
                    <div class="body change-iconrech-report change-iconrech-responshive" style="padding:12px;padding-left: 0;padding-right: 0;padding-top: 15px;">
                        <div class="table-responsive recharge-responsive" style="position:inherit;margin-top:-10px;">
                             ...
                             <form method="post" action="<?php echo base_url()."MasterDealer/agent_edit/commission?crypt=".$this->Common_methods->encrypt("MyData");?>" name="frmdistributer_form2" id="frmdistributer_form2" autocomplete="off">
                                <input type="hidden" name="hiduserid" value="<?php echo $result_user->row(0)->user_id; ?>">
...
function changeCommission(id)
{
    ...
    if(commission <= 5)
    {
        ...
        $.ajax({
          type: "POST",
          url:'<?php echo base_url();?>MasterDealer/agent_edit/change_commission?company_id='+company_id+'&commission='+commission,
          cache:false,
