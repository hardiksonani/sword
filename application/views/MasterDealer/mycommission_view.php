...
<?php
  ...
  $comm_mobdth = $this->db->query("
    select 
        ...
        where   (a.service_id = 1 or a.service_id = 2)  order by a.service_id,a.company_name",array($this->session->userdata("MdId")));
 ...
 ?>
  ...
  $comm_utility = $this->db->query("
    select 
        ...
        left join tblservice s on a.service_id = s.service_id
        left join tbluser_commission b on a.company_id = b.company_id  and b.user_id=?
        where   a.service_id > 2   order by a.service_id,a.company_name",array($this->session->userdata("MdId")));
 ...
 ?>
                                ...
                                <div role="tabpanel" class="tab-pane flash" id="moneyoperator">
                                    ...
                                    $groupinfo = $this->db->query("select * from mt3_group where Id = (select dmr_group from tblusers where user_id = ?)",array($this->session->userdata("MdId")));
