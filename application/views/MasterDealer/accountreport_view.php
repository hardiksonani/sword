...
<form action="<?php echo base_url()."MasterDealer/Accountreport"; ?>" method="post">                        <div class="">
                            ...
                            <div class="col-md-3 rechargethrees">
                             ...
                             <div class="col-md-2 rechargefive">
                                <div class="form-group">
                                    <select id="ddltransaction_type" name="ddltransaction_type" class="form-control">
                                                <option value="ALL">ALL</option>
                                                <option value="PAYMENT">PAYMENT</option>
                                            </select>
                                    <script language="javascript">
                                        document.getElementById("ddltransaction_type").value = '<?php echo $ddltransaction_type; ?>';
                                    </script> 
                                </div>
                            </div>
                        ...
                        <div class="table-responsive recharge-responsive" style="position:inherit;margin-top:-10px;">
                            <table id="tbldata" class="table table-bordered table-striped table-hover dataTable" style="width:100%;" cellspacing="0">
                                <thead style="background-color:whitesmoke;">
                                    <tr>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">#&nbsp;Sr</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Ref No</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Old Balance</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Credit Amount</th>


                                        

                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Debit Amount</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">New Balance</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Detail</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Remarks</th>
                                        

                                        
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">DateTime</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Payment By</th>
                                        <th style="padding-left:2px; padding-right:2px;text-align:center;">Payment To</th>
...
<tr style="background-color:">
        ...
        <td>
          <?php 
              ...
              {
                echo $result->payment_id;   
              }
              else
              {
                echo $result->recharge_id; 
              }
        ...
        <td> <?php echo ($result->balance - $result->credit_amount + $result->debit_amount); ?></td>
