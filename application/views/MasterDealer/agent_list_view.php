...
<form action="<?php echo base_url()."MasterDealer/agent_list?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">                            
                                    <input type="hidden" id="hidID" name="hidID">                                     
                                    <table cellspacing="10" cellpadding="3">                                     
                                    <tr>                                     
                                    <td style="padding-right:10px;">                                             
                                    <h5>RETAILER NAME</h5>                                             
                                    <input class="form-control" value="<?php echo $txtAGENTName; ?>" id="txtAGENTName" name="txtAGENTName" type="text" style="width:120px;cursor:pointer;" >                                         </td>                                      
                                    <td style="padding-right:10px;">                                             
                                    <h5>RETAILRE ID</h5>                                             
                                    <input class="form-control"  id="txtAGENTId" value="<?php echo $txtAGENTId; ?>" name="txtAGENTId" type="text" style="width:120px;cursor:pointer;">                                         
                                    </td>   
                                    
                                    <td style="padding-right:10px;">                                             
                                    <h5>MOBILE NO</h5>                                             
                                    <input class="form-control" id="txtMOBILENo" value="<?php echo $txtAGENTId; ?>" name="txtMOBILENo" type="text" style="width:120px;cursor:pointer;">                                         
                                    </td>   
    ...
    <tr>
        <th style="padding-left:2px; padding-right:2px;text-align:center;">Sr No</th>
       <th style="padding-left:2px; padding-right:2px;text-align:center;">Retailer Id</th>
       <th style="padding-left:2px; padding-right:2px;text-align:center;">Retailer Name</th>
       <th style="padding-left:2px; padding-right:2px;text-align:center;">Mobile</th>
       <th style="padding-left:2px; padding-right:2px;text-align:center;">Password</th>
       <th style="padding-left:2px; padding-right:2px;text-align:center;">State</th>   
       <th style="padding-left:2px; padding-right:2px;text-align:center;">City</th> 
       <th style="padding-left:2px; padding-right:2px;text-align:center;">Group Name</th> 
      
       <th style="padding-left:2px; padding-right:2px;text-align:center;">Balance</th> 
      
       <th style="padding-left:2px; padding-right:2px;text-align:center;">Login</th>
       <th style="padding-left:2px; padding-right:2px;text-align:center;">Action</th>                 
    </tr>
  </thead>
...
<td ><a href="<?php echo base_url()."_Admin/profile/view/".$this->Common_methods->encrypt("Agent")."/".$this->Common_methods->encrypt($result->user_id);?>" target="_blank"><?php 
...
?></a></td>
  ...
  <td >
    <input type="button" id="btnshowpwd<?php echo $result->user_id; ?>" onclick="Shospassword(<?php echo $result->user_id; ?>)" value="show">
    <span id="hidpwd<?php echo $result->user_id; ?>" style="display: none;"><?php echo $result->password; ?></span>
       <script language="javascript">
        function Shospassword(userid)
        {
            document.getElementById("hidpwd"+userid).style.display = 'block';
            document.getElementById("btnshowpwd"+userid).style.display = 'none';
        }
        function resetpassword(userid)
        {
            $.ajax({
                        url: '/MasterDealer/Recharge_home/ResetPassword',
                        type: 'GET',
                        dataType: "json",
                        data: { userid: userid },
                        ...
                        { 
                            ...
                            document.getElementById("hidpwd"+userid).innerHTML =password;
                            document.getElementById("hidpwd"+userid).style.display = 'none';
                            document.getElementById("btnshowpwd"+userid).style.display = 'block';
                        },
...
<input type="button" class="btn btn-primary btn-sm" id="btnresetpwd<?php echo $result->user_id; ?>" onclick="resetpassword(<?php echo $result->user_id; ?>)" value="reset">
...
<td style="display:none"><span id="spanbalance2<?php echo $result->user_id; ?>"></span></td>
<td>
<?php if($result->status == 0){echo "<span class='red'>Deactive</span>";}else{echo "<span class='green'><a href='#' onclick='actionDeactivate(".$result->user_id.",0)'>Active</a></span>";} ?>
 ...
 <td width="180px">
  <a class="btn btn-success btn-sm" style="" href="<?php echo base_url()."MasterDealer/agent_edit?id=".$this->Common_methods->encrypt($result->user_id); ?>" title="Edit Franchise">Edit</a> 
   |       
 <?php 
 ...
 echo '<a class="fas rupee" style="font-size:16px;" title="Transfer Money" href="'.base_url().'MasterDealer/add_balance2?encrid='.$this->Common_methods->encrypt($result->user_id).'" class="paging"><img style="width:30px;" src="'.base_url().'files/rupee.png"></a> | ';
  ...
  function getuserbalance()
{
    ...
    $(document).ready(function()
    {
        ...
        <input type="hidden" id="hidbaseurl" value="<?php echo base_url()."MasterDealer/agent_list"; ?>">
...
<!--Today Business-->
    ...
    function disputedata(e) {
        ...
        var txtmob = $('#txtmob').val();
             ...
             $.post("/MasterDealer/Home/dispute",
             {"id": e, "txtregion": ""},
                 function (data) {
                     $.post("/MasterDealer/Home/InfiniteScroll",
...
<script type="text/javascript">
    function GotoPDFRecharge(e) {
                       // alert(e)
                       var idno = e.toString();
                       var url = '/MasterDealer/Home/RechargePDF?Idno=' + idno + '';
...
<script>
    function findtotal() {
         ...
         var Operator = $('#Operator').val();
         var txtmob = $('#txtmob').val();
             $.post("/MasterDealer/Home/FindTotal",
...
<script type="text/javascript">
    function GenrateInvoice(ultra_request_id, RechargeTo, OptName, amt, OptID, Date) {
       var url = '/MasterDealer/Home/GotoInvoicePDF1?Id=' + ultra_request_id + '&RechargeTo=' + RechargeTo + '&OptName=' + OptName + '&amt=' + amt + '&OptID=' + OptID + '&Date=' + Date + '';
            window.open(url, '_blank');
     }
</script>
<script>
   ...
   var txt_frm_date = $('#txt_frm_date').val();
         ...
         var Operator = $('#Operator').val();
        var txtmob = $('#txtmob').val();
        var url = '/MasterDealer/Home/ExcelRechargereport?txt_frm_date=' + txt_frm_date + '&txt_to_date=' + txt_to_date + '&ddl_status=' + ddl_status + '&Operator=' + Operator + '&txtmob=' + txtmob;
        location.href = url;
});
</script>
<script>
    $("#btnPDF").click(function () {
     var txt_frm_date = $('#txt_frm_date').val();
         ...
         var Operator = $('#Operator').val();
        var txtmob = $('#txtmob').val();
        var url = '/MasterDealer/Home/PDFRechargereport?txt_frm_date=' + txt_frm_date + '&txt_to_date=' + txt_to_date + '&ddl_status=' + ddl_status + '&Operator=' + Operator + '&txtmob=' + txtmob;
        window.open(
url,
