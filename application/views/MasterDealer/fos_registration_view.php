    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pageheader">
        ...
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Fos Registration</span>
          ...
          <?php include("elements/messagebox.php");?>
            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  ...
                  <form method="post" action="<?php echo base_url()."MasterDealer/fos_registration?crypt=".$this->Common_methods->encrypt("MyData")?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
<table class="table">
<tbody>
<tr>
<td><h5>Fos Name :</h5><input type="text" class="form-control-sm" placeholder="Enter FOS Name." id="txtDistname" name="txtDistname" value="<?php echo $regData['distributer_name']; ?>"  maxlength="100" style="width:300px;"/>
</td>
<td>
<h5>Mobile No :</h5><input style="width:300px;" type="text" class="form-control-sm" onKeyPress="return isNumeric(event);" placeholder="Enter Mobile No.<br />e.g. 9898980000" id="txtMobNo" name="txtMobNo" maxlength="10"  value="<?php echo $regData['mobile_no']; ?>"/>
</td>
</tr>
<tr>
...
<select style="width:300px;" class="form-control-sm" id="ddlState" name="ddlState" onChange="getCityName('<?php echo base_url()."MasterDealer/city/getCity/"; ?>')" placehoder="Select State.<br />Click on drop down"><option value="0">Select State</option>
<?php
