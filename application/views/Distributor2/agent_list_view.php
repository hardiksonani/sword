...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
        ...
        <?php include("elements/messagebox.php"); ?>
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form action="<?php echo base_url()."Distributor/agent_list?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">                            
    ...
    <tr>
	   ...
	   <th style="width: 80px;display:none">Wallet 2</th> 
...
<?php if($result->status == 0){echo "<span class='red'>Deactive</span>";}else{echo "<span class='green'><a href='#' onclick='actionDeactivate(".$result->user_id.",0)'>Active</a></span>";} ?>
 ...
 <td width="180px">
  <a class="btn btn-primary btn-sm" style="font-size:18px;" href="<?php echo base_url()."Distributor/agent_edit?id=".$this->Common_methods->encrypt($result->user_id); ?>" title="Edit Franchise"></a> 
   |       
 <?php 
 ...
 echo '<a class="fas rupee" style="font-size:16px;" title="Transfer Money" href="'.base_url().'Distributor/add_balance2?encrid='.$this->Common_methods->encrypt($result->user_id).'" class="paging"><img style="width:30px;" src="'.base_url().'files/rupee.png"></a> | ';
