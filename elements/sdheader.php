<div class="br-header">
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            ...
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <span class="logged-name hidden-md-down"><?php echo substr($this->session->userdata("SdBusinessName"),0,15); ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              ...
              <div class="tx-center">
                ...
                <h6 class="logged-fullname"><?php echo $this->session->userdata("SdBusinessName"); ?></h6>

                <p><?php echo $this->session->userdata("SdEmail"); ?></p>
...

	{
		...
		$.ajax({type: "GET",url: '<?php echo base_url(); ?>SuperDealer/Dashboard/getBalance',
