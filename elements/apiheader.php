<div class="br-header">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                ...
                <h6 class="logged-fullname"><?php echo $this->session->userdata("ApiBusinessName"); ?></h6>
                <p><?php echo $this->session->userdata("ApiEmail"); ?></p>
              </div>
              <hr>
              <div class="tx-center">
	...
	function get_balance(){$.ajax({type: "GET",url: '<?php echo base_url(); ?>/API/Dashboard/getBalance',cache: false,success: function(html){$("#balanceddl").html(html);}});$("#balanceddl").fadeOut(1000);$("#balanceddl").fadeIn(2000);}	
