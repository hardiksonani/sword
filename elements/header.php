<div class="br-header">
      <div class="br-header-left">
        ...
        <div class="input-group hidden-xs-down wd-170 transition">
           ...
           <form class="app-search" action="<?php echo base_url()."_Admin/list_recharge?crypt=".$this->Common_methods->encrypt("MyData") ?>" method="post">
                                <input type="text" id="txtSearchNumber" name="txtSearchNumber" class="form-control" placeholder="Search MO NO"> <a class="srh-btn"><i class="ti-close"></i></a> 
             </form>
      ...
      <div>
      <h1 style="color:blue;background-color:pink;">Welcome to <?php echo $this->white->getName(); ?> </h1>
      </div>
      <?php
        $dataheader = array();
