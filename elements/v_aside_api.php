...
<aside id="leftsidebar" class="sidebar fullbodydycolorbg retailer-header-left header-left-newresponshive" style="box-shadow:none;">
            <div class="navbar-header asd-asd" style="padding:0px 0px;">
                ...
                <a href="<?php echo base_url(); ?>API/Recharge_history/Dashboard">
                    <center>
                ...
                <div class="user-info navbar fullbodydycolorbg">
                    ...
                    <center>
                        <div class="legal legal-profilepassword legal-responsiveclass" style="background:none; position:relative; padding:0px;">
                            <div class="name john john-changeclass" style="color:white;"><span style="font-weight:700"><?php echo $this->session->userdata("ApiBusinessName"); ?></span></div>
                            <div class="email" style="color:white;"></div>
                            <div style="margin-top:2px;margin-right:0px;">
                                <div class="profile-es profile-es-newadd">
                                    <a href="<?php echo base_url(); ?>API/Profile" class="btn btn-info">Profile</a>
                                </div>
...
<form action="" method="post"><input name="__RequestVerificationToken" type="hidden" value="">                                        
    <a href="<?php echo base_url()."API/change_password"; ?>" style="padding:5px 1px;background:#fff;padding: 8px 6px;
background:#fff;color:#000;font-size: 12px;text-decoration: none;">Manage Password</a>
            ...
            <div class="menu" style="border-right:2px solid #9e8e8e33;">
                ...
                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 609px;"><ul class="list report-list-change" style="overflow: hidden; width: auto; height: 609px;">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>API/recharge_history" class="toggled waves-effect waves-block">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>API/dmr_report" class="toggled waves-effect waves-block">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>API/operatorwisereport" class="toggled waves-effect waves-block">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>API/search_number" class="toggled waves-effect waves-block">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>API/complain" class="toggled waves-effect waves-block">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>API/Recharge_history/Ecommerce_Report" class=" waves-effect waves-block">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>API/payment_request" class=" waves-effect waves-block">
                            ...
                            <li>
                                <a href="<?php echo base_url();?>api_document.html" target="_blank" class=" waves-effect waves-block">
                                ...
                                <a href="<?php echo base_url();?>API/Recharge_history/GatewayTRANSFER" class=" waves-effect waves-block">
                    ...
                    <li>
                    <a href="<?php echo base_url();?>API/topuphistory" class=" waves-effect waves-block">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>API/Recharge_history/Fund_Transfer_Retailer_To_Retailer" class=" waves-effect waves-block">
                    ...
                    <h2 class="reportadminclass reportadminclass-lastclass" style="font-size: 20px;margin: 15px 10px 0px 15px;border-bottom: 2px solid #fff;color: #fff;padding-bottom: 5px;">
                        <img src="<?php echo base_url();?>vfiles/customer.svg" style="float:left;width:24px;padding-left: 0;"><span style="padding-left:10px;">
                            <a href="<?php echo base_url(); ?>API/Recharge_history/Help" style="margin:0px;padding:0px;width:auto;font-size: 18px;
