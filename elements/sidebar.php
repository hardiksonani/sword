...
<li class="sub-item"><a href="<?php echo base_url()."_Admin/agent_list_wl?crypt=".$this->Common_methods->encrypt("MyData"); ?>" class="sub-link">WL Retailer List</a></li>
       ...
       <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="<?php echo base_url()."_Admin/list_recharge_pending?crypt=".$this->Common_methods->encrypt("MyData"); ?>" class="sub-link">Sudhir Pending Recharges</a></li>
            <li class="sub-item"><a href="<?php echo base_url()."_Admin/list_recharge_pending2?crypt=".$this->Common_methods->encrypt("MyData"); ?>" class="sub-link">Dilip pending recharges</a></li>
            <li class="sub-item"><a href="<?php echo base_url()."_Admin/list_recharge?crypt=".$this->Common_methods->encrypt("MyData"); ?>" class="sub-link">Recharge Report</a></li>
             ...
             <li class="sub-item"><a href="<?php echo base_url()."_Admin/account_report3?crypt=".$this->Common_methods->encrypt("MyData"); ?>" class="sub-link">Common Ledger Report</a></li>
             ...
             <li class="sub-item"><a href="<?php echo base_url()."_Admin/Purchase_report?crypt=".$this->Common_methods->encrypt("MyData"); ?>" class="sub-link">Purchase Report</a></li>
             ...
             <li class="sub-item"><a href="<?php echo base_url()."_Admin/openingclosing?crypt=".$this->Common_methods->encrypt("MyData"); ?>" class="sub-link">Opening Closing Report</a></li>
             ...
             <li class="sub-item"><a href="<?php echo base_url()."_Admin/manual_refund?crypt=".$this->Common_methods->encrypt("MyData"); ?>" class="sub-link">MAnual Refund done</a></li>
