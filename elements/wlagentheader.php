<div class="br-header">
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down"><?php echo substr($this->session->userdata("WLAgentBusinessName"),0,15); ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                ...
                <h6 class="logged-fullname"><?php echo $this->session->userdata("WLAgentBusinessName"); ?></h6>
                <p><?php echo $this->session->userdata("WLAgentEmail"); ?></p>
              </div>
              <hr>
              <div class="tx-center">
                <span class="profile-earning-label">Balance</span>
	...
	function get_balance(){$.ajax({type: "GET",url: '<?php echo base_url(); ?>/WLRetailer/Dashboard/getBalance',cache: false,success: function(html){$("#balanceddl").html(html);}});$("#balanceddl").fadeOut(1000);$("#balanceddl").fadeIn(2000);}	
