            ...
            <nav class="navbar navbarr">
                <div class="container-fluid asd-allapp">
                    <div class="navbar-header" style="padding:0px 0px;">
                        ...
                        <a href="<?php echo base_url()."MasterDealer/Dashboard" ?>">
                            <center>
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-btn search-panel">
                                                    ...
                                                    <ul class="dropdown-menu scrollable-dropdown" role="menu">
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Automots</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Cell Phs</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Computer Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Health and Personal Care</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Automotive Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Cell Phone Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Computer Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Health and Personal Care</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Automotive Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Cell </a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Computer Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Health and Personal Care</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Automotive Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#" class=" waves-effect waves-block">Cell Phone Accesories</a></li>
                                                        ...
                                                        <button class="header__cart-btn" id="toggle-cart-btn">
                                                            <i class="cart">
                                                                ...
                                                                <div class="custum-dropdown" style="display:none">
                                                                    <ul><li><a href="<?php echo base_url(); ?>MasterDealer/Recharge_home#">E-Commerce</a></li></ul>
                                                                </div>
                                                            </li>
                                            ...
                                            <div class="asd-nav">
                                                <ul id="leftulbar" class="nav nav-tabs tab-nav-left nav1-tabs1" role="tablist" style="padding-top:5px;border-bottom:none;">
                                                    <li id="dashboard" class="listtryp activee active" role="presentation" style="padding:0px;">
                                                        <a href="<?php echo base_url()."MasterDealer/Dashboard"; ?>" aria-expanded="false" style=" cursor:pointer;"><i class="fa fa-home" style="color:white;top:-3px;"></i></a>
                                                    </li>
                                                    <li id="recharge" class="listtryp activee active" role="presentation" style="padding:0px;">
                                                        <a href="<?php echo base_url()."MasterDealer/recharge_home"; ?>" id="recharge" aria-expanded="false">RECHARGE &amp; BILL</a>
                                                    </li>
                                                    <li id="finanical" class="listtryp active" role="presentation" style="padding:0px;">
                                                        <a href="<?php echo base_url()."MasterDealer/dmrmm_home"; ?>" aria-expanded="true">FINANCIAL</a>
                                                    </li>
                                                    <li id="travel" class="listtryp active" role="presentation" style="padding:0px;">
                                                        <a href="<?php echo base_url()."MasterDealer/recharge_home"; ?>" aria-expanded="true">TRAVEL</a>
                                                    </li>


                                                    
                                                    <li id="Gift" class="listtryp active" role="presentation" style="padding:0px;">
                                                        <a href="<?php echo base_url()."MasterDealer/recharge_home"; ?>" aria-expanded="true">GIFT&nbsp;CARDS</a>
                                                    </li>

                                                    <li id="ecommerce" class="listtryp" role="presentation" style="padding:0px; margin-bottom:-27px;">
                                                        <a href="<?php echo base_url()."MasterDealer/recharge_home"; ?>" aria-expanded="true">E-COMMERCE</a>
                                                    </li>
                ...
                <div class="menus">
                    ...
                    <ul id="leftulbar" class="nav nav-tabs tab-nav-left nav1-tabs1 navi fullbodydycolorbg addnewlogout addnewlogout-responshive" role="tablist" style="padding-top:5px;border-bottom:none;">
                        <li id="dashboard" class="listtryp active" role="presentation" style="padding:0px;">
                            <a href="<?php echo base_url()."MasterDealer/Dashboard"; ?>" aria-expanded="false"><i><img src="<?php echo base_url();?>vfiles/transport.png"></i>DASHBOARD</a>
                        </li>
                        <li id="recharge" class="listtryp" role="presentation" style="padding:0px;">
                            <a href="<?php echo base_url()."MasterDealer/recharge_home"; ?>" id="recharge" aria-expanded="false"><span class="newimgspan"><i><img src="<?php echo base_url();?>vfiles/validating-ticket.svg" style="text-align: center;margin: 0px auto;position: static;float: none;margin-right: 2px;margin-top: -2px;transform:none;"></i>Prepaid&nbsp;&amp;&nbsp;Utility</span></a>
                        </li>
                        <li id="finanical" class="listtryp" role="presentation" style="padding:0px;">
                            <a href="<?php echo base_url()."MasterDealer/dmrmm_home"; ?>" aria-expanded="true"><span class="newimgspan"><i><img style="transform:none;height: 21px;text-align: center;margin: 0px auto;position: static;float: none;margin-right: 2px;margin-top: -2px;" src="<?php echo base_url();?>vfiles/business.svg"></i>FINANCIAL</span></a>
                        </li>
                        <li id="travel" class="listtryp" role="presentation" style="padding:0px;">
                            <a href="<?php echo base_url()."MasterDealer/recharge_home"; ?>" aria-expanded="true"><span class="newimgspan"><i><img style="transform:none;left: 16px;height: 13px;top: 4px;width: 15px !important;text-align: center;margin: 0px auto;position: static;float: none;margin-right: 2px;margin-top: -2px;" src="<?php echo base_url();?>vfiles/interface.png"></i>TRAVEL&nbsp;&amp;&nbsp;Hotels</span></a>
                        </li>


                        
                        <li id="Gift" class="listtryp" role="presentation" style="padding:0px;">
                            <a href="<?php echo base_url()."MasterDealer/recharge_home"; ?>" aria-expanded="true"><span class="newimgspan"><i><img style="transform:none;left:34px;height: 16px;top: 2px;text-align: center;margin: 0px auto;position: static;float: none;margin-right: 2px;margin-top: -2px;" src="<?php echo base_url();?>vfiles/business(1).png"></i>GIFT&nbsp;CARDS</span></a>
                        </li>
                        <li>
                            <a href="<?php echo base_url()."MasterDealer/recharge_home"; ?>"><span class="newimgspan"><i><img style="transform:none;text-align:center;margin:0px auto;position: static;float: none;margin-right: 2px;margin-top: -2px;height: 15px;" src="<?php echo base_url();?>vfiles/computer.png"></i>Security<label class="for-blink1" style="font-size: 10px;position: absolute;top: -4px;right: -23px;">New</label></span></a>
                        </li>

                        <li id="ecommerce" class="listtryp" role="presentation" style="padding:0px;">
                            <a href="<?php echo base_url()."MasterDealer/recharge_home"; ?>" aria-expanded="true"><span class="newimgspan"><i><img style="transform:none;text-align:center;margin:0px auto;position: static;float: none;margin-right: 2px;margin-top: -3px;height: 15px;" src="<?php echo base_url();?>vfiles/interface(1).png"></i>E-COMMERCE</span></a>
                        </li>

                        <li class="bkp logout-bkp">
<form action="<?php echo base_url()."MasterDealer/recharge_home"; ?>" method="post"><input name="__RequestVerificationToken" type="hidden" value="yLpQg1Aw_MwQUJVx1c9U1YqQGhheBfEjkEeerl9McNEkAdqhIoE6bfVA4OyIxrKh7l7dj6Cxzd5S37z17wb7vqzeXcsQKbezNoZg5EVTmA5ouU88rd91-csWhRS-lKx8Nqrxh24xpdr5gDpfEdK5AA2">                                <button type="submit" class="pull-right">
