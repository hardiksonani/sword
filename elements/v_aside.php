...
<aside id="leftsidebar" class="sidebar fullbodydycolorbg retailer-header-left header-left-newresponshive" style="box-shadow:none;">
            <div class="navbar-header asd-asd" style="padding:0px 0px;">
                ...
                <a href="<?php echo base_url(); ?>RETAILER/Home/Dashboard">
                    <center>
                ...
                <div class="user-info navbar fullbodydycolorbg">
                    ...
                    <center>
                        <div class="legal legal-profilepassword legal-responsiveclass" style="background:none; position:relative; padding:0px;">
                            <div class="name john john-changeclass" style="color:white;"><span style="font-weight:700"><?php echo $this->session->userdata("AgentBusinessName"); ?></span></div>
                            <div class="email" style="color:white;"></div>
                            <div style="margin-top:2px;margin-right:0px;">
                                <div class="profile-es profile-es-newadd">
                                    <a href="<?php echo base_url(); ?>Retailer/Profile" class="btn btn-info">Profile</a>
                                </div>
...
<form action="" method="post"><input name="__RequestVerificationToken" type="hidden" value="">                                        
    <a href="<?php echo base_url()."Retailer/change_password"; ?>" style="padding:5px 1px;background:#fff;padding: 8px 6px;
background:#fff;color:#000;font-size: 12px;text-decoration: none;">Manage Password</a>
            ...
            <div class="menu" style="border-right:2px solid #9e8e8e33;">
                ...
                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 609px;"><ul class="list report-list-change" style="overflow: hidden; width: auto; height: 609px;">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>Retailer/recharge_history" class="toggled waves-effect waves-block">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>Retailer/dmr_report" class="toggled waves-effect waves-block">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>Retailer/operatorwisereport" class="toggled waves-effect waves-block">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>Retailer/search_number" class="toggled waves-effect waves-block">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>Retailer/complain" class="toggled waves-effect waves-block">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>RETAILER/Home/Ecommerce_Report" class=" waves-effect waves-block">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>Retailer/payment_request" class=" waves-effect waves-block">
                            ...
                            <li>
                                <a href="<?php echo base_url();?>RETAILER/Home/UPITRANSFER" class=" waves-effect waves-block">
                                ...
                                <a href="<?php echo base_url();?>RETAILER/Home/GatewayTRANSFER" class=" waves-effect waves-block">
                    ...
                    <li>
                        <a href="<?php echo base_url()."Retailer/topuphistory"; ?>" class=" waves-effect waves-block">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>RETAILER/Home/Fund_Transfer_Retailer_To_Retailer" class=" waves-effect waves-block">
                    ...
                    <h2 class="reportadminclass reportadminclass-lastclass" style="font-size: 20px;margin: 15px 10px 0px 15px;border-bottom: 2px solid #fff;color: #fff;padding-bottom: 5px;">
                        <img src="<?php echo base_url();?>vfiles/customer.svg" style="float:left;width:24px;padding-left: 0;"><span style="padding-left:10px;">
                            <a href="<?php echo base_url(); ?>RETAILER/Home/Help" style="margin:0px;padding:0px;width:auto;font-size: 18px;
text-transform: uppercase;font-weight:700;" class=" waves-effect waves-block">Support</a>
            ...
            <div class="legal legal-new">
                <div class="copyright tmw-total-color-one" style="margin-top:-4px;">
                    Copyright&nbsp;&nbsp;2020 - <span>2021</span>
                </div>
                <div class="copyright copyright-new">
                    <a href="javascript:void(0);" class="tmw-total-color-one" style=""><?php echo $this->white->getName(); ?></a>
                </div>
