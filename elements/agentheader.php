...
<h2><?php echo $Message_rslt->row(0)->value; ?></h2>
</marquee>
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down"><?php echo substr($this->session->userdata("ApiBusinessName"),0,15); ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                ...
                <h6 class="logged-fullname"><?php echo $this->session->userdata("AgentBusinessName"); ?></h6>
                <p><?php echo $this->session->userdata("AgentEmail"); ?></p>
              </div>
              <hr>
              <div class="tx-center">
                <span class="profile-earning-label">Recharge Balance</span>
                <h5 class="profile-earning-amount">Rs. <span id="balanceddl"></span></h5>
                <span class="profile-earning-text"></span>
              </div>
              <hr>
              <div class="tx-center">
                <span class="profile-earning-label">DMT Balance</span>
                <h5 class="profile-earning-amount">Rs. <span id="balanceddl2"></span></h5>
                <span class="profile-earning-text"></span>
              </div>
              <hr>
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="<?php echo base_url(); ?>bhavya.apk"><i class="icon ion-ios-download"></i> Android App</a></li>
                ...
                <li><a href="<?php echo base_url() ?>Agentlogout"><i class="icon ion-power"></i> Sign Out</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </nav>
        <div class="navicon-right" style="display:none">
	...
	{
		$.ajax({type: "GET",url: '<?php echo base_url(); ?>/Retailer/Dashboard/getBalance',
			cache: false,
			success: function(html)
			{
				$("#balanceddl").html(html.split("#")[0]);
				$("#balanceddl2").html(html.split("#")[1]);
			}
		}
	...
	function gethourlysale()
		...
		$.ajax({
					type: "GET",
					url: '<?php echo base_url(); ?>Retailer/dashboard/getTodaysHourSale',
					cache: false,
					success: function(html)
					{
