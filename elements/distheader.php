<div class="br-header">
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down"><?php echo substr($this->session->userdata("DistBusinessName"),0,15); ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                ...
                <h6 class="logged-fullname"><?php echo $this->session->userdata("DistBusinessName"); ?></h6>
                <p><?php echo $this->session->userdata("DistEmail"); ?></p>
              </div>
              <hr>
              <div class="tx-center">
	...
	{
		$.ajax({type: "GET",url: '<?php echo base_url(); ?>Distributor/Dashboard/getBalance',
			cache: false,
	...
	function gethourlysale()
		...
		$.ajax({
					type: "GET",
					url: '<?php echo base_url(); ?>Distributor/dashboard/getTodaysHourSale',
					cache: false,
					success: function(html)
					{
